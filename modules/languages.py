...
language2scripts = {
    "ar": [
        "Arabic",
        "[\u064B-\u0655\u0670]",
    ],  # 'Arabic', 'Script_Extensions=Arabic,Syriac' Arabic,Syriac frequent at least in Iraq,
    "ast": ["Latin"],
    ...
    "fa": [
        "Arabic",
        "[\u064B-\u0655\u0670]",
    ],  # 'Arabic', 'Script_Extensions=Arabic,Syriac'
    "fi": ["Latin"],
    "fo": ["Latin"],
    "fr": ["[A-Za-zÉÀÈÙÂÊÎÔÛËÏÜŸÇŒÆéàèùâêîôûëïüÿçœæ]"],
    "fr_GF": ["[A-Za-zÉÀÈÙÂÊÎÔÛËÏÜŸÇŒÆÃĨÕŨÖƗéàèùâêîôûëïüÿçœæãĩõũöɨ]"],
    "fr_LU": ["[A-Za-zÉÀÈÙÂÊÎÔÛÄËÏÜŸÇŒÆéàèùâêîôûäëïüÿçœæ]"],
    "fr_PF": ["[A-Za-zÉÀÈÙÂÊÎÔÛËÏÖÜŸÇŒÆĀĒĪŌŪÚéàèùâêîôûëïöüÿçœæāēīōū]"],
    "fy": ["Latin"],
    "ga": ["Latin"],
    "gl": ["Latin"],
    "he": ["Hebrew"],
    ...
    "my": None,  # Birman
    "ne": ["Devanagari"],
    "nl": ["[A-Za-zÁÉÍÓÚÀÈÌÒÙÄËÏÖÜÇÑáéíóúàèìòùäëïöüçñ]"],
    "no": ["Latin"],
    "pl": ["Latin"],
    "pt": ["Latin"],
    "rm": ["Latin"],
