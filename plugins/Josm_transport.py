...
class Josm_transport(PluginMapCSS):
    ...
    def init(self, logger):
        ...
        self.errors[21401] = self.def_class(
            item=2140,
            level=3,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr(
                "Missing public_transport:version tag on a public_transport route relation"
            ),
        )
        self.errors[21402] = self.def_class(
            item=2140,
            level=3,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("Missing network tag on a public_transport relation"),
        )
        self.errors[21403] = self.def_class(
            item=2140,
            level=3,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("Missing operator tag on a public_transport relation"),
        )
        self.errors[21405] = self.def_class(
            item=2140,
            level=3,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("Missing from/to tag on a public_transport route relation"),
        )
        self.errors[21411] = self.def_class(
            item=2140,
            level=3,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("Missing public_transport tag on a public transport stop"),
        )
        self.errors[21412] = self.def_class(
            item=2140,
            level=3,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("Missing legacy tag on a public transport stop"),
        )
        self.errors[9014002] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("Is it a bus stop or a bus station?"),
        )
        self.errors[9014006] = self.def_class(
            item=9014,
            level=3,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("Check if the note can be deleted"),
        )
        self.errors[9014007] = self.def_class(
            item=9014,
            level=3,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr(
        ...
        self.errors[9014008] = self.def_class(
            item=9014,
            level=3,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr(
                "The operator should be on the transport lines and not on the stops"
            ),
        )
        self.errors[9014009] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr(
                "Missing transportation mode, add a tag route = bus/coach/tram/etc"
            ),
        )
        self.errors[9014010] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr(
                "Missing transportation mode, change tag route to route_master"
            ),
        )
        self.errors[9014019] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("A bus stop is supposed to be a node"),
        )
        self.errors[9014020] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr(
                "The color of the public transport line should be in a colour tag"
            ),
        )
        self.errors[9014021] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("The interval is invalid (try a number of minutes)"),
        )
        self.errors[9014022] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("The duration is invalid (try a number of minutes)"),
        )
        self.errors[9014023] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("Missing interval tag to specify the main interval"),
        )
        self.errors[9014024] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("Missing opening_hours tag"),
        )
        self.errors[9014025] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr(
        ...
        self.errors[9014026] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr(
                "Check the network tag : this network does not exist, it may be a typo"
            ),
        )
        self.errors[9014027] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr("Subway entrances should be mapped as nodes"),
        )
        self.errors[9014028] = self.def_class(
            item=9014,
            level=2,
            tags=mapcss.list_("tag", "public_transport"),
            title=mapcss.tr(
                "The line variant does not belong to any line, add it to the route_master relation"
            ),
        )

        self.re_25554804 = re.compile(r"STIF|Kéolis|Véolia")
        self.re_2fe0817d = re.compile(
            r"^([0-9][0-9]?[0-9]?|[0-2][0-9]:[0-5][0-9](:[0-5][0-9])?)$"
        )
        self.re_6194d2a4 = re.compile(
            r"^(bus|coach|train|subway|monorail|trolleybus|aerialway|funicular|ferry|tram|share_taxi|light_rail|school_bus|walking_bus)$"
        )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        == mapcss._value_capture(capture_tags, 0, "bus_stop")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "amenity")
                        == mapcss._value_capture(capture_tags, 1, "bus_station")
                    )
                ...
                err.append(
                    {
                        "class": 9014002,
                        "subclass": 1676203359,
                        "text": mapcss.tr("Is it a bus stop or a bus station?"),
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["public_transport", "platform"]])},
                    }
                )
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["public_transport", "stop_position"]])},
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "public_transport"
                            )
                        ...
                        and (not mapcss._tag_capture(capture_tags, 4, tags, "tram"))
                        and (not mapcss._tag_capture(capture_tags, 5, tags, "ferry"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 6, tags, "walking_bus"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1,
                        "text": mapcss.tr(
                            "Is this a bus or tram stop ? Add a tag to precise the kind of platform"
                        ),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "railway"))
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "bus")
                            == mapcss._value_capture(capture_tags, 3, "yes")
                        )
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "subclass": 0,
                        "text": mapcss.tr(
                            "Is this a bus stop? add the tag highway=bus_stop"
                        ),
                        "allow_fix_override": True,
                        "fix": {"+": dict([["highway", "bus_stop"]])},
                    }
                )

        # node[highway=bus_stop][note]
        # node[highway=bus_stop][note:fr][inside("FR")]
        if ("highway" in keys and "note" in keys) or (
            "highway" in keys and "note:fr" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "note:fr"))
                ...
                err.append(
                    {
                        "class": 9014006,
                        "subclass": 673170504,
                        "text": mapcss.tr("Check if the note can be deleted"),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "network"))
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        "class": 9014019,
                        "subclass": 1153984743,
                        "text": mapcss.tr("A bus stop is supposed to be a node"),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        ...
                        capture_tags, 0, "train_station_entrance"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        "class": 9014027,
                        "subclass": 514884813,
                        "text": mapcss.tr("Subway entrances should be mapped as nodes"),
                    }
                )
    ...
    def relation(self, data, tags, members):
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "route"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "disused:route"
                            )
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "type")
                            == mapcss._value_capture(capture_tags, 0, "route_master")
                        )
                        and (
                            not mapcss._tag_capture(
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, "disused:route_master"
                            )
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 2, tags, "route"))
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["route_master", mapcss.tag(tags, "route")]]),
                            "-": (["route"]),
                        },
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_6194d2a4),
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_6194d2a4),
                            mapcss._tag_capture(capture_tags, 1, tags, "route_master"),
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if True:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = (set_pt_route) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "public_transport:version"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (set_pt_route) and (
                        not mapcss._tag_capture(capture_tags, 1, tags, "network")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                err.append(
                    {
                        ...
                        "subclass": 0,
                        "text": mapcss.tr(
                            "Missing network tag on a public_transport relation"
                        ),
                    }
                )
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (set_pt_route) and (
                        not mapcss._tag_capture(capture_tags, 1, tags, "operator")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                err.append(
                    {
                        ...
                        "subclass": 0,
                        "text": mapcss.tr(
                            "Missing operator tag on a public_transport relation"
                        ),
                    }
                )
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (set_pt_route) and (
                        not mapcss._tag_capture(capture_tags, 1, tags, "from")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (set_pt_route) and (
                        not mapcss._tag_capture(capture_tags, 1, tags, "to")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "subclass": 0,
                        "text": mapcss.tr(
                            "Missing from/to tag on a public_transport route relation"
                        ),
                    }
                )
        ...
        if "color" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (set_pt_route)
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "colour"))
                        and (mapcss._tag_capture(capture_tags, 2, tags, "color"))
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["colour", mapcss.tag(tags, "color")]]),
                            "-": (["color"]),
                        },
                    }
                )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_25554804
                                ),
                    ...
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(capture_tags, 1, tags, "network"),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
        ...
        if "interval" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (set_pt_route)
                        and (mapcss._tag_capture(capture_tags, 1, tags, "interval"))
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    2,
                                    self.re_2fe0817d,
                                    "^([0-9][0-9]?[0-9]?|[0-2][0-9]:[0-5][0-9](:[0-5][0-9])?)$",
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "interval"),
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 170114261,
                        "text": mapcss.tr(
                            "The interval is invalid (try a number of minutes)"
                        ),
                    }
                )
        ...
        if "duration" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (set_pt_route)
                        and (mapcss._tag_capture(capture_tags, 1, tags, "duration"))
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags,
                                ...
                                mapcss._tag_capture(capture_tags, 2, tags, "duration"),
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 317647061,
                        "text": mapcss.tr(
                            "The duration is invalid (try a number of minutes)"
                        ),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "interval:conditional"
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "interval"))
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1710360237,
                        "text": mapcss.tr(
                            "Missing interval tag to specify the main interval"
                        ),
                    }
                )
                ...
                err.append(
                    {
                        "class": 9014024,
                        "subclass": 210081506,
                        "text": mapcss.tr("Missing opening_hours tag"),
                    }
                )
...
class Test(TestPluginMapcss):
    def test(self):
        ...
        self.check_not_err(
            n.node(data, {"highway": "bus_stop", "public_transport": "platform"}),
            expected={"class": 21411, "subclass": 0},
        )
        self.check_not_err(
            n.node(data, {"highway": "bus_stop", "public_transport": "stop_position"}),
            expected={"class": 21411, "subclass": 0},
        )
        self.check_err(
            n.node(data, {"highway": "bus_stop"}),
            expected={"class": 21411, "subclass": 0},
        )
        self.check_not_err(
            n.node(data, {"public_transport": "platform", "railway": "tram_stop"}),
            expected={"class": 21411, "subclass": 1},
        )
        self.check_not_err(
            n.node(data, {"public_transport": "stop_position", "railway": "tram_stop"}),
            expected={"class": 21411, "subclass": 1},
        )
        self.check_err(
        ...
        self.check_err(
            n.node(data, {"bus": "yes", "public_transport": "platform"}),
            expected={"class": 21412, "subclass": 0},
        )
        self.check_err(
            n.way(data, {"railway": "subway_entrance"}, [0]),
            expected={"class": 9014027, "subclass": 514884813},
        )
        self.check_not_err(
            n.relation(
                data,
                {"public_transport:version": "1", "route": "bus", "type": "route"},
                [],
            ),
            expected={"class": 21401, "subclass": 0},
        )
        self.check_err(
            n.relation(data, {"route": "bus", "type": "route"}, []),
            expected={"class": 21401, "subclass": 0},
        )
        self.check_not_err(
            n.relation(
                data, {"network": "BiBiBus", "route": "bus", "type": "route"}, []
            ),
            expected={"class": 21402, "subclass": 0},
        )
        self.check_err(
            n.relation(data, {"route": "bus", "type": "route"}, []),
            expected={"class": 21402, "subclass": 0},
        ...
        self.check_not_err(
            n.relation(
                data, {"operator": "BiBiBus", "route": "bus", "type": "route"}, []
            ),
            expected={"class": 21403, "subclass": 0},
        )
        self.check_err(
            n.relation(data, {"route": "bus", "type": "route"}, []),
            expected={"class": 21403, "subclass": 0},
        ...
        self.check_not_err(
            n.relation(
                data, {"from": "A", "route": "bus", "to": "B", "type": "route"}, []
            ),
            expected={"class": 21405, "subclass": 0},
        )
        self.check_err(
            n.relation(data, {"from": "A", "route": "bus", "type": "route"}, []),
            expected={"class": 21405, "subclass": 0},
        )
        self.check_err(
            n.relation(data, {"route": "bus", "to": "B", "type": "route"}, []),
            expected={"class": 21405, "subclass": 0},
        )
        self.check_err(
            n.relation(data, {"route": "bus", "type": "route"}, []),
        ...
        self.check_not_err(
            n.relation(
                data, {"interval": "00:05", "route": "bus", "type": "route"}, []
            ),
            expected={"class": 9014021, "subclass": 170114261},
        )
        self.check_not_err(
            n.relation(
                data, {"interval": "00:10:00", "route": "bus", "type": "route"}, []
            ),
            expected={"class": 9014021, "subclass": 170114261},
        )
        self.check_err(
            n.relation(
                data, {"interval": "00:70:00", "route": "bus", "type": "route"}, []
            ),
            expected={"class": 9014021, "subclass": 170114261},
        )
        self.check_not_err(
            n.relation(
                data, {"interval": "02:00:00", "route": "bus", "type": "route"}, []
            ),
            expected={"class": 9014021, "subclass": 170114261},
        )
        self.check_not_err(
            n.relation(data, {"interval": "10", "route": "bus", "type": "route"}, []),
            expected={"class": 9014021, "subclass": 170114261},
        )
        self.check_not_err(
            n.relation(data, {"interval": "120", "route": "bus", "type": "route"}, []),
            expected={"class": 9014021, "subclass": 170114261},
        )
        self.check_not_err(
            n.relation(data, {"interval": "5", "route": "bus", "type": "route"}, []),
            expected={"class": 9014021, "subclass": 170114261},
        )
        self.check_err(
            n.relation(
                data, {"interval": "irregular", "route": "bus", "type": "route"}, []
            ),
            expected={"class": 9014021, "subclass": 170114261},
        )
        self.check_err(
            n.relation(
                data, {"interval": "2heures", "route": "ferry", "type": "route"}, []
            ),
            expected={"class": 9014021, "subclass": 170114261},
        )
        self.check_err(
            n.relation(
                data,
                {"interval": "1240", "route_master": "bus", "type": "route_master"},
                [],
            ),
            expected={"class": 9014021, "subclass": 170114261},
        )
        self.check_err(
            n.relation(
                data, {"duration": "20minutes", "route": "bus", "type": "route"}, []
            ),
            expected={"class": 9014022, "subclass": 317647061},
        )
        self.check_not_err(
            n.relation(
                data, {"duration": "25:00", "route": "bus", "type": "route"}, []
            ),
            expected={"class": 9014022, "subclass": 317647061},
        )
        self.check_not_err(
            n.relation(
                data, {"duration": "120", "route": "ferry", "type": "route"}, []
            ),
            expected={"class": 9014022, "subclass": 317647061},
        )
        self.check_err(
            n.relation(
                data, {"duration": "1240", "route": "ferry", "type": "route"}, []
            ),
            expected={"class": 9014022, "subclass": 317647061},
        )
        self.check_not_err(
            n.relation(data, {"duration": "20", "route": "ferry", "type": "route"}, []),
            expected={"class": 9014022, "subclass": 317647061},
        )
        self.check_not_err(
            n.relation(
                data,
                {"duration": "02:00:00", "route": "bus", "type": "route_master"},
                [],
            ),
            expected={"class": 9014022, "subclass": 317647061},
        )
        self.check_not_err(
            n.relation(
                data,
                {"duration": "5", "route_master": "bus", "type": "route_master"},
                [],
            ),
            expected={"class": 9014022, "subclass": 317647061},
        )
