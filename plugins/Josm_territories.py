...
class Josm_territories(PluginMapCSS):
    ...
    def init(self, logger):
        ...
        self.errors[9009001] = self.def_class(
            item=9009, level=3, tags=["tag"], title=mapcss.tr("deprecated tagging")
        )
        self.errors[9009002] = self.def_class(
            item=9009, level=2, tags=["tag"], title=mapcss.tr("street name contains ss")
        )
        self.errors[9009003] = self.def_class(
            item=9009, level=2, tags=["tag"], title=mapcss.tr("street name contains ß")
        )
                        ...
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_5b84a257
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 0, tags, "addr:street"
                                ),
                            )
                        )
                        and (
                ...
                err.append(
                    {
                        "class": 9009002,
                        "subclass": 1817721249,
                        "text": mapcss.tr("street name contains ss"),
                    }
                )
                ...
                err.append(
                    {
                        "class": 9009003,
                        "subclass": 610086334,
                        "text": mapcss.tr("street name contains ß"),
                    }
                )
        ...
        if "type" in keys:
            ...
            if not match:
                ...
                try:
                    ...
                    ) and (mapcss.inside(self.father.config.options, "DE"))
                except mapcss.RuleAbort:
                    pass
            if match:
...
class Test(TestPluginMapcss):
    def test(self):
        ...
        self.check_err(
            n.way(data, {"name": "Hauptstrasse"}, [0]),
            expected={"class": 9009002, "subclass": 1817721249},
        )
        self.check_not_err(
            n.way(data, {"name": "Hauptstraße"}, [0]),
            expected={"class": 9009002, "subclass": 1817721249},
        )
        self.check_not_err(
            n.way(data, {"name": "Hochspannungstrasse"}, [0]),
            expected={"class": 9009002, "subclass": 1817721249},
        )
        self.check_not_err(
            n.way(data, {"name": "Kapitän-Strasser-Straße"}, [0]),
            expected={"class": 9009002, "subclass": 1817721249},
        )
        self.check_not_err(
            n.way(data, {"name": "Peter-Strasser-Platz"}, [0]),
            expected={"class": 9009002, "subclass": 1817721249},
        )
        self.check_not_err(
            n.way(data, {"name": "Hauptstrasse"}, [0]),
            expected={"class": 9009003, "subclass": 610086334},
        )
        self.check_err(
            n.way(data, {"name": "Hauptstraße"}, [0]),
            expected={"class": 9009003, "subclass": 610086334},
