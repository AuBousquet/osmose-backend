...
class Josm_DutchSpecific(PluginMapCSS):
    ...
    def init(self, logger):
        ...
        self.errors[90201] = self.def_class(
            item=9020, level=3, tags=[], title=mapcss.tr("NL addresses and contacts")
        )
        self.errors[90202] = self.def_class(
            item=9020, level=3, tags=[], title=mapcss.tr("NL deprecated features")
        )
        self.errors[90203] = self.def_class(
            item=9020, level=3, tags=[], title=mapcss.tr("NL nomenclature")
        )
        self.errors[90204] = self.def_class(
            item=9020, level=3, tags=[], title=mapcss.tr("NL heritage")
        )
        self.errors[90205] = self.def_class(
            item=9020, level=3, tags=[], title=mapcss.tr("NL traffic signs")
        )
        self.errors[90206] = self.def_class(
            item=9020, level=3, tags=[], title=mapcss.tr("NL German style tagging")
        )
        self.errors[90207] = self.def_class(
            item=9020, level=3, tags=[], title=mapcss.tr("NL speed limits")
        )
        self.errors[90208] = self.def_class(
            item=9020, level=3, tags=[], title=mapcss.tr("NL mofa tagging")
        )

        self.re_011bedaa = re.compile(
            r"^hgv(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_023db19d = re.compile(
            r"^(motor_)?vehicle(:backward|:both_ways)?(:conditional)?$"
        )
        ...
        self.re_06bae8ee = re.compile(
            r"^maxspeed:advisory(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_06ddeafa = re.compile(r"\bbouwweg")
        self.re_076895f4 = re.compile(r"payment:O[vV][-_]?[cC]hipkaart")
        self.re_08935e4d = re.compile(
            r"^maxspeed:advisory(:forward|:both_ways)?(:conditional)?$"
        )
        self.re_08ba1dfb = re.compile(r"(^|; ?)NL:C18\b")
        self.re_08f9030c = re.compile(r"(^|; ?)NL:L301\b")
        self.re_0abf5cfa = re.compile(r"(^|; ?)NL:C21\b")
        self.re_0c61efa0 = re.compile(
            r"^maxlength(:backward|:both_ways)?(:conditional)?$"
        )
        self.re_0cbcfeaf = re.compile(
            r"^maxspeed(:forward|:both_ways)?(:conditional)?$"
        )
        self.re_0e042431 = re.compile(
            r"^hazmat(:[A-E])?(:forward|:both_ways)?(:conditional)?$"
        )
        ...
        self.re_1705b261 = re.compile(
            r"(?i)(^|\sen\s)((on)?verplicht\s)?(\(?brom\)?)?fietspad$"
        )
        self.re_17085e60 = re.compile(r"houseboat|static_caravan")
        self.re_19b1af6a = re.compile(r"^paving_stones:([1-9])0$")
        self.re_1aa298e1 = re.compile(
            r"^maxheight(:backward|:both_ways)?(:conditional)?$"
        )
        self.re_1cc9227a = re.compile(
            r"^maxspeed(:backward|:both_ways)?(:conditional)?$"
        )
        ...
        self.re_21dc697e = re.compile(
            r"^maxaxleload(:backward|:both_ways)?(:conditional)?$"
        )
        self.re_229e1925 = re.compile(
            r"^hazmat(:[A-E])?(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_2441139b = re.compile(
            r"(?i)\b(aansl|empl|goed|ind|inhaalsp|opstel|overloopw|racc|rang|terr)\b"
        )
        self.re_251abd6a = re.compile(
            r"^(residential|unclassified|tertiary|secondary|primary|trunk|motorway|busway)(_link)?$"
        )
        self.re_252a5d6c = re.compile(r"forward")
        self.re_25a62b9d = re.compile(
            r"^(motor_)?vehicle(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_26516863 = re.compile(r".:covid19$")
        self.re_26ae994a = re.compile(
            r"^motorcycle(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_26e04b1e = re.compile(r"\b(([Aa]f)?gesloten|[Gg]eopend)\b")
        self.re_2823d45d = re.compile(
            r"^maxlength(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_287f5dd8 = re.compile(r"^(\+|00)31 ?0?( ?[0-9]){3,6}$")
        self.re_293c2706 = re.compile(r"^[A-Z][a-z]{1,4}\. ")
        self.re_2cd26805 = re.compile(
            r"^maxlength(:forward|:both_ways)?(:conditional)?$"
        )
        self.re_2f938f56 = re.compile(
            r"^(Adr|Anth?|Chr?|Corn|Fred|Hub|Jacq?|Joh|Jos|Mac|Nic|Ph|Th)\."
        )
        self.re_30fdb33a = re.compile(r"(?i)^(lift)$")
        self.re_31154585 = re.compile(
            r"^motorcycle(:forward|:both_ways)?(:conditional)?$"
        )
        self.re_3254c1c6 = re.compile(
            r"(?i)(parkeren$|parkeerplaats$|^toegang(sweg)?\s|^richting\s|drive.thro?u(gh)?)"
        )
        self.re_32d334cf = re.compile(r"(^|.+:)addr:street($|:.+)")
        self.re_33480e64 = re.compile(
            r"^maxheight(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_339dfcbd = re.compile(
            r"^maxweight(:backward|:both_ways)?(:conditional)?$"
        )
        self.re_33af5199 = re.compile(
            r"^motorcycle(:backward|:both_ways)?(:conditional)?$"
        )
        self.re_33fbfa8d = re.compile(r"(?i)post\W?nl$")
        self.re_345ec50a = re.compile(
            r"^maxweight(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_3894ceb2 = re.compile(r"^oneway:")
        self.re_39064d44 = re.compile(
            r"^(motorway(_link)?|trunk(_link)?|cycleway|service|busway|construction|proposed|raceway)$"
        )
        ...
        self.re_3cd0133e = re.compile(
            r"^access(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        ...
        self.re_460900e8 = re.compile(
            r"^maxspeed:advisory(:backward|:both_ways)?(:conditional)?$"
        )
        self.re_467ce1ba = re.compile(
            r"(?i)(parkeren|parkeerplaats|parkeergarage|^garage)$"
        )
        ...
        self.re_53816e1a = re.compile(
            r"^maxwidth(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_543ffeee = re.compile(r"(?i)(rolstoel|invaliden)")
        self.re_54b75cfc = re.compile(
            r"^maxwidth(:forward|:both_ways)?(:conditional)?$"
        )
        self.re_550ffc74 = re.compile(r"^building(:part)?$")
        self.re_556f4d08 = re.compile(
            r"^maxweight(:forward|:both_ways)?(:conditional)?$"
        )
        ...
        self.re_617e36ee = re.compile(
            r"^hazmat(:[A-E])?(:backward|:both_ways)?(:conditional)?$"
        )
        ...
        self.re_63f5f8f1 = re.compile(
            r"^maxheight(:forward|:both_ways)?(:conditional)?$"
        )
        self.re_640dd184 = re.compile(
            r"^trailer(:backward|:both_ways)?(:conditional)?$"
        )
        self.re_6454d3f5 = re.compile(
            r"stenen$|^hout$|\bbestraa?t(ing)?$|grond$|^puin$|^grind$|zand$"
        )
        self.re_65dfbf19 = re.compile(
            r"^(motor_)?vehicle(:forward|:both_ways)?(:conditional)?$"
        )
        self.re_676d2c9e = re.compile(
            r"\b(Adm|Br|Burg|Cmdt|Dr|Drs|Ds|Gebr|Gen|Ing|Ir|Jhr|Kard|Kon|Luit|Mej|Mevr|Mgr|Min|Mr|Past|Pr|Pres|Prof|St|Vr|Weth|Zr)\.? [A-Za-z]"
        )
        self.re_682234cc = re.compile(
            r"^foot(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        ...
        self.re_6b8a2885 = re.compile(
            r"^bicycle(:backward|:both_ways)?(:conditional)?$"
        )
        self.re_6cd83c9e = re.compile(r"(?i)^gratis\s|gratis\)")
        self.re_6e264741 = re.compile(r"(?i)^(Geldmaat|ABN.?AMRO|ING|Rabobank|SNS)\b")
        self.re_7087ae0d = re.compile(
            r"^trailer(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_7184e9bc = re.compile(r"^sidewalk:(left|right|both)$")
        self.re_71a0b33c = re.compile(r"(?i)(drinkwater|\swater|kraan)")
        self.re_7372291c = re.compile(
            r"^bicycle(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_73ea17b1 = re.compile(
            r"^moped(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_745836a5 = re.compile(r"^(brand|name|operator)$")
        self.re_74d9b833 = re.compile(r"^(.+):surface$")
        self.re_7531ba03 = re.compile(
            r"^maxaxleload(:forward|:both_ways)?(:conditional)?$"
        )
        self.re_7537ca1e = re.compile(r"\bNL:G0?7\b")
        self.re_75b7dc3e = re.compile(r"^oneway:hazmat")
        self.re_774d1ba2 = re.compile(
            r"^maxwidth(:backward|:both_ways)?(:conditional)?$"
        )
        self.re_78809448 = re.compile(r"^moped(:backward|:both_ways)?(:conditional)?$")
        self.re_798edef1 = re.compile(
            r"(?i)(aansl|empl|goed|ind|inhaalsp|opstel|overloopw|racc|rang|terr)\."
        )
        self.re_7acb98bb = re.compile(
            r"^maxspeed(:forward|:backward|:both_ways)?(:conditional)?$"
        )
        self.re_7be1bafc = re.compile(r"^1[23]0$")
        self.re_7c3d18b2 = re.compile(r"^(0031|\+31|0) ?[1-9]( ?[0-9]){11}")
        self.re_7d72e705 = re.compile(
            r"^maxaxleload(:forward|:backward|:both_ways)?(:conditional)?$"
        )
    ...
    def node(self, data, tags):
        ...
        keys = tags.keys()
        err = []
        set_abbrname = set_addrOnBuilding = set_altLivingStreet = set_badPhoneNumber = (
            set_completedSurfacePavingStonesNumber
        ) = set_housenameWithFix = set_multipleGsigns = set_steps = False
        ...
        if "highway" in keys and "traffic_sign" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss.list_contains(
                                mapcss._tag_capture(
                                    capture_tags, 0, tags, "traffic_sign"
                                ),
                                mapcss._value_capture(capture_tags, 0, "NL:L2"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "crossing")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "zebra", "zebra"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "crossing")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "uncontrolled", "uncontrolled"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "crossing")
                            != mapcss._value_const_capture(
                                capture_tags, 3, "marked", "marked"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                            == mapcss._value_capture(capture_tags, 4, "crossing")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "crossing")
                            != mapcss._value_const_capture(
                                capture_tags, 5, "traffic_signals", "traffic_signals"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 6, tags, "crossing_ref")
                            != mapcss._value_const_capture(
                                capture_tags, 6, "zebra", "zebra"
                            )
                        )
                    )
                    ...
                    match = (
                        (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 0, "NL:L02"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "crossing")
                ...
                err.append(
                    {
                        ...
                        "text": mapcss.tr(
                            ...
                            mapcss._tag_uncapture(
                                capture_tags, "{2.tag} + crossing_ref=zebra"
                            ),
                            mapcss._tag_uncapture(
                                capture_tags, "{3.tag} + crossing_ref=zebra"
                            ),
                        ),
                    }
                )
        ...
        # *[phone=~/^(00|\+)31 ?0( ?[0-9]){7,}/]
        if (
            ("contact:mobile" in keys)
            or ("contact:phone" in keys)
            or ("contact:whatsapp" in keys)
            or ("phone" in keys)
        ):
            match = False
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_594405dc),
                        mapcss._tag_capture(capture_tags, 0, tags, "contact:phone"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_594405dc),
                        mapcss._tag_capture(capture_tags, 0, tags, "contact:mobile"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_594405dc),
                        mapcss._tag_capture(capture_tags, 0, tags, "contact:whatsapp"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_594405dc),
                        mapcss._tag_capture(capture_tags, 0, tags, "phone"),
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1739574763,
                        "text": mapcss.tr(
                            "Invalid tag {0}: country code should not be followed by a 0",
        ...
        if ("contact:mobile" in keys) or ("contact:phone" in keys) or ("phone" in keys):
            ...
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_287f5dd8),
                        mapcss._tag_capture(capture_tags, 0, tags, "contact:phone"),
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "subclass": 345342642,
                        "text": mapcss.tr(
                            "Invalid tag {0}: short phone numbers cannot be used with international prefix (or: wrong phone number length)",
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                        ),
                    }
                )
        ...
        if (
            ...
            if not match:
                ...
                try:
                    match = (
                        (not set_badPhoneNumber)
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_7c3d18b2
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 0, tags, "contact:phone"
                                ),
                            )
                        )
                    ...
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 0, tags, "contact:mobile"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    ...
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 0, tags, "contact:whatsapp"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                ...
                err.append(
                    {
                        ...
                        "subclass": 50270752,
                        "text": mapcss.tr(
                            "Invalid tag {0}: too many digits (or foreign number, if so: ignore)",
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                        ),
                    }
                )
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, self.re_561be3ff))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, self.re_49026388
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, self.re_32d334cf
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "addr:interpolation"
                            )
                        )
                        and (
                            not mapcss._tag_capture(capture_tags, 3, tags, "addr:flats")
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 509151640,
                        "text": mapcss.tr(
                            "Incomplete address: {0} {1} {2} {3}",
                            mapcss.any_(mapcss.tag(tags, "addr:street"), "[street?]"),
                            mapcss.any_(
                                mapcss.tag(tags, "addr:housenumber"), "[housenumber?]"
                            ),
                            mapcss.any_(mapcss.tag(tags, "addr:postcode"), ""),
                            mapcss.any_(mapcss.tag(tags, "addr:city"), ""),
                        ),
                    }
                )
        ...
        if "addr:interpolation" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "addr:interpolation")
                    ) and (mapcss.inside(self.father.config.options, "NL"))
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "subclass": 864819394,
                        "text": mapcss.tr(
                            "Adressen ({0}) worden in Nederland individueel geïmporteerd uit de BAG",
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                        ),
                    }
                )
        ...
        if (
            ("is_in" in keys)
            or ("is_in:city" in keys)
            or ("is_in:continent" in keys)
            or ("is_in:country" in keys)
            or ("is_in:country_code" in keys)
            or ("is_in:province" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "is_in"
                    ) == mapcss._value_capture(capture_tags, 0, "NL")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "is_in:country")
                    ) and (mapcss.inside(self.father.config.options, "NL"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "is_in:city")
                    ) and (mapcss.inside(self.father.config.options, "NL"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "is_in:province")
                    ) and (mapcss.inside(self.father.config.options, "NL"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "is_in:continent")
                    ) and (mapcss.inside(self.father.config.options, "NL"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "is_in:country_code"
                    ) == mapcss._value_capture(capture_tags, 0, "NL")
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if True:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, self.re_076895f4)
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("NL deprecated features")
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, self.re_26516863)
                    ) and (mapcss.inside(self.father.config.options, "NL"))
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1496260396,
                        "text": mapcss.tr(
                            "There are no active covid-19 restrictions at the moment. Remove {0}.",
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                        ),
                        "allow_fix_override": True,
                        "fix": {
        ...
        if "amenity" in keys and "opening_hours" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "opening_hours")
                            == mapcss._value_capture(capture_tags, 0, "24/7")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "amenity")
                            == mapcss._value_capture(capture_tags, 1, "atm")
                        )
                        and (
                            mapcss.regexp_test(
                                self.re_6e264741,
                                mapcss._match_regex(tags, self.re_745836a5),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                ...
                err.append(
                    {
                        ...
                        "subclass": 1466427444,
                        "text": mapcss.tr(
                            "{0} op {1} is onwaarschijnlijk, Geldmaten zijn niet de hele nacht geopend",
                            mapcss._tag_uncapture(capture_tags, "{0.tag}"),
                            mapcss._tag_uncapture(capture_tags, "{1.tag}"),
                        ),
                    }
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_19b1af6a
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "surface"),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                        ...
                        "fix": {
                            "+": dict(
                                [
                                    (
                                        mapcss.concat(
                                            "paving_stones:length=0.",
                                            mapcss.get(
                                                mapcss.regexp_match(
                                                    self.re_19b1af6a,
                                                    mapcss.tag(tags, "surface"),
                                                ),
                                                1,
                                            ),
                                        )
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, self.re_74d9b833))
                        and (
                            mapcss.regexp_test(
                                self.re_19b1af6a,
                                mapcss._match_regex(tags, self.re_74d9b833),
                            )
                        )
                        and (
                            mapcss.count(mapcss.tag_regex(tags, self.re_74d9b833)) == 1
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                except mapcss.RuleAbort:
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (
                        (not set_completedSurfacePavingStonesNumber)
                        and (
                            mapcss.regexp_test(
                                self.re_19b1af6a,
                                mapcss._match_regex(tags, self.re_74d9b833),
                ...
                err.append(
                    {
                        ...
                        "subclass": 1665978272,
                        "text": mapcss.tr(
                            "{0} is deprecated", "*:surface=paving_stones:NN"
                        ),
                    }
                )
        ...
        if (
            ("amenity" in keys and "name" in keys)
            or ("highway" in keys and "name" in keys)
            or ("leisure" in keys and "name" in keys)
            or ("name" in keys)
        ):
            match = False
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_30fdb33a
                                ),
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "amenity")
                            == mapcss._value_capture(capture_tags, 1, "drinking_water")
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_71a0b33c
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "amenity")
                            == mapcss._value_capture(
                                capture_tags, 1, "charging_station"
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_0660931d
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
            ...
            if not match:
                ...
                try:
                    match = (mapcss._tag_capture(capture_tags, 0, tags, "name")) and (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_26e04b1e),
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.startswith(
                                mapcss._tag_capture(capture_tags, 1, tags, "amenity"),
                                mapcss._value_capture(capture_tags, 1, "parking"),
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_467ce1ba
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
            ...
            if not match:
                ...
                try:
                    match = (mapcss._tag_capture(capture_tags, 0, tags, "name")) and (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_6cd83c9e),
                            mapcss._tag_capture(capture_tags, 1, tags, "name"),
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_6b1906aa
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "route"))
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "playground")
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_5ed5036a
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.startswith(
                                mapcss._tag_capture(capture_tags, 1, tags, "leisure"),
                                mapcss._value_capture(capture_tags, 1, "dog"),
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_5b4448e5
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "leisure")
                            == mapcss._value_capture(capture_tags, 1, "pitch")
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_3c163648
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_6211f625
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "historic"))
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "tourism")
                            != mapcss._value_const_capture(
                                capture_tags, 3, "information", "information"
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 4, tags, "landuse"))
                        and (not mapcss._tag_capture(capture_tags, 5, tags, "highway"))
                        and (not mapcss._tag_capture(capture_tags, 6, tags, "boundary"))
        ...
        if "name" in keys and "place" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (not set_abbrname)
                        and (mapcss._tag_capture(capture_tags, 0, tags, "name"))
                        and (mapcss._tag_capture(capture_tags, 1, tags, "place"))
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_676d2c9e
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_293c2706
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    3,
                                    self.re_2f938f56,
                                    "^(Adr|Anth?|Chr?|Corn|Fred|Hub|Jacq?|Joh|Jos|Mac|Nic|Ph|Th)\.",
                                ),
                ...
                err.append(
                    {
                        "class": 90203,
                        "subclass": 1573033356,
                        "text": mapcss.tr("Gebiedsnaam met afkorting"),
                    }
                )
        ...
        if "name" in keys and "railway" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (not set_abbrname)
                        and (mapcss._tag_capture(capture_tags, 0, tags, "railway"))
                        and (mapcss._tag_capture(capture_tags, 1, tags, "name"))
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_798edef1
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_2441139b
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        "class": 90203,
                        "subclass": 1558593366,
                        "text": mapcss.tr("Spoorgebied met afgekorte naam"),
                    }
                )
        ...
        if ("name:fy" in keys and "name:nl" in keys) or ("name:nl" in keys):
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "name:nl"))
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "name"))
                        and (mapcss.inside(self.father.config.options, "NL"))
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "type")
                            != mapcss._value_const_capture(
                                capture_tags, 3, "route", "route"
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "name:fy"))
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "name:fy")
                            == mapcss._value_capture(
                                capture_tags, 5, mapcss.tag(tags, "name:nl")
                            )
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (not mapcss._tag_capture(capture_tags, 4, tags, "name:fy"))
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "amenity" in keys and "operator" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "operator"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "operator")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "PostNL", "PostNL"
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_33fbfa8d
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "operator"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "amenity")
                            == mapcss._value_capture(capture_tags, 3, "post_box")
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "heritage" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "heritage")
                        == mapcss._value_capture(capture_tags, 0, 1)
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "heritage:operator")
                        != mapcss._value_const_capture(capture_tags, 1, "whc", "whc")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "heritage")
                            == mapcss._value_capture(capture_tags, 0, 2)
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "heritage:operator"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 1, "rce", "rce"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
        ...
        if "ref:rce" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "ref:rce")
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "heritage:operator"
                        )
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["heritage:operator", "rce"]])},
                    }
                )
        ...
        if "heritage:operator" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "heritage:operator")
                        == mapcss._value_capture(capture_tags, 0, "rce")
                    ) and (not mapcss._tag_capture(capture_tags, 1, tags, "heritage"))
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("NL heritage")
    ...
    def way(self, data, tags, nds):
        ...
        if ("highway" in keys and "mofa" in keys and "traffic_sign" in keys) or (
            "highway" in keys and "moped" in keys and "traffic_sign" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "traffic_sign"
                                ),
                                mapcss._value_capture(capture_tags, 1, "NL:G11"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "moped"))
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 3, self.re_47aaa0f7
                                ),
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:G12a"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "moped"))
                        and (
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 2, tags, "mofa"))
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 3, self.re_143f11c5
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:G13"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "moped"))
                        and (
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:D103"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "moped"))
                        and (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 4, "construction", "construction"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:D104"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "moped"))
                        and (
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "moped"))
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "mofa"))
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, "motor_vehicle"
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 4, tags, "access"))
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:F13"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "bus"))
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "psv"))
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 4, "busway", "busway"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 5, "bus_guideway", "bus_guideway"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:F17"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "bus"))
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "psv"))
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:F19"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "bus"))
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "psv"))
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "hgv"))
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:F21"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "hgv"))
                    )
                ...
                err.append(
                    {
                        ...
                        "text": mapcss.tr(
                            "{0} without {1}",
                            mapcss._tag_uncapture(capture_tags, "{1.tag}"),
                            mapcss._tag_uncapture(capture_tags, "{2.key}=designated"),
                        ),
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict(
        ...
        if (
            ("bus" in keys and "highway" in keys and "traffic_sign" in keys)
            or ("hgv" in keys and "highway" in keys and "traffic_sign" in keys)
            or ("highway" in keys and "psv" in keys and "traffic_sign" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "bus")
                            == mapcss._value_capture(capture_tags, 2, "no")
                        )
                        and (
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "psv")
                            == mapcss._value_capture(capture_tags, 2, "no")
                        )
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "bus"))
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 4, "construction", "construction"
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "hgv")
                            == mapcss._value_capture(capture_tags, 2, "no")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "highway")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_08f9030c),
                            mapcss._tag_capture(capture_tags, 1, tags, "traffic_sign"),
                        )
                    )
                except mapcss.RuleAbort:
                    pass
                    ...
                    match = (
                        ...
                        and (
                            mapcss.string_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:G"),
                            )
                        )
                        and (
                            mapcss.count(
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    2,
                                    self.re_251abd6a,
                                    "^(residential|unclassified|tertiary|secondary|primary|trunk|motorway|busway)(_link)?$",
                                ),
        ...
        if "highway" in keys and "traffic_sign" in keys:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "busway", "busway"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 3, "service", "service"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 4, "bus_guideway", "bus_guideway"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 5, "construction", "construction"
                            )
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (not set_altLivingStreet)
                        and (mapcss._tag_capture(capture_tags, 0, tags, "highway"))
                        and (
                            mapcss.list_contains(
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "traffic_sign"
                                ),
                                mapcss._value_capture(capture_tags, 1, "NL:G5"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "living_street", "living_street"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "highway")
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 4, "path", "path"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 5, "cycleway", "cycleway"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 6, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 6, "pedestrian", "pedestrian"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 7, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 7, "bridleway", "bridleway"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 8, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 8, "steps", "steps"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:G05"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:G7"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "footway", "footway"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 3, "steps", "steps"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 4, "pedestrian", "pedestrian"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "highway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:G07"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:G7-ZB"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:G07-ZB"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:G9"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "bridleway", "bridleway"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "highway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:G09"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "cycleway", "cycleway"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "highway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.string_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:L301"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "steps", "steps"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "highway")
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 4, self.re_08f9030c
                                ),
                                mapcss._tag_capture(
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:L51"),
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "cyclestreet"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "highway")
        ...
        if (
            ("highway" in keys and "traffic_sign" in keys)
            or ("highway" in keys and "traffic_sign:backward" in keys)
            or ("highway" in keys and "traffic_sign:forward" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C1"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "vehicle"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_25a62b9d
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 4, tags, self.re_3cd0133e
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "highway")
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "traffic_sign:forward"
                                ),
                                mapcss._value_capture(capture_tags, 1, "NL:C1"),
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "vehicle:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_65dfbf19
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 4, tags, self.re_4cfe628c
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "highway")
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "traffic_sign:backward"
                                ),
                                mapcss._value_capture(capture_tags, 1, "NL:C1"),
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "vehicle:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_023db19d
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 4, tags, self.re_4d87e9ab
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "highway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C01"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "vehicle"))
                        and (
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C6"),
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "motor_vehicle"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "motor_vehicle:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "motor_vehicle:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 7, tags, "oneway:motor_vehicle"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 7, "yes", "yes"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C06"),
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C7"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "hgv"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_011bedaa
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "hgv:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_1faa7e13
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "hgv:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_5577fcc2
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "oneway:hgv")
                            != mapcss._value_const_capture(
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C07"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "hgv"))
                        and (
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C9"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "bicycle"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_7372291c
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "bicycle:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_033b234a
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "bicycle:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_6b8a2885
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "oneway:bicycle")
                            != mapcss._value_const_capture(
                                capture_tags, 5, "yes", "yes"
                            )
                        )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_73ea17b1
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "moped:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_697de1f2
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "moped:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_78809448
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "oneway:moped")
                            != mapcss._value_const_capture(
                                capture_tags, 5, "yes", "yes"
                            )
                        )
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C09"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "bicycle"))
                        and (
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C10"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "trailer"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_7087ae0d
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "trailer:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_4e099629
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "trailer:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_640dd184
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "oneway:trailer")
                            != mapcss._value_const_capture(
                                capture_tags, 5, "yes", "yes"
                            )
                        )
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C11"),
                            )
                        )
                        and (
                            not mapcss._tag_capture(capture_tags, 2, tags, "motorcycle")
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_26ae994a
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "motorcycle:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_31154585
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "motorcycle:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_33af5199
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 5, tags, "oneway:motorcycle"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 5, "yes", "yes"
                            )
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C12"),
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C13"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "moped"))
                        and (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 5, "footway", "footway"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 6, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 6, "footway", "footway"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C14"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "bicycle"))
                        and (
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C15"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "bicycle"))
                        and (
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C16"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "foot"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_682234cc
                            )
                        )
                        and (
                            not mapcss._tag_capture(
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "foot:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_0f9e3c59
                            )
                        )
                        and (
                            not mapcss._tag_capture(
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "foot:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_4e4468f8
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 6, tags, "oneway:foot")
                            != mapcss._value_const_capture(
                                capture_tags, 6, "yes", "yes"
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "text": mapcss.tr(
                            ...
                            mapcss._tag_uncapture(capture_tags, "{1.tag}"),
                            mapcss._tag_uncapture(
                                capture_tags, "{2.key}=no/private/destination/..."
                            ),
                        ),
                    }
                )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_619cd3d8
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "traffic_sign"
                                ),
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, self.re_229e1925
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                        ...
                        and (mapcss._tag_capture(capture_tags, 6, tags, "highway"))
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "traffic_sign:forward"
                            )
                        )
                        and (
                            mapcss.regexp_test(
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, self.re_0e042431
                            )
                        )
                        and (
                            not mapcss._tag_capture(
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "traffic_sign:backward"
                            )
                        )
                        and (
                            mapcss.regexp_test(
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, self.re_617e36ee
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                        ...
                        and (
                            not mapcss.regexp_test(
                                self.re_51f98600,
                                mapcss._match_regex(tags, self.re_75b7dc3e),
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "text": mapcss.tr(
                            "{0} without {1} or {2}",
                            mapcss._tag_uncapture(capture_tags, "{0.tag}"),
                            "hazmat=no/private/destination/...",
                            "hazmat:A-E=no/private/destination/...",
                        ),
                    }
                )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_0e900094
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "traffic_sign"
                                ),
                        ...
                        and (
                            not mapcss._tag_capture(capture_tags, 2, tags, "maxlength")
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_2823d45d
                            )
                        )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "maxlength:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_2cd26805
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "maxlength:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_0c61efa0
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_08ba1dfb
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "traffic_sign"
                                ),
                        ...
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "maxwidth"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_53816e1a
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "maxwidth:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_54b75cfc
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "maxwidth:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_774d1ba2
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_4065f95d
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "traffic_sign"
                                ),
                        ...
                        and (
                            not mapcss._tag_capture(capture_tags, 2, tags, "maxheight")
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_33480e64
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "maxheight:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_63f5f8f1
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "maxheight:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_1aa298e1
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_59aca94c
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "traffic_sign"
                                ),
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "maxaxleload"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_7d72e705
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "maxaxleload:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_7531ba03
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "maxaxleload:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_21dc697e
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_0abf5cfa
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "traffic_sign"
                                ),
                        ...
                        and (
                            not mapcss._tag_capture(capture_tags, 2, tags, "maxweight")
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_345ec50a
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "maxweight:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_556f4d08
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "maxweight:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_339dfcbd
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C2"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "oneway")
                            != mapcss._value_const_capture(
                        ...
                        and (
                            mapcss.regexp_test(
                                self.re_42dce20e,
                                mapcss.join_list(
                                    "", mapcss.tag_regex(tags, self.re_3894ceb2)
                                ),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "oneway")
                            != mapcss._value_capture(capture_tags, 4, -1)
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "highway")
                            != mapcss._value_const_capture(
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C02"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "oneway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C3"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "oneway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C03"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "oneway")
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 5, self.re_1d478f9e, "\bNL:C0?2\b"
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 5, tags, "traffic_sign:backward"
                                ),
                            )
                        )
                    )
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C5"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "oneway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:C05"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "oneway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:D1"),
                            )
                        )
                        and (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "junction")
                            != mapcss._value_const_capture(
                                capture_tags, 3, "circular", "circular"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:D01"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "junction")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "junction")
                            == mapcss._value_capture(capture_tags, 2, "circular")
                        )
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 3, self.re_3bd9d067, "^(yes|-?1)$"
                                ),
                                mapcss._tag_capture(capture_tags, 3, tags, "oneway"),
                            )
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "traffic_sign")
                            == mapcss._value_capture(capture_tags, 0, "NL:B1")
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "priority_road"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "priority_road:forward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, "priority_road:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 4, tags, "priority_road:both_ways"
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 5, tags, "highway"))
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "traffic_sign")
                            == mapcss._value_capture(capture_tags, 0, "NL:B01")
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "priority_road"
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, "priority_road:both_ways"
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "priority_road:backward"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
        ...
        if (
            ("highway" in keys and "parking:both" in keys and "traffic_sign" in keys)
            or (
                "highway" in keys
                and "parking:both" in keys
                and "traffic_sign:left" in keys
            )
            or (
                "highway" in keys
                and "parking:both" in keys
                and "traffic_sign:right" in keys
            )
            or (
                "highway" in keys
                and "parking:lane:right" in keys
                and "parking:left" in keys
                and "traffic_sign" in keys
            )
            or (
                "highway" in keys
                and "parking:left" in keys
                and "parking:right" in keys
                and "traffic_sign" in keys
            )
            or (
                "highway" in keys
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "parking:both:restriction"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 0, "no_parking", "no_parking"
                            )
                        )
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:E01"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "highway"))
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "parking:both")
                            == mapcss._value_capture(capture_tags, 3, "no")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 4, tags, "parking:right:restriction"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 4, "no_parking", "no_parking"
                            )
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 5, tags, "parking:left:restriction"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 5, "no_parking", "no_parking"
                            )
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 2, tags, "highway"))
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "parking:left")
                            == mapcss._value_capture(capture_tags, 3, "no")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 4, tags, "parking:lane:right"
                            )
                            == mapcss._value_capture(capture_tags, 4, "no")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 5, tags, "parking:right:restriction"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 5, "no_parking", "no_parking"
                            )
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 6, tags, "parking:left:restriction"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 6, "no_parking", "no_parking"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:E1"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "highway"))
                        and (
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "parking:right:restriction"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 0, "no_parking", "no_parking"
                            )
                        ...
                        and (
                            mapcss.list_contains(
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "traffic_sign:right"
                                ),
                                mapcss._value_capture(capture_tags, 1, "NL:E01"),
                            )
                        )
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 4, tags, "parking:both:restriction"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 4, "no_parking", "no_parking"
                            )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 2, tags, "highway"))
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "parking:right")
                            == mapcss._value_capture(capture_tags, 3, "no")
                        )
                        and (
                            mapcss._tag_capture(
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "parking:left:restriction"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 0, "no_parking", "no_parking"
                            )
                        ...
                        and (
                            mapcss.list_contains(
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "traffic_sign:left"
                                ),
                                mapcss._value_capture(capture_tags, 1, "NL:E01"),
                            )
                        )
                ...
                try:
                    match = (
                        (
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 0, "no_stopping", "no_stopping"
                            )
                        )
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:E02"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "highway"))
                        and (
                        ...
                        and (
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 4, "no_stopping", "no_stopping"
                            )
                        )
                        and (
                            mapcss._tag_capture(
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 5, "no_stopping", "no_stopping"
                            )
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "parking:right")
                            == mapcss._value_capture(capture_tags, 4, "no")
                        )
                        and (
                            mapcss._tag_capture(
                        ...
                        and (
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 6, "no_stopping", "no_stopping"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:E2"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "highway"))
                        and (
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:F5"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "priority"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_5012755c
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:F05"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "priority"))
                        and (
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:F6"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "priority"))
                        and (
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(capture_tags, 1, "NL:F06"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "priority"))
                        and (
                ...
                err.append(
                    {
                        ...
                        "text": mapcss.tr(
                            "{0} without {1} or {2}",
                            mapcss._tag_uncapture(capture_tags, "{1.tag}"),
                            mapcss._tag_uncapture(capture_tags, "{2.key}=forward"),
                            mapcss._tag_uncapture(capture_tags, "{2.key}=backward"),
                        ),
                    }
                )
        ...
        if ("highway" in keys and "traffic_sign:backward" in keys) or (
            "highway" in keys and "traffic_sign:forward" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "priority")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "backward", "backward"
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                self.re_68a71d57,
                                mapcss._match_regex(tags, self.re_5012755c),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "priority")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "forward", "forward"
                            )
                        )
                        and (
                            not mapcss.regexp_test(
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, self.re_5ef8db88)
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "amenity")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "place_of_worship", "place_of_worship"
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                ...
                err.append(
                    {
                        ...
                        "subclass": 822822875,
                        "text": mapcss.tr(
                            "In Nederland is het gebouw niet gekoppeld aan het adres. Het adres is wel gekoppeld aan het gebruiksdoel."
                        ),
                    }
                )
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (
                        (not set_addrOnBuilding)
                        and (mapcss._tag_capture(capture_tags, 0, tags, "addr:street"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, self.re_49026388
                            )
        ...
        if ("cycleway:surface" in keys and "highway" in keys and "surface" in keys) or (
            "footway:surface" in keys and "highway" in keys and "surface" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "cycleway:surface"))
                        and (mapcss._tag_capture(capture_tags, 1, tags, "surface"))
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                            == mapcss._value_capture(capture_tags, 2, "cycleway")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "surface")
                            == mapcss._value_capture(
                                capture_tags, 3, mapcss.tag(tags, "cycleway:surface")
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "footway:surface"))
                        and (mapcss._tag_capture(capture_tags, 1, tags, "surface"))
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "highway")
                            == mapcss._value_capture(capture_tags, 2, "footway")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "surface")
                            == mapcss._value_capture(
                                capture_tags, 3, mapcss.tag(tags, "footway:surface")
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
        ...
        if ("cycleway:surface" in keys and "highway" in keys) or (
            "footway:surface" in keys and "highway" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "cycleway")
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "surface"))
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "highway")
                            == mapcss._value_capture(capture_tags, 1, "footway")
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "surface"))
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
        ...
        if (
            "cycleway:surface" in keys
            and "footway:surface" in keys
            and "highway" in keys
            and "segregated" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "cycleway:surface"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "segregated")
                            == mapcss._value_capture(capture_tags, 2, "no")
                        )
                        and (mapcss._tag_capture(capture_tags, 3, tags, "highway"))
                        and (
                            mapcss._tag_capture(
                                capture_tags, 4, tags, "footway:surface"
                            )
                            != mapcss._value_capture(
                                capture_tags, 4, mapcss.tag(tags, "cycleway:surface")
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, self.re_5f5aa10b))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, self.re_7184e9bc)
                        )
                        and (
                            mapcss.regexp_test(
                                self.re_51f98600,
                                mapcss._match_regex(tags, self.re_7184e9bc),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_5e498788
                                ),
        ...
        if ("cycleway" in keys and "highway" in keys) or (
            "highway" in keys and "segregated" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "cycleway")
                            != mapcss._value_const_capture(capture_tags, 2, "no", "no")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "cycleway")
                            != mapcss._value_const_capture(
                                capture_tags, 3, "lane", "lane"
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 4, self.re_7537ca1e, "\bNL:G0?7\b"
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 4, tags, "traffic_sign"
                                ),
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 2, self.re_7537ca1e, "\bNL:G0?7\b"
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "traffic_sign"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
        ...
        if (
            ("cycleway" in keys)
            or ("cycleway:both" in keys)
            or ("cycleway:left" in keys)
            or ("cycleway:right" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        == mapcss._value_capture(capture_tags, 0, "opposite")
                    ) and (mapcss.inside(self.father.config.options, "NL"))
                except mapcss.RuleAbort:
                    pass
            if not match:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "cycleway:both")
                        == mapcss._value_capture(capture_tags, 0, "opposite")
                    ) and (mapcss.inside(self.father.config.options, "NL"))
                except mapcss.RuleAbort:
                    pass
                    ...
                    match = (
                        ...
                        and (
                            mapcss.startswith(
                                ...
                                mapcss._value_capture(capture_tags, 1, "opposite_"),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.startswith(
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "cycleway:left"
                                ),
                                mapcss._value_capture(capture_tags, 1, "opposite_"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.startswith(
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "cycleway:right"
                                ),
                                mapcss._value_capture(capture_tags, 1, "opposite_"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.startswith(
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "cycleway:both"
                                ),
                                mapcss._value_capture(capture_tags, 1, "opposite_"),
                            )
                        )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "building")
                            == mapcss._value_capture(capture_tags, 0, "terrace")
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                        and (
                            mapcss._tag_capture(capture_tags, -1, tags, "area")
                ...
                err.append(
                    {
                        ...
                        "subclass": 2130098421,
                        "text": mapcss.tr(
                            "Een rij met rijtjeshuizen ({0}) wordt in Nederland per huis geïmporteerd uit de BAG",
                            mapcss._tag_uncapture(capture_tags, "{0.tag}"),
                        ),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "tracks"))
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "tracks")
                            != mapcss._value_capture(capture_tags, 2, 1)
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 379490980,
                        "text": mapcss.tr(
                            "Railway lines should be drawn as separate ways per track, rather than one way with {0}",
                            mapcss._tag_uncapture(capture_tags, "{1.tag}"),
                        ),
                    }
                )
        ...
        if ("addr:housename" in keys) or ("building:name" in keys):
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "addr:housename"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, self.re_550ffc74)
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "name"))
                        and (
                            mapcss._tag_capture(capture_tags, -1, tags, "area")
                            != mapcss._value_const_capture(capture_tags, -1, "no", "no")
                        )
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "building:name"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, self.re_550ffc74)
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
        ...
        if ("addr:housename" in keys and "name" in keys) or (
            "building:name" in keys and "name" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "name")
                            == mapcss._value_capture(
                                capture_tags, 3, mapcss.tag(tags, "addr:housename")
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, -1, tags, "area")
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "name")
                            == mapcss._value_capture(
                                capture_tags, 3, mapcss.tag(tags, "building:name")
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, -1, tags, "area")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss.inside(self.father.config.options, "NL"))
                        and (mapcss._tag_capture(capture_tags, 3, tags, "name"))
                        and (
                            mapcss._tag_capture(capture_tags, -1, tags, "area")
                            != mapcss._value_const_capture(capture_tags, -1, "no", "no")
                        )
        ...
        if "bicycle_road" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "bicycle_road")
                        in ("yes", "true", "1")
                    ) and (mapcss.inside(self.father.config.options, "NL"))
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "subclass": 1111134078,
                        "text": mapcss.tr(
                            "Het concept {0} bestaat niet in Nederland",
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                        ),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_6454d3f5),
                            mapcss._tag_capture(capture_tags, 1, tags, "surface"),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "highway")
                            == mapcss._value_capture(capture_tags, 1, "service")
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_3254c1c6
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_1705b261
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_44720f99
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_543ffeee
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_3b2cb1d7
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_1582ff37
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 3, "busway", "busway"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 4, "service", "service"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "highway")
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_06ddeafa
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        "class": 90203,
                        "subclass": 397885213,
                        "text": mapcss.tr("Straatnaam met afkorting"),
                    }
                )
        ...
        if (
            ("highway" in keys)
            or ("highway" in keys and "maxspeed:type" in keys)
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "maxspeed")
                            != mapcss._value_capture(capture_tags, 1, 15)
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, self.re_1d614d5c
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "highway")
                            != mapcss._value_const_capture(
                                capture_tags, 3, "living_street", "living_street"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "maxspeed:type")
                            == mapcss._value_capture(capture_tags, 0, "NL:zone30")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "maxspeed")
                            != mapcss._value_capture(capture_tags, 1, 30)
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "maxspeed:both_ways"
                            )
                            != mapcss._value_capture(capture_tags, 2, 30)
                        )
                        and (mapcss._tag_capture(capture_tags, 3, tags, "highway"))
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "maxspeed:type")
                            == mapcss._value_capture(capture_tags, 0, "NL:zone60")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "maxspeed")
                            != mapcss._value_capture(capture_tags, 1, 60)
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "maxspeed:both_ways"
                            )
                            != mapcss._value_capture(capture_tags, 2, 60)
                        )
                        and (mapcss._tag_capture(capture_tags, 3, tags, "highway"))
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "maxspeed:type")
                            == mapcss._value_capture(capture_tags, 0, "NL:urban")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "maxspeed")
                            != mapcss._value_capture(capture_tags, 1, 50)
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "maxspeed:both_ways"
                            )
                            != mapcss._value_capture(capture_tags, 2, 50)
                        )
                        and (mapcss._tag_capture(capture_tags, 3, tags, "highway"))
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "maxspeed:type")
                            == mapcss._value_capture(capture_tags, 0, "NL:rural")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "maxspeed")
                            != mapcss._value_capture(capture_tags, 1, 80)
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "maxspeed:both_ways"
                            )
                            != mapcss._value_capture(capture_tags, 2, 80)
                        )
                        and (mapcss._tag_capture(capture_tags, 3, tags, "highway"))
                    )
                except mapcss.RuleAbort:
        ...
        if (
            ("highway" in keys and "maxspeed:type" in keys)
            or ("highway" in keys and "traffic_sign" in keys)
            or ("highway" in keys and "traffic_sign:backward" in keys)
            or ("highway" in keys and "traffic_sign:forward" in keys)
        ):
            match = False
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.startswith(
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "maxspeed:type"
                                ),
                                mapcss._value_capture(capture_tags, 2, "NL:zone"),
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, "maxspeed:both_ways"
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 4, self.re_1d0c9a01, "^NL:zone[36]0$"
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 4, tags, "maxspeed:type"
                                ),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 5, tags, "highway"))
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_4547b418
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "traffic_sign"
                                ),
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_7acb98bb
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_0cbcfeaf
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_1cc9227a
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "maxspeed:advisory"
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_5a895116
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "traffic_sign"
                                ),
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_06bae8ee
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "maxspeed:advisory:forward"
                            )
                        )
                        and (
                            mapcss.regexp_test(
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_08935e4d
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "maxspeed:advisory:backward"
                            )
                        )
                        and (
                            mapcss.regexp_test(
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, self.re_460900e8
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "highway"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "highway")
                            == mapcss._value_capture(capture_tags, 0, "motorway")
                        )
                        and (mapcss._tag_capture(capture_tags, 1, tags, "maxspeed"))
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_7be1bafc
                                ),
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 3, self.re_5578cc63
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 3, tags, "maxspeed:conditional"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                ...
                err.append(
                    {
                        ...
                        "subclass": 640790005,
                        "text": mapcss.tr(
                            "Agreed upon was to use 100 as the maximum speed and {0} as the conditional maximum speed",
        ...
        if ("highway" in keys and "maxspeed" in keys) or (
            "maxspeed" in keys and "motorroad" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "maxspeed")
                            > mapcss._value_capture(capture_tags, 2, 130)
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "highway")
                            == mapcss._value_capture(capture_tags, 0, "motorway_link")
                        )
                        and (mapcss._tag_capture(capture_tags, 1, tags, "maxspeed"))
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "maxspeed")
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "highway")
                            == mapcss._value_capture(capture_tags, 0, "trunk")
                        )
                        and (mapcss._tag_capture(capture_tags, 1, tags, "maxspeed"))
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "maxspeed")
                            > mapcss._value_capture(capture_tags, 2, 100)
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "highway")
                            == mapcss._value_capture(capture_tags, 0, "trunk_link")
                        )
                        and (mapcss._tag_capture(capture_tags, 1, tags, "maxspeed"))
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "maxspeed")
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    4,
                                    self.re_62e192cf,
                                    "^(motorway(_link)?|construction|proposed)$",
                                ),
                                mapcss._tag_capture(capture_tags, 4, tags, "highway"),
                            )
                        )
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    3,
                                    self.re_39064d44,
                                    "^(motorway(_link)?|trunk(_link)?|cycleway|service|busway|construction|proposed|raceway)$",
                                ),
                                mapcss._tag_capture(capture_tags, 3, tags, "highway"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "motorroad")
                            != mapcss._value_const_capture(
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "maxspeed")
                            > mapcss._value_capture(capture_tags, 2, 40)
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, "motor_vehicle"
                        ...
                        and (not mapcss._tag_capture(capture_tags, 4, tags, "vehicle"))
                        and (not mapcss._tag_capture(capture_tags, 5, tags, "access"))
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if (
            ("maxspeed:bus" in keys)
            or ("maxspeed:hgv" in keys)
            or ("maxspeed:mofa" in keys)
            or ("maxspeed:moped" in keys)
            or ("maxspeed:trailer" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "maxspeed:mofa"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "maxspeed:mofa")
                            > mapcss._value_capture(capture_tags, 1, 25)
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "maxspeed:moped"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "maxspeed:moped")
                            > mapcss._value_capture(capture_tags, 1, 45)
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "maxspeed:bus"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "maxspeed:bus")
                            > mapcss._value_capture(capture_tags, 1, 100)
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "maxspeed:trailer"))
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "maxspeed:trailer"
                            )
                            > mapcss._value_capture(capture_tags, 1, 90)
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "maxspeed:hgv"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "maxspeed:hgv")
                            > mapcss._value_capture(capture_tags, 1, 80)
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
                ...
                err.append(
                    {
                        ...
                        "subclass": 790150725,
                        "text": mapcss.tr(
                            "{0} overschrijdt de maximumsnelheid van RVV art. 22",
                            mapcss._tag_uncapture(capture_tags, "{0.tag}"),
                        ),
                    }
                )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_5fbb635f
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "maxspeed"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "maxspeed")
                            != mapcss._value_capture(capture_tags, 2, 5)
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "maxspeed")
                            != mapcss._value_capture(capture_tags, 3, 15)
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 4, self.re_251abd6a
                                ),
                                mapcss._tag_capture(capture_tags, 4, tags, "highway"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 5, tags, "access"))
                        and (not mapcss._tag_capture(capture_tags, 6, tags, "vehicle"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 7, tags, "motor_vehicle"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "maxspeed")
                            == mapcss._value_capture(capture_tags, 0, 20)
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_251abd6a
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "highway"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "access"))
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "vehicle"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 4, tags, "motor_vehicle"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "maxspeed")
                            == mapcss._value_capture(capture_tags, 0, 40)
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                ...
                err.append(
                    {
                        ...
                        "subclass": 441867371,
                        "text": mapcss.tr(
                            "{0} is a non-standard speed limit. Possibly this is an advisory speed limit instead?",
                            mapcss._tag_uncapture(capture_tags, "{0.tag}"),
                        ),
                    }
                )
        ...
        if "oneway" in keys and "oneway:bicycle" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "oneway:bicycle"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "oneway:mofa"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "oneway")
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 3, self.re_55879a11
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 3, tags, "oneway:bicycle"
                                ),
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(capture_tags, 4, tags, "mofa"),
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 5, tags, "motor_vehicle"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "NL"))
        ...
        if (
            ("bicycle" in keys and "moped" in keys)
            or ("bicycle:backward" in keys and "moped:backward" in keys)
            or ("bicycle:both_ways" in keys and "moped:both_ways" in keys)
            or ("bicycle:forward" in keys and "moped:forward" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "bicycle:forward"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "moped:forward")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "bicycle:forward"
                            ...
                            == mapcss._value_capture(
                                capture_tags, 2, mapcss.tag(tags, "moped:forward")
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "mofa"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 4, tags, "mofa:forward"
                            )
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 5, tags, "bicycle:forward"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 5, "designated", "designated"
                            )
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 6, tags, "bicycle:forward"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 6, "yes", "yes"
                            )
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "bicycle:backward"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "moped:backward")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "bicycle:backward"
                            ...
                            == mapcss._value_capture(
                                capture_tags, 2, mapcss.tag(tags, "moped:backward")
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "mofa"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 4, tags, "mofa:backward"
                            )
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 5, tags, "bicycle:backward"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 5, "designated", "designated"
                            )
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 6, tags, "bicycle:backward"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 6, "yes", "yes"
                            )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "bicycle:both_ways"
                            )
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "moped:both_ways"
                            )
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "bicycle:both_ways"
                            )
                            == mapcss._value_capture(
                                capture_tags, 2, mapcss.tag(tags, "moped:both_ways")
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "mofa"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 4, tags, "mofa:both_ways"
                            )
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 5, tags, "bicycle:both_ways"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 5, "designated", "designated"
                            )
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 6, tags, "bicycle:both_ways"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 6, "yes", "yes"
                            )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "moped"))
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "bicycle")
                            == mapcss._value_capture(
                                capture_tags, 2, mapcss.tag(tags, "moped")
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "mofa"))
                        and (
                            mapcss._tag_capture(capture_tags, 4, tags, "bicycle")
                            != mapcss._value_const_capture(
                                capture_tags, 4, "designated", "designated"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 5, tags, "bicycle")
                            != mapcss._value_const_capture(
                                capture_tags, 5, "yes", "yes"
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "text": mapcss.tr(
                            ...
                            mapcss._tag_uncapture(capture_tags, "{0.tag}"),
                            mapcss._tag_uncapture(capture_tags, "{1.tag}"),
                            mapcss._tag_uncapture(capture_tags, "{3.key}={0.value}"),
                        ),
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict(
    ...
    def relation(self, data, tags, members):
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        == mapcss._value_capture(capture_tags, 0, "associatedStreet")
                    ) and (mapcss.inside(self.father.config.options, "NL"))
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        # area[addr:housename][/^building(:part)?$/][inside("NL")][!name]
        # area[building:name][/^building(:part)?$/][inside("NL")][!name]
        if ("addr:housename" in keys and "type" in keys) or (
            "building:name" in keys and "type" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
        ...
        # area[addr:housename][/^building(:part)?$/][inside("NL")][name=*"addr:housename"]!.housenameWithFix
        # area[building:name][/^building(:part)?$/][inside("NL")][name=*"building:name"]!.housenameWithFix
        if ("addr:housename" in keys and "name" in keys and "type" in keys) or (
            "building:name" in keys and "name" in keys and "type" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
...
class Test(TestPluginMapcss):
    def test(self):
        ...
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "highway": "crossing",
                    "note": "traffic_signals_combined_with_zebra",
                    "traffic_sign": "NL:L02",
                },
            ),
            expected={"class": 90205, "subclass": 938076772},
        )
        self.check_err(
            n.node(data, {"highway": "crossing", "traffic_sign": "NL:L02;NL:J23"}),
            expected={"class": 90205, "subclass": 938076772},
        )
        self.check_not_err(
            n.node(data, {"direction": "300", "traffic_sign": "NL:L2"}),
            expected={"class": 90205, "subclass": 938076772},
        )
        self.check_not_err(
            n.node(
        ...
        self.check_err(
            n.node(data, {"highway": "crossing", "traffic_sign": "NL:L2"}),
            expected={"class": 90205, "subclass": 938076772},
        )
        self.check_err(
            n.node(data, {"phone": "+31 06 1234 5678"}),
            expected={"class": 90201, "subclass": 1739574763},
        )
        self.check_err(
            n.node(data, {"phone": "+31 0612345678"}),
            expected={"class": 90201, "subclass": 1739574763},
        )
        self.check_err(
            n.node(data, {"phone": "+31 08008844"}),
            expected={"class": 90201, "subclass": 1739574763},
        )
        self.check_not_err(
            n.node(data, {"phone": "+31 6 1234 5678"}),
            expected={"class": 90201, "subclass": 1739574763},
        )
        self.check_not_err(
            n.node(data, {"phone": "+31 612345678"}),
            expected={"class": 90201, "subclass": 1739574763},
        )
        self.check_err(
            n.node(data, {"phone": "00310612345678"}),
            expected={"class": 90201, "subclass": 1739574763},
        )
        self.check_not_err(
            n.node(data, {"phone": "0031612345678"}),
            expected={"class": 90201, "subclass": 1739574763},
        )
        self.check_not_err(
            n.node(data, {"phone": "06 12 34 56 78"}),
            expected={"class": 90201, "subclass": 1739574763},
        )
        self.check_not_err(
            n.node(data, {"phone": "0612345678"}),
            expected={"class": 90201, "subclass": 1739574763},
        )
        self.check_err(
            n.node(data, {"phone": "+31 14 0245"}),
            expected={"class": 90201, "subclass": 345342642},
        )
        self.check_err(
            n.node(data, {"phone": "+31 140245"}),
            expected={"class": 90201, "subclass": 345342642},
        )
        self.check_not_err(
            n.node(data, {"phone": "+31 800 8844"}),
            expected={"class": 90201, "subclass": 345342642},
        )
        self.check_err(
            n.node(data, {"phone": "+3114024"}),
            expected={"class": 90201, "subclass": 345342642},
        )
        self.check_not_err(
            n.node(data, {"phone": "+318008844"}),
            expected={"class": 90201, "subclass": 345342642},
        )
        self.check_err(
            n.node(data, {"phone": "0031140245"}),
            expected={"class": 90201, "subclass": 345342642},
        )
        self.check_not_err(
            n.node(data, {"phone": "0031612345678"}),
        ...
        self.check_not_err(
            n.node(data, {"phone": "0800 8844"}),
            expected={"class": 90201, "subclass": 345342642},
        )
        self.check_not_err(
            n.node(data, {"phone": "08008844"}),
            expected={"class": 90201, "subclass": 345342642},
        )
        self.check_not_err(
            n.node(data, {"phone": "14024"}),
            expected={"class": 90201, "subclass": 345342642},
        )
        self.check_not_err(
            n.node(data, {"phone": "140245"}),
            expected={"class": 90201, "subclass": 345342642},
        )
        self.check_not_err(
            n.node(data, {"contact:mobile": "097 123456789"}),
            expected={"class": 90201, "subclass": 50270752},
        )
        self.check_not_err(
            n.node(data, {"contact:whatsapp": "+31 97 1234 567 89"}),
            expected={"class": 90201, "subclass": 50270752},
        )
        self.check_not_err(
            n.node(data, {"contact:whatsapp": "+3197 123456789"}),
            expected={"class": 90201, "subclass": 50270752},
        )
        self.check_not_err(
            n.node(data, {"phone": "+31 6 1234 5678"}),
        ...
        self.check_not_err(
            n.node(data, {"phone": "+31 6 12345678"}),
            expected={"class": 90201, "subclass": 50270752},
        )
        self.check_not_err(
            n.node(data, {"phone": "0031612345678"}),
        ...
        self.check_not_err(
            n.node(data, {"phone": "06 12345678"}),
            expected={"class": 90201, "subclass": 50270752},
        )
        self.check_not_err(
            n.node(data, {"phone": "0800 1234567"}),
            expected={"class": 90201, "subclass": 50270752},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    "addr:city": "Milheeze",
                    "addr:housenumber": "2a",
                    "addr:street": "Pastoor Simonisplein",
                    "amenity": "atm",
                },
            ),
            expected={"class": 90201, "subclass": 509151640},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    "addr:city": "Marrum",
                    "addr:housenumber": "1W-5",
                    "addr:street": "Ozingaloane",
                    "power": "generator",
                },
            ),
            expected={"class": 90201, "subclass": 509151640},
        ...
        self.check_not_err(
            n.node(
                ...
                {
                    "addr:city": "XXX",
                    "addr:housenumber:construction": "123",
                    "addr:postcode": "1234AB",
                    "addr:street": "XXX",
                },
            ),
        ...
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "addr:postcode": "1234AB",
                    "addr:street": "XXX",
                    "proposed:addr:housenumber": "123",
                },
            ),
            expected={"class": 90201, "subclass": 509151640},
        )
        self.check_err(
            n.node(data, {"amenity": "drinking_water", "name": "kraanwater"}),
            expected={"class": 90203, "subclass": 310270104},
        )
        self.check_err(
            n.node(
                data,
                {"amenity": "parking_entrance", "name": "parkeerplaats voor bezoekers"},
            ),
            expected={"class": 90203, "subclass": 310270104},
        )
        self.check_err(
            n.node(data, {"leisure": "pitch", "name": "voetbalveld"}),
            expected={"class": 90203, "subclass": 310270104},
        )
        self.check_err(
            n.node(data, {"leisure": "playground", "name": "Abc (gesloten)"}),
            expected={"class": 90203, "subclass": 310270104},
        )
        self.check_not_err(
            n.node(data, {"name": "Landgoed", "railway": "tram_stop"}),
            expected={"class": 90203, "subclass": 1558593366},
        )
        self.check_not_err(
            n.node(data, {"name:fy": "y", "name:nl": "x"}),
            expected={"class": 90203, "subclass": 1647353731},
        )
        self.check_not_err(
            n.node(data, {"name": "x", "name:en": "y", "name:nl": "x"}),
            expected={"class": 90203, "subclass": 1647353731},
        )
        self.check_err(
            n.node(data, {"amenity": "post_box", "operator": "post nl"}),
            expected={"class": 90203, "subclass": 1831362989},
        )
        self.check_not_err(
            n.node(data, {"amenity": "post_box", "operator": "PostNL"}),
            expected={"class": 90203, "subclass": 1831362989},
        )
        self.check_err(
            n.node(data, {"amenity": "post_box", "operator": "postnl"}),
        ...
        self.check_err(
            n.way(
                data, {"highway": "cycleway", "traffic_sign": "NL:G13; NL:L301-A"}, [0]
            ),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_not_err(
            n.way(
                data,
                {"highway": "cycleway", "traffic_sign": "NL:J1; NL:G11; NL:G07; OB109"},
                [0],
            ),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_not_err(
            n.way(data, {"highway": "cycleway", "traffic_sign": "NL:G11;NL:G07"}, [0]),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_not_err(
            n.way(
                data,
                {"highway": "cycleway", "traffic_sign": "NL:G11;NL:G07;OB109"},
                [0],
            ),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_not_err(
            n.way(
                data,
                {"highway": "cycleway", "traffic_sign": "NL:G11;OB109;NL:G07"},
                [0],
            ),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_not_err(
            n.way(data, {"highway": "cycleway", "traffic_sign": "NL:G13"}, [0]),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_err(
            n.way(
        ...
        self.check_err(
            n.way(data, {"highway": "cycleway", "traffic_sign": "NL:G7"}, [0]),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_err(
            n.way(data, {"highway": "cycleway", "traffic_sign": "NL:G7;OB109"}, [0]),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_not_err(
            n.way(
                data,
                {"highway": "cycleway", "traffic_sign": "NL:J1;NL:G11;OB109;NL:G07"},
                [0],
            ),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_err(
            n.way(data, {"highway": "cycleway", "traffic_sign": "NL:J1;NL:G7"}, [0]),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_err(
            n.way(
                data, {"highway": "cycleway", "traffic_sign": "NL:J1;NL:G7;OB109"}, [0]
            ),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_err(
            n.way(data, {"highway": "cycleway", "traffic_sign": "NL:L301"}, [0]),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_not_err(
            n.way(
                data, {"highway": "residential", "traffic_sign": "NL:G12;NL:G10"}, [0]
            ),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_err(
        ...
        self.check_not_err(
            n.way(
                data,
                {"highway": "service", "living_street": "yes", "traffic_sign": "NL:G5"},
                [0],
            ),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_err(
            n.way(data, {"highway": "service", "traffic_sign": "NL:G5"}, [0]),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_not_err(
            n.way(data, {"highway": "steps", "traffic_sign": "NL:G13; NL:L301-B"}, [0]),
            expected={"class": 90205, "subclass": 1734745494},
        )
        self.check_not_err(
            n.way(data, {"highway": "steps", "traffic_sign": "NL:G13;NL:L301-B"}, [0]),
        ...
        self.check_not_err(
            n.way(
                data,
                {
                    ...
                    "hgv:backward": "no",
                    "highway": "service",
                    "traffic_sign:backward": "NL:C07;NL:C16",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 1181284851},
        )
        self.check_not_err(
            n.way(
                data,
        ...
        self.check_err(
            n.way(
                data,
                {
                    "access:backward": "no",
                    "highway": "service",
                    "traffic_sign:backward": "NL:C1",
                    "traffic_sign:forward": "NL:C9;NL:OB58",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 1181284851},
        ...
        self.check_err(
            n.way(
                data,
                {"highway": "service", "traffic_sign:forward": "NL:C9;NL:OB58"},
                [0],
            ),
            expected={"class": 90205, "subclass": 1181284851},
        )
        self.check_err(
            n.way(data, {"highway": "service", "traffic_sign": "NL:C01"}, [0]),
            expected={"class": 90205, "subclass": 1181284851},
        )
        self.check_not_err(
            n.way(
                data,
                {"access": "no", "highway": "service", "traffic_sign": "NL:C01;NL:C16"},
                [0],
            ),
            expected={"class": 90205, "subclass": 1181284851},
        )
        self.check_not_err(
            n.way(
                data,
                {
                    "highway": "service",
                    "motor_vehicle": "no",
                    "traffic_sign": "NL:C01;NL:OB51;NL:OB54",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 1181284851},
        ...
        self.check_not_err(
            n.way(
                data,
                {"highway": "track", "motor_vehicle": "no", "traffic_sign": "NL:C12"},
                [0],
            ),
            expected={"class": 90205, "subclass": 1181284851},
        )
        self.check_not_err(
            n.way(
                data,
                {
                    "hazmat:A:backward": "no",
                    "highway": "service",
                    "traffic_sign:backward": "NL:C22[A]",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 85894353},
        )
        self.check_not_err(
            n.way(
                data,
        ...
        self.check_not_err(
            n.way(
                data,
                {
                    "highway": "service",
                    "oneway:hazmat:C": "yes",
                    "traffic_sign:backward": "NL:C22[C]",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 85894353},
        ...
        self.check_err(
            n.way(
                ...
                {
                    "highway": "service",
                    "traffic_sign:forward": "NL:C16; NL:C22[A]; NL:OB58",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 85894353},
        ...
        self.check_err(
            n.way(
                data,
                {"highway": "service", "traffic_sign:forward": "NL:C22[A];NL:OB58"},
                [0],
            ),
            expected={"class": 90205, "subclass": 85894353},
        )
        self.check_not_err(
            n.way(
                data,
                {"access": "no", "highway": "service", "traffic_sign": "NL:C22"},
                [0],
            ),
            expected={"class": 90205, "subclass": 85894353},
        )
        self.check_not_err(
            n.way(
                data,
                {"hazmat": "no", "highway": "service", "traffic_sign": "NL:C22"},
                [0],
            ),
            expected={"class": 90205, "subclass": 85894353},
        )
        self.check_err(
            n.way(data, {"highway": "service", "traffic_sign": "NL:C22"}, [0]),
            expected={"class": 90205, "subclass": 85894353},
        )
        self.check_not_err(
            n.way(data, {"highway": "service", "traffic_sign": "NL:C22a"}, [0]),
            expected={"class": 90205, "subclass": 85894353},
        )
        self.check_not_err(
            n.way(
                ...
                {
                    "highway": "residential",
                    "maxweight:backward": "2.1",
                    "traffic_sign:backward": "NL:C21[2.1]",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 991745921},
        )
        self.check_err(
            n.way(
                data,
                {"highway": "residential", "traffic_sign:forward": "NL:C19[2.1]"},
                [0],
            ),
            expected={"class": 90205, "subclass": 991745921},
        )
        self.check_err(
            n.way(
                data,
                {"highway": "residential", "traffic_sign:forward": "NL:C21[2.1]"},
                [0],
            ),
            expected={"class": 90205, "subclass": 991745921},
        )
        self.check_err(
            n.way(
                ...
                {
                    "highway": "residential",
                    "traffic_sign:forward": "NL:J19; NL:L01[4.1]; NL:OB108",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 991745921},
        ...
        self.check_err(
            n.way(data, {"highway": "residential", "traffic_sign": "NL:C21[2.1]"}, [0]),
            expected={"class": 90205, "subclass": 991745921},
        )
        self.check_not_err(
            n.way(
                ...
                {
                    "highway": "residential",
                    "maxweight:conditional": "xxx",
                    "traffic_sign": "NL:J19;NL:C21[2.1];NL:OB108",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 991745921},
        ...
        self.check_err(
            n.way(
                data,
                {"highway": "residential", "traffic_sign:backward": "NL:C02;NL:OB58"},
                [0],
            ),
            expected={"class": 90205, "subclass": 2031953960},
        )
        self.check_not_err(
            n.way(
                data,
        ...
        self.check_err(
            n.way(
                ...
                {
                    "highway": "residential",
                    "oneway:motor_vehicle": "-1",
                    "traffic_sign:forward": "NL:C3",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 2031953960},
        ...
        self.check_err(
            n.way(
                data, {"highway": "residential", "traffic_sign:forward": "NL:C3"}, [0]
            ),
            expected={"class": 90205, "subclass": 2031953960},
        )
        self.check_err(
        ...
        self.check_err(
            n.way(data, {"highway": "residential", "traffic_sign": "NL:C02"}, [0]),
            expected={"class": 90205, "subclass": 2031953960},
        )
        self.check_not_err(
            n.way(
        ...
        self.check_err(
            n.way(
                data, {"highway": "residential", "traffic_sign": "NL:C3;NL:OB58"}, [0]
            ),
            expected={"class": 90205, "subclass": 2031953960},
        )
        self.check_err(
            n.way(
                data,
                {"highway": "residential", "oneway": "yes", "traffic_sign": "NL:C05"},
                [0],
            ),
            expected={"class": 90205, "subclass": 560436831},
        )
        self.check_not_err(
            n.way(data, {"highway": "residential", "traffic_sign": "NL:C05"}, [0]),
            expected={"class": 90205, "subclass": 560436831},
        )
        self.check_not_err(
            n.way(
        ...
        self.check_not_err(
            ...
            expected={"class": 90205, "subclass": 439012160},
        )
        self.check_not_err(
            n.way(
                data,
        ...
        self.check_err(
            n.way(
                data,
                {"highway": "residential", "oneway": "yes", "traffic_sign": "NL:D1"},
                [0],
            ),
            expected={"class": 90205, "subclass": 439012160},
        )
        self.check_not_err(
            ...
            expected={"class": 90205, "subclass": 1998584294},
        )
        self.check_not_err(
            n.way(
                data,
        ...
        self.check_err(
            n.way(
                data,
                {
                    "highway": "residential",
                    "parking:both": "no",
                    "traffic_sign:left": "NL:E02",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 1049002673},
        )
        self.check_err(
            n.way(
                data,
        ...
        self.check_not_err(
            n.way(
                data,
                {
                    "highway": "residential",
                    "priority": "forward",
                    "traffic_sign": "NL:F6;NL:F5",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 1040610185},
        )
        self.check_not_err(
            n.way(
                data,
                {
                    "highway": "residential",
                    "priority:agricultural": "forward",
                    "traffic_sign": "NL:F6;OB05",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 1040610185},
        ...
        self.check_err(
            n.way(data, {"highway": "residential", "traffic_sign": "NL:F6;OB05"}, [0]),
            expected={"class": 90205, "subclass": 1040610185},
        )
        self.check_err(
            n.way(
                data,
                {
                    "highway": "residential",
                    "priority": "backward",
                    "traffic_sign:backward": "NL:F05",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 1108961023},
        )
        self.check_not_err(
            n.way(
                data,
        ...
        self.check_not_err(
            n.way(
                ...
                {
                    "highway": "residential",
                    "priority:conditional": "forward @ (10:00-12:00)",
                    "traffic_sign:forward": "NL:F6",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 1108961023},
        ...
        self.check_err(
            n.way(
                data, {"highway": "residential", "traffic_sign:forward": "NL:F6"}, [0]
            ),
            expected={"class": 90205, "subclass": 1108961023},
        )
        self.check_err(
            n.way(
                ...
                {
                    "highway": "residential",
                    "priority:agricultural": "backward",
                    "traffic_sign:forward": "NL:F6;OB05",
                },
                [0],
            ),
            expected={"class": 90205, "subclass": 1108961023},
        ...
        self.check_not_err(
            n.way(
                data,
                {"cycleway": "lane", "highway": "footway", "traffic_sign": "NL:G07-ZB"},
                [0],
            ),
            expected={"class": 90206, "subclass": 1018129333},
        )
        self.check_not_err(
            n.way(data, {"cycleway": "no", "highway": "footway"}, [0]),
            expected={"class": 90206, "subclass": 1018129333},
        )
        self.check_not_err(
            n.way(
        ...
        self.check_not_err(
            n.way(
                data,
                {"highway": "footway", "segregated": "yes", "traffic_sign": "NL:G7"},
                [0],
            ),
            expected={"class": 90206, "subclass": 1018129333},
        )
        self.check_err(
            n.way(data, {"highway": "service", "surface": "niet bestraat"}, [0]),
            expected={"class": 90202, "subclass": 1678452337},
        )
        self.check_not_err(
            n.way(data, {"highway": "service", "surface": "paving_stones"}, [0]),
            expected={"class": 90202, "subclass": 1678452337},
        )
        self.check_err(
            n.way(data, {"highway": "service", "surface": "straatstenen"}, [0]),
            expected={"class": 90202, "subclass": 1678452337},
        )
        self.check_not_err(
            n.way(data, {"highway": "footway", "surface": "paving_stones"}, [0]),
            expected={"class": 90202, "subclass": 1868473171},
        )
        self.check_not_err(
            n.way(
                data,
                {
                    "cycleway:surface": "paving_stones:20",
                    "highway": "residential",
                    "sidewalk:surface": "paving_stones",
                },
                [0],
            ),
            expected={"class": 90202, "subclass": 1911834456},
        )
        self.check_not_err(
            n.way(
                data,
                {
                    "cycleway:surface": "paving_stones:20",
                    "highway": "residential",
                    "sidewalk:surface": "paving_stones:30",
                },
                [0],
            ),
            expected={"class": 90202, "subclass": 1911834456},
        ...
        self.check_err(
            n.way(data, {"highway": "service", "name": "McDonalds drive through"}, [0]),
            expected={"class": 90203, "subclass": 381483467},
        )
        self.check_err(
            n.way(data, {"highway": "service", "name": "fiets- en bromfietspad"}, [0]),
            expected={"class": 90203, "subclass": 381483467},
        )
        self.check_err(
            n.way(data, {"highway": "service", "name": "onverplicht fietspad"}, [0]),
            expected={"class": 90203, "subclass": 381483467},
        )
        self.check_err(
            n.way(
                data,
                {"highway": "service", "name": "parkeerplaats voor bezoekers"},
                [0],
            ),
            expected={"class": 90203, "subclass": 381483467},
        )
        self.check_err(
            n.way(data, {"highway": "service", "name": "rolstoelpad"}, [0]),
            expected={"class": 90203, "subclass": 381483467},
        )
        self.check_not_err(
            n.way(data, {"highway": "unclassified", "name": "Gesloten Stad"}, [0]),
            expected={"class": 90203, "subclass": 381483467},
        )
        self.check_not_err(
            n.way(data, {"highway": "unclassified", "name": "Landbouwweg"}, [0]),
            expected={"class": 90203, "subclass": 381483467},
        )
        self.check_not_err(
            n.way(data, {"highway": "residential", "name": "De Visserstraat"}, [0]),
            expected={"class": 90203, "subclass": 397885213},
        )
        self.check_not_err(
            n.way(
                data, {"highway": "residential", "name": "J.T. de Visserstraat"}, [0]
            ),
            expected={"class": 90203, "subclass": 397885213},
        )
        self.check_not_err(
            n.way(
                data, {"highway": "residential", "name": "Jac. P. Thijsseplein"}, [0]
            ),
            expected={"class": 90203, "subclass": 397885213},
        )
        self.check_not_err(
            n.way(data, {"highway": "residential", "name": "Th. Weeversweg"}, [0]),
            expected={"class": 90203, "subclass": 397885213},
        )
        self.check_not_err(
            n.way(data, {"highway": "residential", "name": "Wim Kan Dreef"}, [0]),
            expected={"class": 90203, "subclass": 397885213},
        )
        self.check_not_err(
            n.way(
                data,
                {
                    ...
                    "maxspeed": "10",
                    "traffic_sign": "NL:A01-10",
                },
                [0],
            ),
            expected={"class": 90207, "subclass": 670992523},
        )
        self.check_not_err(
            n.way(
                data,
                {
                    "highway": "residential",
                    "maxspeed:forward": "30",
                    "traffic_sign:forward": "NL:A1-30",
                },
                [0],
            ),
            expected={"class": 90207, "subclass": 1250414020},
        )
        self.check_err(
            n.way(
                data,
                {"highway": "residential", "traffic_sign:forward": "NL:A1-30-ZB"},
                [0],
            ),
            expected={"class": 90207, "subclass": 1250414020},
        )
        self.check_not_err(
            n.way(
                ...
                {
                    "highway": "residential",
                    "maxspeed:advisory:both_ways": "50",
        ...
        self.check_err(
            n.way(data, {"highway": "residential", "traffic_sign": "NL:A4[60]"}, [0]),
            expected={"class": 90207, "subclass": 1250414020},
        )
        self.check_err(
            n.way(
                data,
                {"highway": "residential", "traffic_sign": "NL:C16; NL:A01-30"},
                [0],
            ),
            expected={"class": 90207, "subclass": 1250414020},
        )
        ...
        self.check_err(
            n.way(data, {"highway": "residential", "traffic_sign": "NL:A01-30"}, [0]),
            expected={"class": 90207, "subclass": 1250414020},
        )
        self.check_err(
            n.way(data, {"highway": "residential", "traffic_sign": "NL:A04-30"}, [0]),
            expected={"class": 90207, "subclass": 1250414020},
        )
        self.check_err(
            n.way(data, {"highway": "residential", "traffic_sign": "NL:A4"}, [0]),
            expected={"class": 90207, "subclass": 1250414020},
        )
        self.check_not_err(
            n.way(data, {"highway": "motorway", "maxspeed": "120"}, [0]),
            expected={"class": 90207, "subclass": 286842004},
        )
        self.check_not_err(
            n.way(
                data,
                {"highway": "motorway_link", "maxspeed": "130", "motorroad": "yes"},
                [0],
            ),
            expected={"class": 90207, "subclass": 286842004},
        )
        self.check_not_err(
            n.way(
                data,
                {"highway": "tertiary", "maxspeed": "100", "motorroad": "yes"},
                [0],
            ),
            expected={"class": 90207, "subclass": 286842004},
        )
        self.check_not_err(
            n.way(data, {"highway": "trunk", "maxspeed": "90"}, [0]),
            expected={"class": 90207, "subclass": 286842004},
        )
        self.check_not_err(
            n.way(data, {"highway": "trunk_link", "maxspeed": "100"}, [0]),
            expected={"class": 90207, "subclass": 286842004},
        )
        self.check_not_err(
            n.way(data, {"highway": "unclassified", "maxspeed": "80"}, [0]),
            expected={"class": 90207, "subclass": 286842004},
        )
        self.check_not_err(
            n.way(data, {"highway": "unclassified", "maxspeed:moped": "45"}, [0]),
            expected={"class": 90207, "subclass": 790150725},
        )
        self.check_not_err(
            n.way(data, {"highway": "cycleway", "maxspeed": "40"}, [0]),
            expected={"class": 90207, "subclass": 441867371},
        )
        self.check_not_err(
            n.way(data, {"highway": "residential", "maxspeed": "30"}, [0]),
            expected={"class": 90207, "subclass": 441867371},
        )
        self.check_not_err(
            n.way(
        ...
        self.check_not_err(
            n.way(
                data,
                {"highway": "residential", "oneway": "no", "oneway:bicycle": "no"},
                [0],
            ),
            expected={"class": 90208, "subclass": 1454217287},
        )
        self.check_not_err(
            n.way(
                data,
        ...
        self.check_not_err(
            n.way(
                data,
                {"highway": "residential", "oneway": "yes", "oneway:bicycle": "yes"},
                [0],
            ),
            expected={"class": 90208, "subclass": 1454217287},
        )
        self.check_not_err(
            n.relation(
                data,
                {"addr:housename": "huis", "building": "yes", "type": "multipolygon"},
                [],
            ),
            expected={"class": 90201, "subclass": 822822875},
        )
