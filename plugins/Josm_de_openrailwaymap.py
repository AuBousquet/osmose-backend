...
class Josm_de_openrailwaymap(PluginMapCSS):
    ...
    def init(self, logger):
        ...
        self.errors[9016002] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={"en": "hp signals only exist as semaphore or light signals"},
        )
        self.errors[9016003] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={"en": "KVB hp signals only exist as light signals"},
        )
        self.errors[9016004] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={"en": "Vr repeated signals only exist as light signals"},
        )
        self.errors[9016005] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={"en": "Signal Gsp 2 was renamed to Wn 7 in 2008"},
        )
        self.errors[9016006] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "Ne 14 sign requires additional tag railway:signal:train_protection:type=block_marker"
            },
        )
        self.errors[9016007] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "main and repeated distant signal usually are not at the same place"
            },
        )
        self.errors[9016008] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "German distant signals can't be repeated and shortened at the same time"
            },
        )
        self.errors[9016009] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "German Ks signals can't have main and distant signal at the same place, try a combined signal instead"
            },
        )
        self.errors[9016010] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={"en": "Sh semaphore signals cannot display Hp 0, but only Sh 0"},
        )
        self.errors[9016011] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={"en": "Sh light signals cannot display Sh 0, but only Hp 0"},
        )
        self.errors[9016012] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "Zs3v sign signals can only have a single speed, are a multiple of 5 and cannot be greater than 160"
            },
        )
        self.errors[9016013] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "Zs3 sign signals can only have a single speed, are a multiple of 5 and cannot be greater than 160"
            },
        )
        self.errors[9016014] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "Zs3v light signal states should have the form 'speed[;speed …][;off][;?], speeds can only be multiples of 10"
            },
        )
        self.errors[9016015] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "Zs3 light signal states should have the form 'speed[;speed …][;off][;?], speeds can only be multiples of 10"
            },
        )
        self.errors[9016016] = self.def_class(
            item=9016,
            level=3,
            tags=["tag", "railway"],
            title={
                "en": "It is unclear if Zs10 light signals have ever been placed, please double check."
            },
        )
        self.errors[9016017] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "Tracks should not be named by their timetable number (KBS xy). Use a route relation with route=railway, instead."
            },
        )
        self.errors[9016018] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": 'ref=* should be a VzG number (without "VzG"). Use a route relation with route=railway for KBS numbers, instead.'
            },
        )
        self.errors[9016019] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={"en": 'ref=* should be a VzG number without "VzG"'},
        )
        self.errors[9016020] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={"en": 'VzG numbers should be tagged as ref=* without "VzG"'},
        )
        self.errors[9016021] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "ref=* should only be a VzG number, it should not contain the track number"
            },
        )
        self.errors[9016022] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "Track names should be real names. VzG numbers should be tagged ref=*. KBS numbers should be mapped as a relation with route=railway."
            },
        )
        self.errors[9016023] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "Track names should be real names. KBS numbers should be mapped as a relation with route=railway."
            },
        )
        self.errors[9016024] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "Track names should be real names. KBS numbers should be mapped as a relation with route=railway, track numbers as railway:track_ref=*."
            },
        )
        self.errors[9016025] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "Track refs should be VzG numbers in Germany. KBS numbers should be mapped as a relation with route=railway."
            },
        )
        self.errors[9016026] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": "Track refs should be VzG numbers in Germany. KBS numbers should be mapped as a relation with route=railway, track numbers as railway:track_ref=*."
            },
        )
        self.errors[9016028] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={"en": "workrules=BOA is deprecated, replace by an adequate value"},
        )
        self.errors[9016029] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={"en": "workrules: separate country and ruleset by : , not by -"},
        )
        self.errors[9016030] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": mapcss._tag_uncapture(
                    capture_tags, "{1.value} signals only exist as light signals"
                )
            },
        )
        self.errors[9016031] = self.def_class(
            item=9016,
            level=2,
            tags=["tag", "railway"],
            title={
                "en": mapcss._tag_uncapture(
                    capture_tags,
                    "workrules={1.value} is deprecated, change to workrules=DE:{1.value}",
                )
            },
        )
        ...
        self.re_38b81466 = re.compile(
            r"^([1-9]0|1[0-6]0|off|\?)(;([1-9]0|1[0-6]0|off|\?))*$"
        )
    ...
    def node(self, data, tags):
        ...
        if (
            ("railway" in keys and "railway:signal:combined" in keys)
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "DE-ESO:ks")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "railway:signal:main:form"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 2, "light", "light"
                            )
                        )
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "railway:signal:distant:form"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 2, "light", "light"
                            )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "railway:signal:combined:form"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 2, "light", "light"
                            )
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "DE-ESO:hl")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "railway:signal:main:form"
                ...
                err.append(
                    {
                        ...
                        "text": {
                            "en": mapcss._tag_uncapture(
                                capture_tags,
                                "{1.value} signals only exist as light signals",
                            )
                        },
        ...
        if ("railway" in keys and "railway:signal:distant" in keys) or (
            "railway" in keys and "railway:signal:main" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "DE-ESO:hp")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "railway:signal:main:form"
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "railway:signal:main:form"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 3, "semaphore", "semaphore"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "DE-ESO:vr")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "railway:signal:distant:form"
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "railway:signal:distant:form"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 3, "semaphore", "semaphore"
                            )
                ...
                err.append(
                    {
                        ...
                        "subclass": 1455678760,
                        "text": {
                            "en": "hp signals only exist as semaphore or light signals"
                        },
                    }
                )
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "DE-KVB:hp")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "railway:signal:combined:form"
                ...
                err.append(
                    {
                        "class": 9016003,
                        "subclass": 1610282655,
                        "text": {"en": "KVB hp signals only exist as light signals"},
                    }
                )
        ...
        if (
            "railway" in keys
            and "railway:signal:distant" in keys
            and "railway:signal:distant:repeated" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "railway:signal:distant:repeated"
                            )
                ...
                err.append(
                    {
                        ...
                        "subclass": 377147416,
                        "text": {
                            "en": "Vr repeated signals only exist as light signals"
                        },
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "railway:signal:minor:states"
                    ) == mapcss._value_capture(
                        capture_tags, 0, "DE-ESO:sh0;DE-ESO:gsp2"
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "railway:signal:minor:states"
                    ) == mapcss._value_capture(capture_tags, 0, "sh0;gsp2")
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        "class": 9016005,
                        "subclass": 931682141,
                        "text": {"en": "Signal Gsp 2 was renamed to Wn 7 in 2008"},
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict(
                                [
        ...
        if "railway:signal:train_protection" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "railway:signal:train_protection"
                        )
                        == mapcss._value_capture(capture_tags, 0, "DE-ESO:ne14")
                    ) and (
                        mapcss._tag_capture(
                            capture_tags,
                            1,
                        ...
                        != mapcss._value_const_capture(
                            capture_tags, 1, "block_marker", "block_marker"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if (
            (
                "railway:signal:distant:repeated" in keys
                and "railway:signal:distant:shortened" in keys
                and "railway:signal:main" in keys
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "railway:signal:distant:repeated"
                            )
                    ...
                    match = (
                        ...
                        and (
                            mapcss.list_contains(
                                ...
                                mapcss._value_capture(
                                    capture_tags, 2, "DE-ESO:kennlicht"
                                ),
                            )
                        )
                        and (
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_103aec5a
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "railway:signal:main"
                                ),
                        ...
                        and (
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 2, "DE-ESO:hp", "DE-ESO:hp"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["railway:signal:distant:shortened", "yes"]]),
        ...
        if (
            (
                "railway:signal:distant" in keys
                and "railway:signal:distant:repeated" in keys
                and "railway:signal:distant:shortened" in keys
            )
            or (
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_103aec5a
                                ),
                                mapcss._tag_capture(
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "railway:signal:distant"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 3, "DE-ESO:vr", "DE-ESO:vr"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 2, "DE-ESO:vr")
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, "railway:signal:main"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 3, "DE-ESO:hp", "DE-ESO:hp"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 3, "DE-ESO:hp")
                        )
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 4, tags, "railway:signal:main:states"
                                ),
                            )
                        )
                    )
        ...
        if "railway:signal:distant" in keys and "railway:signal:main" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "railway:signal:main"
                        )
                        == mapcss._value_capture(capture_tags, 0, "DE-ESO:ks")
                    ) and (
                        mapcss._tag_capture(
                            capture_tags, 1, tags, "railway:signal:distant"
                        )
        ...
        if (
            "railway" in keys
            and "railway:signal:minor" in keys
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "DE-ESO:sh")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "railway:signal:minor:form"
                            )
                            == mapcss._value_capture(capture_tags, 2, "semaphore")
                        )
                        and (
                            mapcss.list_contains(
                                mapcss._tag_capture(
                                    capture_tags, 3, tags, "railway:signal:minor:states"
                                ),
                                mapcss._value_capture(capture_tags, 3, "DE-ESO:hp0"),
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1342331763,
                        "text": {
                            "en": "Sh semaphore signals cannot display Hp 0, but only Sh 0"
                        },
                    }
                )
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 2, "light")
                        )
                        and (
                            mapcss.list_contains(
                                mapcss._tag_capture(
                                ...
                                mapcss._value_capture(capture_tags, 3, "DE-ESO:sh0"),
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1627617188,
                        "text": {
                            "en": "Sh light signals cannot display Sh 0, but only Hp 0"
                        },
                    }
                )
        ...
        if (
            "railway" in keys
            and "railway:signal:speed_limit_distant" in keys
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "DE-ESO:zs3v")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags,
                            ...
                            == mapcss._value_capture(capture_tags, 2, "sign")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags,
                        ...
                        and (
                            ...
                            != mapcss._value_capture(capture_tags, 5, 5)
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags,
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            > mapcss._value_capture(capture_tags, 3, 160)
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if (
            "railway" in keys
            and "railway:signal:speed_limit" in keys
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "DE-ESO:zs3")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "railway:signal:speed_limit:form"
                            )
                            == mapcss._value_capture(capture_tags, 2, "sign")
                        )
                        and (
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    4,
                                    self.re_38b81466,
                                    "^([1-9]0|1[0-6]0|off|\?)(;([1-9]0|1[0-6]0|off|\?))*$",
                                ),
                                mapcss._tag_capture(
                                    capture_tags,
                                    4,
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "DE-ESO:db:zs10")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "railway:signal:speed_limit:form"
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_4fd6fb40),
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_057dc3df),
                            mapcss._tag_capture(capture_tags, 1, tags, "name"),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_480b052a),
                            mapcss._tag_capture(capture_tags, 1, tags, "ref"),
                        )
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        "class": 9016019,
                        "subclass": 1513071347,
                        "text": {"en": 'ref=* should be a VzG number without "VzG"'},
                    }
                )
                ...
                err.append(
                    {
                        ...
                        "subclass": 498921024,
                        "text": {
                            "en": 'VzG numbers should be tagged as ref=* without "VzG"'
                        },
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_36ee52ff),
                            mapcss._tag_capture(capture_tags, 1, tags, "ref"),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_555f3b4c),
                            mapcss._tag_capture(capture_tags, 1, tags, "name"),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_12ca7ec2),
                            mapcss._tag_capture(capture_tags, 1, tags, "name"),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_27c794aa),
                            mapcss._tag_capture(capture_tags, 1, tags, "name"),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_48fcc4a9),
                            mapcss._tag_capture(capture_tags, 1, tags, "name"),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "workrules")
                        == mapcss._value_capture(capture_tags, 1, "EBO")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "workrules")
                        == mapcss._value_capture(capture_tags, 1, "ESBO")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "workrules")
                        == mapcss._value_capture(capture_tags, 1, "BOStrab")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                        ...
                        "fix": {
                            "+": dict(
                                [
                                    (
                                        mapcss._tag_uncapture(
                                            capture_tags, "workrules=DE:{1.value}"
                                        )
                                    ).split("=", 1)
                                ]
                            )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "workrules")
                        == mapcss._value_capture(capture_tags, 1, "BOA")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "subclass": 219100574,
                        "text": {
                            "en": "workrules=BOA is deprecated, replace by an adequate value"
                        },
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "workrules")
                        == mapcss._value_capture(capture_tags, 1, "DE-BOStrab")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "subclass": 2059785415,
                        "text": {
                            "en": "workrules: separate country and ruleset by : , not by -"
                        },
                        "allow_fix_override": True,
                        "fix": {"+": dict([["workrules", "DE:BOStrab"]])},
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "workrules")
                        == mapcss._value_capture(capture_tags, 1, "DE-EBO")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
...
class Test(TestPluginMapcss):
    def test(self):
        ...
        self.check_not_err(
            ...
            expected={"class": 9016030, "subclass": 64936959},
        )
        self.check_err(
            n.node(
                data,
        ...
        self.check_err(
            n.node(data, {"railway": "signal", "railway:signal:main": "DE-ESO:hl"}),
            expected={"class": 9016030, "subclass": 64936959},
        )
        self.check_not_err(
            n.node(
        ...
        self.check_not_err(
            ...
            expected={"class": 9016002, "subclass": 1455678760},
        )
        self.check_not_err(
            n.node(
                data,
        ...
        self.check_err(
            n.node(
                data,
                {
                    "railway": "signal",
                    "railway:signal:main": "DE-ESO:hp",
                    "railway:signal:main:form": "typo",
                },
            ),
            expected={"class": 9016002, "subclass": 1455678760},
        )
        self.check_err(
            n.node(data, {"railway": "signal", "railway:signal:main": "DE-ESO:hp"}),
            expected={"class": 9016002, "subclass": 1455678760},
        )
        self.check_not_err(
            n.node(
            ...
            expected={"class": 9016003, "subclass": 1610282655},
        )
        self.check_not_err(
            n.node(
                data,
        ...
        self.check_err(
            n.node(
                data,
                {
                    "railway": "signal",
                    "railway:signal:combined": "DE-KVB:hp",
                    "railway:signal:combined:form": "semaphore",
                },
            ),
            expected={"class": 9016003, "subclass": 1610282655},
        )
        self.check_err(
            n.node(
                data,
                {
                    "railway": "signal",
                    "railway:signal:combined": "DE-KVB:hp",
                    "railway:signal:combined:form": "typo",
                },
            ),
            expected={"class": 9016003, "subclass": 1610282655},
        )
        self.check_err(
            n.node(data, {"railway": "signal", "railway:signal:combined": "DE-KVB:hp"}),
            expected={"class": 9016003, "subclass": 1610282655},
        )
        self.check_not_err(
            n.node(
            ...
            expected={"class": 9016004, "subclass": 377147416},
        )
        self.check_err(
            n.node(
                data,
        ...
        self.check_err(
            n.node(
                ...
                {
                    "railway": "derail",
                    "railway:signal:minor:states": "DE-ESO:sh0;DE-ESO:gsp2",
                },
            ),
            expected={"class": 9016005, "subclass": 931682141},
        )
        self.check_not_err(
            n.node(
                data,
        ...
        self.check_err(
            n.node(
                data, {"railway": "signal", "railway:signal:minor:states": "sh0;gsp2"}
            ),
            expected={"class": 9016005, "subclass": 931682141},
        )
        self.check_not_err(
            n.node(data, {"railway": "signal", "railway:signal:main": "DE-ESO:hp"}),
            expected={"class": 9016006, "subclass": 1157239794},
        )
        self.check_not_err(
            n.node(
                data,
        ...
        self.check_err(
            n.node(
                data,
                {"railway": "signal", "railway:signal:train_protection": "DE-ESO:ne14"},
            ),
            expected={"class": 9016006, "subclass": 1157239794},
        )
        self.check_not_err(
            ...
            expected={"class": 9016007, "subclass": 1775285105},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    "railway": "signal",
                    "railway:signal:distant": "DE-ESO:vr",
                    "railway:signal:distant:repeated": "no",
                    "railway:signal:main": "DE-ESO:hp",
                },
            ),
            expected={"class": 9016007, "subclass": 1775285105},
        ...
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:main": "DE-ESO:hp",
                    "railway:signal:main:states": "DE-ESO:hp0;DE-ESO:kennlicht",
                },
            ),
            expected={"class": 9016007, "subclass": 1775285105},
        )
        ...
        self.check_err(
            ...
            expected={"class": 9016008, "subclass": 331861787},
        )
        self.check_err(
            n.node(
                data,
        ...
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:distant:shortened": "yes",
                    "railway:signal:main": "DE-ESO:hp",
                    "railway:signal:main:states": "DE-ESO:kennlicht;DE-ESO:hp1",
                },
            ),
            expected={"class": 9016008, "subclass": 331861787},
        )
        ...
        self.check_not_err(
            ...
            expected={"class": 9016009, "subclass": 832014689},
        )
        self.check_not_err(
            n.node(
                data,
        ...
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:minor:states": "DE-ESO:hp0",
                },
            ),
            expected={"class": 9016010, "subclass": 1342331763},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:minor": "DE-ESO:sh",
                    "railway:signal:minor:form": "light",
                    "railway:signal:minor:states": "DE-ESO:hp0;DE-ESO:sh1",
                },
            ),
            expected={"class": 9016010, "subclass": 1342331763},
        )
        ...
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:minor": "DE-ESO:sh",
                    "railway:signal:minor:form": "semaphore",
                    "railway:signal:minor:states": "DE-ESO:sh0",
                },
            ),
            expected={"class": 9016010, "subclass": 1342331763},
        )
        ...
        self.check_not_err(
            ...
            expected={"class": 9016011, "subclass": 1627617188},
        )
        self.check_not_err(
            n.node(
                data,
        ...
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit_distant:speed": "80;90",
                },
            ),
            expected={"class": 9016012, "subclass": 1868832018},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:form": "light",
                    "railway:signal:speed_limit_distant:speed": "87",
                },
            ),
            expected={"class": 9016012, "subclass": 1868832018},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:form": "light",
                    "railway:signal:speed_limit_distant:speed": "foo",
                },
            ),
            expected={"class": 9016012, "subclass": 1868832018},
        )
        ...
        self.check_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:form": "sign",
                    "railway:signal:speed_limit_distant:speed": "05",
                },
            ),
            expected={"class": 9016012, "subclass": 1868832018},
        )
        self.check_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:form": "sign",
                    "railway:signal:speed_limit_distant:speed": "200",
                },
            ),
            expected={"class": 9016012, "subclass": 1868832018},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:form": "sign",
                    "railway:signal:speed_limit_distant:speed": "5",
                },
            ),
            expected={"class": 9016012, "subclass": 1868832018},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:form": "sign",
                    "railway:signal:speed_limit_distant:speed": "80",
                },
            ),
            expected={"class": 9016012, "subclass": 1868832018},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:form": "sign",
                    "railway:signal:speed_limit_distant:speed": "85",
                },
            ),
            expected={"class": 9016012, "subclass": 1868832018},
        )
        ...
        self.check_not_err(
            ...
            expected={"class": 9016013, "subclass": 1804825947},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit": "DE-ESO:zs3",
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit:speed": "87",
                },
            ),
            expected={"class": 9016013, "subclass": 1804825947},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit": "DE-ESO:zs3",
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit:speed": "foo",
                },
            ),
            expected={"class": 9016013, "subclass": 1804825947},
        )
        ...
        self.check_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit": "DE-ESO:zs3",
                    "railway:signal:speed_limit:form": "sign",
                    "railway:signal:speed_limit:speed": "05",
                },
            ),
            expected={"class": 9016013, "subclass": 1804825947},
        )
        self.check_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit": "DE-ESO:zs3",
                    "railway:signal:speed_limit:form": "sign",
                    "railway:signal:speed_limit:speed": "200",
                },
            ),
            expected={"class": 9016013, "subclass": 1804825947},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit": "DE-ESO:zs3",
                    "railway:signal:speed_limit:form": "sign",
                    "railway:signal:speed_limit:speed": "5",
                },
            ),
            expected={"class": 9016013, "subclass": 1804825947},
        )
        ...
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit": "DE-ESO:zs3",
                    "railway:signal:speed_limit:form": "sign",
                    "railway:signal:speed_limit:speed": "85",
                },
            ),
            expected={"class": 9016013, "subclass": 1804825947},
        )
        ...
        self.check_not_err(
            ...
            expected={"class": 9016014, "subclass": 720472651},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:speed": "80;120",
                },
            ),
            expected={"class": 9016014, "subclass": 720472651},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:speed": "80;120;off;?",
                },
            ),
            expected={"class": 9016014, "subclass": 720472651},
        )
        ...
        self.check_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:speed": "80;foo",
                },
            ),
            expected={"class": 9016014, "subclass": 720472651},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:speed": "80;off",
                },
            ),
            expected={"class": 9016014, "subclass": 720472651},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:speed": "?;80;off;120",
                },
            ),
            expected={"class": 9016014, "subclass": 720472651},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit_distant": "DE-ESO:zs3v",
                    "railway:signal:speed_limit_distant:speed": "off;?",
                },
            ),
            expected={"class": 9016014, "subclass": 720472651},
        )
        ...
        self.check_not_err(
            ...
            expected={"class": 9016015, "subclass": 1065351347},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit": "DE-ESO:zs3",
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit:speed": "80;120",
                },
            ),
            expected={"class": 9016015, "subclass": 1065351347},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit": "DE-ESO:zs3",
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit:speed": "80;120;off;?",
                },
            ),
            expected={"class": 9016015, "subclass": 1065351347},
        )
        ...
        self.check_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit": "DE-ESO:zs3",
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit:speed": "80;foo",
                },
            ),
            expected={"class": 9016015, "subclass": 1065351347},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit": "DE-ESO:zs3",
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit:speed": "80;off",
                },
            ),
            expected={"class": 9016015, "subclass": 1065351347},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit": "DE-ESO:zs3",
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit:speed": "?;80;off;120",
                },
            ),
            expected={"class": 9016015, "subclass": 1065351347},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    ...
                    "railway:signal:speed_limit": "DE-ESO:zs3",
                    "railway:signal:speed_limit:form": "light",
                    "railway:signal:speed_limit:speed": "off;?",
                },
            ),
            expected={"class": 9016015, "subclass": 1065351347},
        )
        ...
        self.check_not_err(
            n.node(
                ...
                {
                    "railway": "signal",
                    "railway:signal:speed_limit": "DE-ESO:db:zs1",
                    "railway:signal:speed_limit:form": "light",
                },
            ),
            expected={"class": 9016016, "subclass": 1437297810},
        )
        self.check_err(
            n.node(
                data,
        ...
        self.check_err(
            n.way(
                data, {"name": "Kursbuchstrecke 710.1", "railway": "light_rail"}, [0]
            ),
            expected={"class": 9016017, "subclass": 460679615},
        )
        self.check_not_err(
            n.way(data, {"railway": "light_rail", "ref": "Kursbuchstrecke 710.1"}, [0]),
            expected={"class": 9016017, "subclass": 460679615},
        )
        self.check_err(
            n.way(data, {"name": "KBS 258", "railway": "rail"}, [0]),
            expected={"class": 9016017, "subclass": 460679615},
        )
        self.check_not_err(
            n.way(data, {"name": "Frankenbahn", "railway": "rail"}, [0]),
            expected={"class": 9016017, "subclass": 460679615},
        )
        self.check_err(
            n.way(data, {"railway": "light_rail", "ref": "Kursbuchstrecke 710.1"}, [0]),
            expected={"class": 9016018, "subclass": 1307191883},
        )
        self.check_err(
            n.way(data, {"railway": "rail", "ref": "KBS 258"}, [0]),
            expected={"class": 9016018, "subclass": 1307191883},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "ref": "7400"}, [0]),
            expected={"class": 9016018, "subclass": 1307191883},
        )
        self.check_err(
            n.way(data, {"railway": "rail", "ref": "VzG 7400"}, [0]),
            expected={"class": 9016019, "subclass": 1513071347},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "ref": "7400"}, [0]),
            expected={"class": 9016019, "subclass": 1513071347},
        ...
        self.check_err(
            n.way(data, {"name": "VzG 7400", "railway": "rail"}, [0]),
            expected={"class": 9016020, "subclass": 498921024},
        )
        self.check_not_err(
            n.way(data, {"name": "7400", "railway": "rail"}, [0]),
            expected={"class": 9016020, "subclass": 498921024},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "ref": "7400"}, [0]),
            expected={"class": 9016021, "subclass": 1211908367},
        )
        self.check_err(
            n.way(data, {"railway": "rail", "ref": "7400-1"}, [0]),
            expected={"class": 9016021, "subclass": 1211908367},
        )
        self.check_err(
            n.way(data, {"name": "7400", "railway": "rail"}, [0]),
            expected={"class": 9016022, "subclass": 1094567914},
        )
        self.check_not_err(
            n.way(data, {"name": "750", "railway": "rail"}, [0]),
            expected={"class": 9016022, "subclass": 1094567914},
        )
        self.check_not_err(
            n.way(data, {"name": "Hohenlohebahn", "railway": "rail"}, [0]),
            expected={"class": 9016022, "subclass": 1094567914},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "ref": "7400"}, [0]),
        ...
        self.check_err(
            n.way(data, {"name": "740.4", "railway": "rail"}, [0]),
            expected={"class": 9016023, "subclass": 1319009137},
        )
        self.check_not_err(
            n.way(data, {"name": "780", "railway": "rail"}, [0]),
            expected={"class": 9016023, "subclass": 1319009137},
        )
        self.check_not_err(
            n.way(data, {"name": "790.4--5", "railway": "rail"}, [0]),
            expected={"class": 9016023, "subclass": 1319009137},
        )
        self.check_err(
            n.way(data, {"name": "790.4-5", "railway": "rail"}, [0]),
        ...
        self.check_not_err(
            n.way(data, {"name": "790.4a5", "railway": "rail"}, [0]),
            expected={"class": 9016023, "subclass": 1319009137},
        )
        self.check_not_err(
            n.way(data, {"name": "7400", "railway": "rail"}, [0]),
        ...
        self.check_not_err(
            n.way(data, {"name": "7400a", "railway": "rail"}, [0]),
            expected={"class": 9016023, "subclass": 1319009137},
        )
        self.check_not_err(
            n.way(data, {"name": "Hohenlohebahn", "railway": "rail"}, [0]),
        ...
        self.check_not_err(
            n.way(data, {"name": "740.4", "railway": "rail"}, [0]),
            expected={"class": 9016024, "subclass": 1536179499},
        )
        self.check_err(
            n.way(data, {"name": "780", "railway": "rail"}, [0]),
            expected={"class": 9016024, "subclass": 1536179499},
        ...
        self.check_err(
            n.way(data, {"railway": "rail", "ref": "740.4"}, [0]),
            expected={"class": 9016025, "subclass": 1194218564},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "ref": "780"}, [0]),
            expected={"class": 9016025, "subclass": 1194218564},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "ref": "790.4--5"}, [0]),
            expected={"class": 9016025, "subclass": 1194218564},
        )
        self.check_err(
            n.way(data, {"railway": "rail", "ref": "790.4-5"}, [0]),
        ...
        self.check_not_err(
            n.way(data, {"railway": "rail", "ref": "790.4a5"}, [0]),
            expected={"class": 9016025, "subclass": 1194218564},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "ref": "7400"}, [0]),
        ...
        self.check_not_err(
            n.way(data, {"railway": "rail", "ref": "7400a"}, [0]),
            expected={"class": 9016025, "subclass": 1194218564},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "ref": "740.4"}, [0]),
            expected={"class": 9016026, "subclass": 2032079245},
        )
        self.check_err(
            n.way(data, {"railway": "rail", "ref": "780"}, [0]),
            expected={"class": 9016026, "subclass": 2032079245},
        ...
        self.check_err(
            n.way(data, {"railway": "rail", "workrules": "BOStrab"}, [0]),
            expected={"class": 9016031, "subclass": 1085911640},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "workrules": "DE:BOStrab"}, [0]),
            expected={"class": 9016031, "subclass": 1085911640},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "workrules": "DE:EBO"}, [0]),
            expected={"class": 9016031, "subclass": 1085911640},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "workrules": "DE:ESBO"}, [0]),
            expected={"class": 9016031, "subclass": 1085911640},
        )
        self.check_err(
            n.way(data, {"railway": "rail", "workrules": "EBO"}, [0]),
            expected={"class": 9016031, "subclass": 1085911640},
        )
        self.check_err(
            n.way(data, {"railway": "rail", "workrules": "ESBO"}, [0]),
            expected={"class": 9016031, "subclass": 1085911640},
        )
        self.check_not_err(
        ...
        self.check_err(
            n.way(data, {"railway": "rail", "workrules": "BOA"}, [0]),
            expected={"class": 9016028, "subclass": 219100574},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "workrules": "DE:BOStrab"}, [0]),
            expected={"class": 9016028, "subclass": 219100574},
        ...
        self.check_err(
            n.way(data, {"railway": "rail", "workrules": "DE-BOStrab"}, [0]),
            expected={"class": 9016029, "subclass": 2059785415},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "workrules": "DE:BOStrab"}, [0]),
            expected={"class": 9016029, "subclass": 2059785415},
        ...
        self.check_err(
            n.way(data, {"railway": "rail", "workrules": "DE-EBO"}, [0]),
            expected={"class": 9016029, "subclass": 2020708529},
        )
        self.check_not_err(
            n.way(data, {"railway": "rail", "workrules": "DE:EBO"}, [0]),
            expected={"class": 9016029, "subclass": 2020708529},
