...
class Highway_Lanes(Plugin):
    ...
    def init(self, logger):
        ...
        self.errors[31601] = self.def_class(
            item=3160,
            level=2,
            tags=["highway", "fix:chair"],
            title=T_("Bad lanes value"),
            detail=T_("""Non-numeric value, `lanes=*` must have an integer value."""),
        )
        self.errors[31603] = self.def_class(
            item=3160,
            level=2,
            tags=["highway", "fix:chair"],
            title=T_(
...
`forward`, `backward` or `both_ways` suffixes."""
        ...
        self.errors[31604] = self.def_class(
            item=3160,
            level=2,
            tags=["highway", "fix:chair"],
            title=T_("Conflict between lanes number"),
        )
        self.errors[31605] = self.def_class(
            item=3160,
            level=2,
            tags=["highway", "fix:chair"],
            title=T_("Invalid usage of *:lanes:(backward|both_ways) on oneway highway"),
            detail=T_("""You can not set opposite lanes data on a one way."""),
        )
        self.errors[31606] = self.def_class(
            item=3160,
            level=2,
            tags=["highway", "fix:chair"],
        ...
        self.errors[31607] = self.def_class(
            item=3160,
            level=2,
            tags=["highway", "fix:chair"],
            title=T_("Bad turn lanes order"),
            detail=T_("""Right must be on the right and left on the left."""),
        )
        self.errors[31608] = self.def_class(
            item=3160,
            level=2,
            tags=["highway", "fix:chair"],
            title=T_(
                'Conflict between lanes number of same suffix ("", forward, backward or both_ways)'
            ),
            detail=T_(
...
given direction."""
        ...
        self.errors[31609] = self.def_class(
            item=3160,
            level=2,
            tags=["highway", "fix:chair"],
            title=T_(
...
the number of lanes."""
        ...
        self.errors[31600] = self.def_class(
            item=3160,
            level=2,
            tags=["highway", "fix:chair"],
...
side* and `the merge_to_left` on the *right side*."""
        ...
        self.errors[316011] = self.def_class(
            item=3160,
            level=3,
            tags=["highway", "fix:chair"],
        ...
        self.errors[316012] = self.def_class(
            item=3160,
            level=2,
            tags=["highway", "fix:chair"],
        ...
        self.errors[316013] = self.def_class(
            item=3160,
            level=2,
            tags=["highway", "fix:chair"],
        ...
        self.errors[316014] = self.def_class(
            item=3160,
            level=2,
            tags=["highway", "fix:chair"],
...
or right (for `only_left`) side of the lane to which changing is possible."""
    ...
    def way(self, data, tags, nds):
        ...
        tags_lanes = {}
        for tag in tags:
            if "lanes" in tag and "source" not in tag and "FIXME" not in tag:
                ...
                if tl in tags_lanes:
                                ...
                                err.append(
                                    {
                                        ...
                                        "text": T_('Unknown turn lanes value "{0}"', t),
                                    }
                                )

                        if ("merge_to_left" in settt and i == 0) or (
                            "merge_to_right" in settt and i == len(ttt) - 1
                        ):
                            ...
                            err.append(
                                {
                                    "class": 31600,
                                    "subclass": 1
                                    + stablehash64(tl + "|" + tt + "|" + str(i)),
                                }
                            )
                            bad_turn_lanes_value = True

                        elif (
                            not unknown_turn_lanes_value
                            and len(settt) > 1
                            and ("none" in settt or "" in settt)
                        ):
                            # A single turn lane containing both `none` and `something`
                            if not (
                                "none" in settt and "" in settt and len(settt) == 2
                            ):
                                err.append(
                                    {
                                        "class": 316012,
                                        ...
                                        + stablehash64(tl + "|" + tt + "|" + str(i)),
                                        "text": T_(
                                            'Combined none and indicated turn lane: "{0}"',
                                            tt,
                                        ),
                                    }
                                )
                            ...
                            and (
                                (
                                    len(settt) > 2
                                    and (
                                        "merge_to_right" in settt
                                        or "merge_to_left" in settt
                                    )
                                )
                                or (
                                    "merge_to_right" in settt
                                    and "merge_to_left" not in settt
                                )
                                or (
                                    "merge_to_left" in settt
                                    and "merge_to_right" not in settt
                                )
                            )
                        ):
                            ...
                            err.append(
                                {
                                    ...
                                    + stablehash64(tl + "|" + tt + "|" + str(i)),
                                    "text": T_(
                                        'Merge together with another turn lane: "{0}"',
                                        tt,
                                    ),
                                }
                            )
                    ...
                    if not unknown_turn_lanes_value and not bad_turn_lanes_value:
                        ...
                        t = list(
                            map(
                                lambda e: (
                                    "N"
                                    if len(e) == 0
                                    else e[0] if len(e) == 1 else "".join(sorted(e))
                                ),
                                t,
                            )
                        )
                        ...
                        for k in [
                            ...
                            if tag in tags:
                                ...
                                changeindices = [
                                    ...
                                    if tagsplit[i] != tagsplit[i - 1]
                                    and (tagsplit[i] == "no" or tagsplit[i - 1] == "no")
                                ]
                        ...
                        for k in range(len(t)):
                            tk = t[k].replace(
                                "N", throughvalue
                            )  # Treat remaining none as through
                                ...
                                err.append(
                                    {
                                        ...
                                        "text": T_('Bad turn lanes order in "{0}"', tl),
                                    }
                                )
                                break
        ...
        for tag_cl in [
            ...
            if tag_cl in tags_lanes:
                ...
                for clv in changeLanesValues:
                    if clv not in self.knownChangeLaneValues:
                        err.append(
                            {
                                "class": 316013,
                                "subclass": 0 + stablehash64(tag_cl + "|" + clv),
                                "text": T_('Unknown {0} value "{1}"', tag_cl, clv),
                            }
                        )
                ...
                if not unknown_change_lanes_value:
                    if (
                        changeLanesValues[0] == "only_left"
                        or changeLanesValues[-1] == "only_right"
                    ):
                        err.append(
                            {
                                "class": 316014,
                                "subclass": 0 + stablehash64(tag_cl),
                                "text": T_(
                                    'Impossible lane change in tag "{0}"', tag_cl
                                ),
                            }
                        )
                        ...
                        err.append(
                            {
                                ...
                                "text": {"en": "{0}={1}".format(tag, tags_lanes[tag])},
                            }
                        )
                    except ValueError:
        ...
        stars = set(
            map(
                lambda tag: tag.split(":lanes")[0],
                filter(
                    lambda tag: ":lanes" in tag
                    and tag.split(":")[0]
                    not in ("source", "proposed", "construction", "note"),
                    tags_lanes,
                ),
            )
        )
                ...
                for direction in [":forward", ":backward", ":both_ways"]:
                    if star + ":lanes" + direction in tags_lanes:
                        err.append(
                            {
                                "class": 31603,
                                "subclass": stablehash64(star + "|" + direction),
                                "text": {
                                    "en": "`{0}` + `{1}`".format(
                                        star + ":lanes", star + ":lanes" + direction
                                    )
                                },
                            }
                        )
        ...
        for direction in ["", ":forward", ":backward", ":both_ways"]:
            ...
            for star in sorted(number.keys()):
                ...
                non_fullwidth_lanes_number_tag = (
                    (non_fullwidth_lanes_number.get(direction) or 0)
                    if tag != "lanes" + direction
                    else 0
                )
                if (
                    n_lanes.get(direction) is not None
                    and number[star].get(direction) is not None
                    and (
                        number[star][direction] - non_fullwidth_lanes_number_star
                        > n_lanes[direction]
                        or n_lanes[direction] - non_fullwidth_lanes_number_tag
        ...
        if oneway:
            ...
            if (
                ...
                and nlb is not None
                and (
                    nl < nlf + nlb + (nl2 or 0) - nfw_nl - nfw_nlf - nfw_nlb - nfw_nl2
                    or nl > nlf + nlb + (nl2 or 0)
                )
            ):
                err.append(
                    {
...
class Test(TestPluginCommon):
    def test(self):
        ...
        for t in [
            {
                "highway": "residential",
                "destination:lanes": "x|y",
                "destination:lanes:backward": "y",
            },
            ...
            },
            {
                ...
                "lanes": "2",
                "lanes:forward": "2",
                "destination:lanes:forward": "a",
                "destination:lanes:backward": "b",
            },
            {
                "highway": "motorway",
            ...
            },
            {
                "highway": "another",
                "oneway": "yes",
                "vehicle:lanes": "yes|yes|yes|no|no|no|no",
        ...
        for t in [
            ...
            {"highway": "motorway", "turn:lanes": "none|none|merge_to_left"},
            {
                "highway": "residential",
                "lanes": "4",
                "turn:lanes:forward": "none|none|merge_to_left",
                "turn:lanes:backward": "",
            },
            {"highway": "motorway", "turn:lanes": "none|none|merge_to_left"},
            {
            ...
            {"highway": "secondary", "lanes": "3", "lanes:both_ways": "1"},
            {
                ...
                "bus:lanes:conditional": "||designated @ (Mo-Fr 07:00-19:00)",
            },
            {
                "highway": "secondary",
                "lanes": "2",
                "change:lanes": "no|no|no|no",
                "bicycle:lanes": "|designated||designated",
                "cycleway": "lane",
            },
            {
                "highway": "secondary",
                "lanes": "1",
                "width:lanes": "3|1.5|1.5",
                "access:lanes": "yes|no|no",
                "bicycle:lanes": "yes|designated|designated",
            },
            {
                "highway": "tertiary",
                "lanes": "6",
            ...
            },
            {
                ...
                "bicycle:lanes": "no|designated|designated",
                "turn:lanes": "through|through|right",
            },
            {
                "highway": "residential",
                "destination:lanes:both_ways": "x|y",
                "destination:lanes:backward": "y",
            },
        ]:
        ...
        for t in [
            ...
            },
            {
                ...
                "oneway": "yes",
                "lanes": "3",
                "turn:lanes": "left|left;right|right",
            },
            {
                "highway": "residential",
                "oneway": "yes",
                "lanes": "4",
                "turn:lanes": "left|left;right|right|none",
            },
            {
                "highway": "residential",
                "oneway": "yes",
                "lanes": "3",
                "turn:lanes": "left|left;right|merge_to_left",
            },
            {
                "highway": "residential",
                "oneway": "yes",
                "lanes": "3",
                "turn:lanes": "left|left;left|merge_to_left",
            },
            {
                "highway": "residential",
                "oneway": "yes",
            ...
            },
            {
                ...
                "oneway": "yes",
                "lanes": "3",
                "turn:lanes": "left|merge_to_left;merge_to_right|right",
            },
            {
                "highway": "residential",
                "oneway": "yes",
            ...
            {
                "highway": "another",
                "turn:lanes": "left;reverse|left|left;through|through|right;sharp_right",
            },
            {
                "highway": "another",
                "turn:lanes": "reverse|sharp_left|left|slight_left||through|none|slight_right|right|sharp_right|merge_to_left",
            },
            ...
            {"highway": "another", "turn:lanes": "reverse|left|left;through||"},
            {
                ...
                "lanes:forward": "2",
                "lanes:backward": "1",
                "turn:lanes:forward": "reverse|reverse",
                "turn:lanes:backward": "reverse",
            },
            {
                "highway": "another",
                "lanes": "2",
                "turn:lanes": "reverse|none",
                "bus:lanes": "|designated",
                "vehicle:lanes": "designated|no",
            },
            {
                "highway": "another",
                "lanes": "3",
                "source:lanes": "usgs_imagery_2007;survey;image",
                "source_ref:lanes": "AM909_DSCS7435",
            },
            {"highway": "another", "lanes": "1", "lanes:both_ways": "1"},
            {
                ...
                "oneway": "yes",
                "lanes": "3",
                "vehicle:lanes": "no|yes|yes|no",
                "bicycle:lanes": "no|no|no|designated",
                "bus:lanes": "designated|yes|yes|no",
                "turn:lanes": "|left;through|right|through;right",
            },
            {
                "highway": "another",
                "vehicle:lanes:forward": "no|yes|yes|no",
                "bicycle:lanes:forward": "no|no|no|designated",
                "bus:lanes:forward": "designated|yes|yes|no",
                "turn:lanes:forward": "|left;through|right|through;right",
            },
            {
                "highway": "another",
                "oneway": "yes",
                "lanes": "3",
                "vehicle:lanes": "yes|yes|yes|no|no",
                "bicycle:lanes": "no|no|no|designated|designated",
                "turn:lanes": "left|through|right|left|through;right",
            },
            {
                "highway": "another",
                "oneway": "yes",
                ...
                "turn:lanes": "left|through|through;left|right",
            },
        ]:
            assert not a.way(None, t, None), a.way(None, t, None)
        ...
        for t in [
            ...
            {"highway": "another", "turn:lanes": "left|sharp_left|through"},
            {
                ...
                "vehicle:lanes": "yes|yes|yes|no|no",
                "bicycle:lanes": "no|no|no|designated|designated",
                "turn:lanes": "left|through|left|left|through;right",
            },
            {
                "highway": "another",
                "oneway": "yes",
                ...
                "vehicle:lanes": "yes|yes|yes|no|no",
                "bicycle:lanes": "no|no|no|designated|designated",
                "turn:lanes": "left|through|right|left;right|through",
            },
        ]:
        ...
        for t in [
            {
                ...
                "oneway": "yes",
                "lanes": "4",
                "change:lanes": "no|not_right|not_left|yes",
            },
            {
                "highway": "primary",
                "oneway": "yes",
                "lanes": "3",
                "change:lanes": "only_right|yes|only_left",
            },
            {
                "highway": "primary",
                "lanes": "4",
        ...
        for t in [
            ...
            },
            {
                ...
                "oneway": "yes",
                "lanes": "2",
                "change:lanes": "not_left;not_right|no",
            },
            {
                "highway": "primary",
                "oneway": "yes",
                "lanes": "2",
                "change:lanes": "only_left|yes",
            },
            {
                "highway": "primary",
                "oneway": "yes",
                "lanes": "2",
                "change:lanes": "yes|only_right",
            },
            {
                "highway": "primary",
                "oneway": "yes",
                "lanes": "1",
                "change:lanes": "only_right",
            },
        ]:
            assert a.way(None, t, None), a.way(None, t, None)
