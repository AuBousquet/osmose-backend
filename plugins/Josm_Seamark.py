...
class Josm_Seamark(PluginMapCSS):
    ...
    MAPCSS_URL = (
        "https://github.com/OpenNauticalChart/josm/blob/master/Seamark.validator.mapcss"
    )

    def init(self, logger):
        super().init(logger)
        tags = capture_tags = {}  # noqa
        self.errors[9012001] = self.def_class(
            item=9012,
            level=3,
            tags=["tag", "seamark"],
            title=mapcss.tr(
                "Multi-colour {0} without {1}",
                mapcss._tag_uncapture(capture_tags, "{0.value}"),
                mapcss._tag_uncapture(capture_tags, "{2.key}"),
            ),
        )
        self.errors[9012002] = self.def_class(
            item=9012,
            level=3,
            tags=["tag", "seamark"],
            title=mapcss.tr(
        ...
        self.errors[9012003] = self.def_class(
            item=9012,
            level=3,
            tags=["tag", "seamark"],
            title=mapcss.tr(
                "{0} have no IALA or system defind ({1})",
                mapcss._tag_uncapture(capture_tags, "{0.value}"),
        ...
        self.errors[9012004] = self.def_class(
            ...
            tags=["tag", "seamark"],
            title=mapcss.tr(
                "Probably wrong category on {0}, {1} colour mean {2} in {3}",
                mapcss._tag_uncapture(capture_tags, "{0.value}"),
        ...
        self.errors[9012005] = self.def_class(
            item=9012,
            level=3,
            tags=["tag", "seamark"],
            title=mapcss.tr(
                "Probably wrong category on {0}, the colour combination {1} usually mean {2}",
                mapcss._tag_uncapture(capture_tags, "{0.value}"),
                mapcss._tag_uncapture(capture_tags, "{1.value}"),
                mapcss._tag_uncapture(capture_tags, "{2.value}"),
            ),
        )
        self.errors[9012006] = self.def_class(
            item=9012,
            level=3,
            tags=["tag", "seamark"],
            title=mapcss.tr(
        ...
        self.errors[9012007] = self.def_class(
            item=9012,
            level=3,
            tags=["tag", "seamark"],
            title=mapcss.tr(
        ...
        self.errors[9012008] = self.def_class(
            item=9012,
            level=3,
            tags=["tag", "seamark"],
            title=mapcss.tr(
        ...
        self.errors[9012010] = self.def_class(
            item=9012,
            level=3,
            tags=["tag", "seamark"],
            title=mapcss.tr(
                "{0} sign require {1} set to left or right",
                mapcss._tag_uncapture(capture_tags, "{0.value}"),
                mapcss._tag_uncapture(capture_tags, "{1.key}"),
            ),
        )
        ...
        self.re_09200db5 = re.compile(
            r"keep_to_port_margin|keep_to_starboard_margin|keep_to_mid|cross_river_to_port|cross_river_to_starboard|reduce_speed"
        )
        self.re_09c0bae9 = re.compile(r"opening_to_right|opening_to_left")
        self.re_0b7ab6fc = re.compile(
            r"keep_to_port_margin|keep_to_starboard_margin|keep_to_mid-river|cross_river_to_port|cross_river_to_starboard"
        )
        self.re_0c508f2a = re.compile(
            r"entry_permitted|overhead_cable|weir|ferry_non_independent|ferry_independent|berthing_permitted|berthing_lateral_limits|berthing_rafting_limit|berthing_unmarked_pushing|berthing_marked_pushing_1|berthing_marked_pushing_2|berthing_marked_pushing_3|berthing_unmarked_non_pushing|berthing_marked_non_pushing_1|berthing_marked_non_pushing_2|berthing_marked_non_pushing_3|berthing_unmarked|berthing_marked_1|berthing_marked_2|berthing_marked_3|anchoring_permitted|mooring_permitted|vehicle_loading_berth|turning_area|secondary_waterway_crossing|secondary_waterway_right|secondary_waterway_left|main_waterway_right_secondary_ahead|main_waterway_left_secondary_ahead|main_waterway_right_secondary_left|main_waterway_left_secondary_right|main_waterway_right_secondary_ahead_left|main_waterway_left_secondary_ahead_right|main_waterway_crossing|main_waterway_junction|main_waterway_ahead_right|main_waterway_ahead_left|main_waterway_ahead_right_secondary_left|main_waterway_ahead_left_secondary_right|prohibition_ends|drinking_water|telephone|motor_craft_permitted|sport_craft_permitted|waterskiing_permitted|sailing_craft_permitted|unpowered_craft_permitted|sailboards_permitted|high_speeds_permitted|launching_beaching_permitted|radio_information|waterbikes_permitted"
        )
        self.re_0e114cad = re.compile(r"bniwr2|ppwbc")
        self.re_0e3e01fc = re.compile(
            r"no_entry|closed_area|no_overtaking|no_convoy_overtaking|no_passing|no_convoy_passing|no_berthing|no_berthing_lateral_limit|no_anchoring|no_mooring|no_turning|no_wash|no_passage_left|no_passage_right|no_motor_craft|no_sport_craft|no_waterskiing|no_sailing_craft|no_unpowered_craft|no_sailboards|no_high_speeds|no_launching_beaching|no_waterbikes"
        )
        self.re_1389a933 = re.compile(
            r"move_to_left|move_to_right|move_to_port|move_to_starboard|keep_to_port|keep_to_starboard|cross_to_port|cross_to_starboard|stop|speed_limit|sound_horn|keep_lookout|give_way_junction|give_way_crossing|make_radio_contact"
        )
        self.re_141d4d2f = re.compile(
            r"horizontal|vertical|diagonal|squared|stripes|border|cross|saltire"
        )
        self.re_253b0e7a = re.compile(
            r"channel_two_way|channel_one_way|opening_to_right|opening_to_left|proceed_to_left|proceed_to_right"
        )
        ...
        self.re_2a269778 = re.compile(
            r"main_waterway_right_secondary_ahead_left|main_waterway_left_secondary_ahead_right"
        )
        self.re_32e3abb7 = re.compile(r"starboard|waterway_left|channel_left")
        self.re_336a6c28 = re.compile(
            r"limited_depth|limited_headroom|limited_width|navigation_restrictions|channel_distance_left|channel_distance_right"
        )
        self.re_39084725 = re.compile(r"limited_headroom")
        self.re_430e795b = re.compile(
            r"main_waterway_right_secondary_ahead_left|main_waterway_left_secondary_ahead_right|traffic_between_margins"
        )
        self.re_61629c48 = re.compile(
            r"preferred_channel_starboard|preferred_channel_port|waterway_separation|channel_separation"
        )
    ...
    def node(self, data, tags):
        ...
        if (
            ("seamark:beacon_cardinal:color" in keys and "seamark:type" in keys)
            or (
                "seamark:beacon_isolated_danger:color" in keys
                and "seamark:type" in keys
            )
            or ("seamark:beacon_lateral:color" in keys and "seamark:type" in keys)
            or (
                "seamark:beacon_special_purpose:color" in keys
                and "seamark:type" in keys
            )
            or ("seamark:buoy_cardinal:color" in keys and "seamark:type" in keys)
            or ("seamark:buoy_isolated_danger:color" in keys and "seamark:type" in keys)
            or ("seamark:buoy_lateral:color" in keys and "seamark:type" in keys)
            or ("seamark:buoy_safe_water:color" in keys and "seamark:type" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "seamark:type")
                            == mapcss._value_capture(capture_tags, 0, "buoy_lateral")
                        )
                        and (
                            mapcss.string_contains(
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "seamark:buoy_lateral:color"
                                ),
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "seamark:type")
                            == mapcss._value_capture(capture_tags, 0, "beacon_lateral")
                        )
                        and (
                            mapcss.string_contains(
                                mapcss._tag_capture(
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "seamark:type")
                            == mapcss._value_capture(capture_tags, 0, "buoy_cardinal")
                        )
                        and (
                            mapcss.string_contains(
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "seamark:buoy_cardinal:color"
                                ),
                                mapcss._value_capture(capture_tags, 1, ";"),
                            )
                        )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "seamark:type")
                            == mapcss._value_capture(capture_tags, 0, "beacon_cardinal")
                        )
                        and (
                            mapcss.string_contains(
                                mapcss._tag_capture(
                    ...
                    match = (
                        (
                            ...
                            == mapcss._value_capture(
                                capture_tags, 0, "buoy_isolated_danger"
                            )
                        )
                        and (
                            mapcss.string_contains(
                                mapcss._tag_capture(
                                    ...
                                    1,
                                    tags,
                                    "seamark:buoy_isolated_danger:color",
                                ),
                                mapcss._value_capture(capture_tags, 1, ";"),
                            )
                        )
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "seamark:type")
                            == mapcss._value_capture(
                                capture_tags, 0, "beacon_isolated_danger"
                            )
                        )
                        and (
                            mapcss.string_contains(
                                mapcss._tag_capture(
                                    ...
                                    1,
                                    tags,
                                    "seamark:beacon_isolated_danger:color",
                                ),
                                mapcss._value_capture(capture_tags, 1, ";"),
                            )
                        )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "seamark:type")
                            == mapcss._value_capture(capture_tags, 0, "buoy_safe_water")
                        )
                        and (
                            mapcss.string_contains(
                                mapcss._tag_capture(
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "seamark:type")
                            == mapcss._value_capture(
                                capture_tags, 0, "beacon_special_purpose"
                            )
                        )
                        and (
                            mapcss.string_contains(
                                mapcss._tag_capture(
                                    ...
                                    1,
                                    tags,
                                    "seamark:beacon_special_purpose:color",
                                ),
                                mapcss._value_capture(capture_tags, 1, ";"),
                            )
                        )
        ...
        if (
            ("seamark:beacon_cardinal:colour_pattern" in keys)
            or ("seamark:beacon_isolated_danger:colour_pattern" in keys)
            or ("seamark:beacon_lateral:colour_pattern" in keys)
            or ("seamark:beacon_safe_water:colour_pattern" in keys)
            or ("seamark:beacon_special_purpose:colour_pattern" in keys)
            or ("seamark:bridge:colour_pattern" in keys)
            or ("seamark:building:colour_pattern" in keys)
            or ("seamark:buoy_cardinal:colour_pattern" in keys)
            or ("seamark:buoy_installation:colour_pattern" in keys)
            or ("seamark:buoy_isolated_danger:colour_pattern" in keys)
            or ("seamark:buoy_lateral:colour_pattern" in keys)
            or ("seamark:buoy_safe_water:colour_pattern" in keys)
            or ("seamark:buoy_special_purpose:colour_pattern" in keys)
            or ("seamark:daymark:colour_pattern" in keys)
            or ("seamark:landmark:colour_pattern" in keys)
            or ("seamark:light_float:colour_pattern" in keys)
            or ("seamark:light_vessel:colour_pattern" in keys)
            or ("seamark:mooring:colour_pattern" in keys)
            or ("seamark:notice:colour_pattern" in keys)
            or ("seamark:pile:colour_pattern" in keys)
            or ("seamark:platform:colour_pattern" in keys)
            or ("seamark:topmark:colour_pattern" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:buoy_lateral:colour_pattern"
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                                ...
                                1,
                                self.re_141d4d2f,
                                "horizontal|vertical|diagonal|squared|stripes|border|cross|saltire",
                            ),
                            mapcss._tag_capture(
                                capture_tags,
                                1,
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            ...
                            0,
                            tags,
                            "seamark:buoy_installation:colour_pattern",
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:topmark:colour_pattern"
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                            ...
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:topmark:colour_pattern"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:daymark:colour_pattern"
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                            ...
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:daymark:colour_pattern"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:bridge:colour_pattern"
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                            ...
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:bridge:colour_pattern"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:building:colour_pattern"
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                            ...
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:building:colour_pattern"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:landmark:colour_pattern"
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                            ...
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:landmark:colour_pattern"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:light_float:colour_pattern"
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:light_vessel:colour_pattern"
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                            ...
                            mapcss._tag_capture(
                                ...
                                1,
                                tags,
                                "seamark:light_vessel:colour_pattern",
                            ),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:notice:colour_pattern"
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                            ...
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:colour_pattern"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:pile:colour_pattern"
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                            ...
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:pile:colour_pattern"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:platform:colour_pattern"
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                            ...
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:platform:colour_pattern"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:mooring:colour_pattern"
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                            ...
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:mooring:colour_pattern"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:buoy_lateral:system"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:beacon_lateral:system"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if (
            (
                "seamark:beacon_lateral:colour" in keys
                and "seamark:beacon_lateral:system" in keys
                and "seamark:topmark:colour" in keys
                and "seamark:type" in keys
            )
            or (
                "seamark:beacon_lateral:colour" in keys
            ...
            or (
                "seamark:beacon_lateral:system" in keys
                and "seamark:buoy_lateral:colour" in keys
                and "seamark:type" in keys
            )
            or (
                "seamark:buoy_lateral:colour" in keys
                and "seamark:buoy_lateral:system" in keys
                and "seamark:topmark:colour" in keys
                and "seamark:type" in keys
            )
            or (
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "iala-a")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "seamark:buoy_lateral:colour"
                            )
                            == mapcss._value_capture(capture_tags, 2, "red")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "seamark:buoy_lateral:category"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 3, "port", "port"
                            )
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "seamark:beacon_lateral:colour"
                            )
                            == mapcss._value_capture(capture_tags, 2, "red")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "seamark:beacon_lateral:category"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 3, "port", "port"
                            )
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 2, "green")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "seamark:buoy_lateral:category"
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 3, "starboard", "starboard"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 2, "green;red;green")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "seamark:buoy_lateral:category"
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "iala-b")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "seamark:buoy_lateral:colour"
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 2, "red;green;red")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "seamark:buoy_lateral:category"
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "cevni")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "seamark:buoy_lateral:colour"
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    3,
                                    self.re_32e3abb7,
                                    "starboard|waterway_left|channel_left",
                                ),
                                mapcss._tag_capture(
                                    capture_tags,
                                    3,
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    3,
                                    self.re_288a42ac,
                                    "port|waterway_right|channel_right",
                                ),
                                mapcss._tag_capture(
                                    capture_tags,
                                    3,
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(
                                capture_tags, 2, "red;green;red;green"
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    3,
                                    self.re_61629c48,
                                    "preferred_channel_starboard|preferred_channel_port|waterway_separation|channel_separation",
                                ),
                                mapcss._tag_capture(
                                    capture_tags,
                                    3,
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    3,
                                    self.re_281803e9,
                                    "preferred_channel_starboard|turnoff_right",
                                ),
                                mapcss._tag_capture(
                                    capture_tags,
                                    3,
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    3,
                                    self.re_637abe26,
                                    "preferred_channel_port|turnoff_left",
                                ),
                                mapcss._tag_capture(
                                    capture_tags,
                                    3,
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(
                                capture_tags, 2, "red;white;red;white"
                            )
                        )
                        and (
                            mapcss._tag_capture(
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 3, "danger_right", "danger_right"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(
                                capture_tags, 2, "green;white;green;white"
                            )
                        )
                        and (
                            mapcss._tag_capture(
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 3, "danger_left", "danger_left"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 2, "white;red")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "seamark:buoy_lateral:category"
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 3, "turnoff_right", "turnoff_right"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 2, "white;green")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "seamark:buoy_lateral:category"
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 3, "turnoff_left", "turnoff_left"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 2, "red;white;red")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "seamark:buoy_lateral:category"
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 3, "junction_right", "junction_right"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(
                                capture_tags, 2, "green;white;green"
                            )
                        )
                        and (
                            mapcss._tag_capture(
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 3, "junction_left", "junction_left"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 2, "red;white")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "seamark:buoy_lateral:category"
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 3, "harbour_right", "harbour_right"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 2, "green;white")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "seamark:buoy_lateral:category"
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 3, "harbour_left", "harbour_left"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 2, "yellow")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 3, tags, "seamark:buoy_lateral:category"
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 4, tags, "seamark:topmark:colour"
                            )
                            == mapcss._value_capture(capture_tags, 4, "red")
                        )
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 4, "green")
                        )
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 3, "bridge_pier", "bridge_pier"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
        ...
        if ("seamark:beacon:cardinal:colour" in keys and "seamark:type" in keys) or (
            "seamark:buoy_cardinal:colour" in keys and "seamark:type" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:buoy_cardinal:colour"
                            )
                            == mapcss._value_capture(capture_tags, 1, "black;yellow")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "seamark:buoy_cardinal:category"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 2, "north", "north"
                            )
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:beacon:cardinal:colour"
                            )
                            == mapcss._value_capture(capture_tags, 1, "black;yellow")
                        )
                        and (
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(
                                capture_tags, 1, "black;yellow;black"
                            )
                        )
                        and (
                            mapcss._tag_capture(
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "yellow;black")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "seamark:buoy_cardinal:category"
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(
                                capture_tags, 1, "yellow;black;yellow"
                            )
                        )
                        and (
                            mapcss._tag_capture(
        ...
        if "seamark:type" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "seamark:type")
                        == mapcss._value_capture(capture_tags, 0, "wreck")
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:wreck:category"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "seamark:wreck:category" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:wreck:category"
                        )
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "seamark:type")
                        != mapcss._value_const_capture(
                            capture_tags, 1, "wreck", "wreck"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "seamark:type" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "seamark:type")
                        == mapcss._value_capture(capture_tags, 0, "rock")
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:rock:water_level"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if (
            ("seamark:notice:1:category" in keys)
            or ("seamark:notice:2:category" in keys)
            or ("seamark:notice:3:category" in keys)
            or ("seamark:notice:4:category" in keys)
            or ("seamark:notice:5:category" in keys)
            or ("seamark:notice:6:category" in keys)
            or ("seamark:notice:7:category" in keys)
            or ("seamark:notice:8:category" in keys)
            or ("seamark:notice:9:category" in keys)
            or ("seamark:notice:category" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:notice:category"
                        )
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:notice:system"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:notice:1:category"
                        )
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:notice:1:system"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:notice:2:category"
                        )
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:notice:2:system"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:notice:3:category"
                        )
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:notice:3:system"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:notice:4:category"
                        )
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:notice:4:system"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:notice:5:category"
                        )
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:notice:5:system"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:notice:6:category"
                        )
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:notice:6:system"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:notice:7:category"
                        )
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:notice:7:system"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:notice:8:category"
                        )
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:notice:8:system"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(
                            capture_tags, 0, tags, "seamark:notice:9:category"
                        )
                    ) and (
                        not mapcss._tag_capture(
                            capture_tags, 1, tags, "seamark:notice:9:system"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if (
            ("seamark:notice:1:category" in keys and "seamark:notice:1:system" in keys)
            or (
                "seamark:notice:2:category" in keys
                and "seamark:notice:2:system" in keys
            )
            or (
                "seamark:notice:3:category" in keys
                and "seamark:notice:3:system" in keys
            )
            or (
                "seamark:notice:4:category" in keys
                and "seamark:notice:4:system" in keys
            )
            or (
                "seamark:notice:5:category" in keys
                and "seamark:notice:5:system" in keys
            )
            or (
                "seamark:notice:6:category" in keys
                and "seamark:notice:6:system" in keys
            )
            or (
                "seamark:notice:7:category" in keys
                and "seamark:notice:7:system" in keys
            )
            or (
                "seamark:notice:8:category" in keys
                and "seamark:notice:8:system" in keys
            )
            or (
                "seamark:notice:9:category" in keys
                and "seamark:notice:9:system" in keys
            )
            or ("seamark:notice:category" in keys and "seamark:notice:system" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "seamark:notice:system"
                            )
                            == mapcss._value_capture(capture_tags, 0, "cevni")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:function"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 1, "prohibition", "prohibition"
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_0e3e01fc
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:category"
                                ),
                            )
                        )
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "seamark:notice:1:system"
                            )
                            == mapcss._value_capture(capture_tags, 0, "cevni")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:1:function"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 1, "prohibition", "prohibition"
                            )
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:1:category"
                                ),
                            )
                        )
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "seamark:notice:2:system"
                            )
                            == mapcss._value_capture(capture_tags, 0, "cevni")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:2:function"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 1, "prohibition", "prohibition"
                            )
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:2:category"
                                ),
                            )
                        )
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "seamark:notice:3:system"
                            )
                            == mapcss._value_capture(capture_tags, 0, "cevni")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:3:function"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 1, "prohibition", "prohibition"
                            )
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:3:category"
                                ),
                            )
                        )
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "seamark:notice:4:system"
                            )
                            == mapcss._value_capture(capture_tags, 0, "cevni")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:4:function"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 1, "prohibition", "prohibition"
                            )
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:4:category"
                                ),
                            )
                        )
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "seamark:notice:5:system"
                            )
                            == mapcss._value_capture(capture_tags, 0, "cevni")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:5:function"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 1, "prohibition", "prohibition"
                            )
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:5:category"
                                ),
                            )
                        )
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "seamark:notice:6:system"
                            )
                            == mapcss._value_capture(capture_tags, 0, "cevni")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:6:function"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 1, "prohibition", "prohibition"
                            )
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:6:category"
                                ),
                            )
                        )
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "seamark:notice:7:system"
                            )
                            == mapcss._value_capture(capture_tags, 0, "cevni")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:7:function"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 1, "prohibition", "prohibition"
                            )
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:7:category"
                                ),
                            )
                        )
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "seamark:notice:8:system"
                            )
                            == mapcss._value_capture(capture_tags, 0, "cevni")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:8:function"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 1, "prohibition", "prohibition"
                            )
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:8:category"
                                ),
                            )
                        )
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "seamark:notice:9:system"
                            )
                            == mapcss._value_capture(capture_tags, 0, "cevni")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:9:function"
                            )
                            != mapcss._value_const_capture(
                                capture_tags, 1, "prohibition", "prohibition"
                            )
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:9:category"
                                ),
                            )
                        )
                    )
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 1, "regulation", "regulation"
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_1389a933
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:category"
                                ),
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 1, "restriction", "restriction"
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_336a6c28
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:category"
                                ),
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 1, "recommendation", "recommendation"
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_253b0e7a
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:category"
                                ),
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_0c508f2a
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:category"
                                ),
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(
                                capture_tags, 2, "berthing_lateral_limit"
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "bniwr")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:system"
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_7c5430c7
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:category"
                                ),
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "bniwr2")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:system"
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_09200db5
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:category"
                                ),
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_39084725
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:category"
                                ),
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_09c0bae9
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:category"
                                ),
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_430e795b
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:category"
                                ),
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "ppwbc")
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:system"
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_0b7ab6fc
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:category"
                                ),
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_2a269778
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "seamark:notice:category"
                                ),
        ...
        if (
            ("seamark:notice:1:system" in keys)
            or ("seamark:notice:2:system" in keys)
            or ("seamark:notice:system" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_0e114cad),
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "seamark:notice:system"
                            ),
                        )
                        ...
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                                capture_tags, 1, self.re_01dd9715, "right|left"
                            ),
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:bank"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        not mapcss.regexp_test(
                            ...
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:1:bank"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        not mapcss.regexp_test(
                            ...
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "seamark:notice:2:bank"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
