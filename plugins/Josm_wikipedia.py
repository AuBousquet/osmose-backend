...
class Josm_wikipedia(PluginMapCSS):
    ...
    def init(self, logger):
        ...
        self.errors[9011001] = self.def_class(
            item=9011,
            level=2,
            tags=["tag", "wikipedia"],
            title=mapcss.tr(
                "wikipedia tag has no language given, use ''wikipedia''=''language:page title''"
            ),
        )
        self.errors[9011002] = self.def_class(
            item=9011,
            level=3,
            tags=["tag", "wikipedia"],
            title=mapcss.tr("wikipedia tag has an unknown language prefix"),
        )
        self.errors[9011003] = self.def_class(
            item=9011,
            level=3,
            tags=["tag", "wikipedia"],
            title=mapcss.tr("deprecated tagging"),
        )
        self.errors[9011004] = self.def_class(
            item=9011,
            level=3,
            tags=["tag", "wikipedia"],
            title=mapcss.tr(
        ...
        self.errors[9011005] = self.def_class(
            item=9011,
            level=3,
            tags=["tag", "wikipedia"],
            title=mapcss.tr(
                "wikipedia ''{0}'' language is invalid, use ''{1}'' instead", "cz", "cs"
            ),
        )
        self.errors[9011006] = self.def_class(
            item=9011,
            level=2,
            tags=["tag", "wikipedia"],
            title=mapcss.tr(
                "{0} tag should not have URL-encoded values like ''%27''",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9011007] = self.def_class(
            item=9011,
            level=3,
            tags=["tag", "wikipedia"],
            title=mapcss.tr(
        ...
        self.errors[9011008] = self.def_class(
            item=9011,
            level=3,
            tags=["tag", "wikipedia"],
            title=mapcss.tr("wikipedia title should not have ''{0}'' prefix", "wiki/"),
        )
        self.errors[9011009] = self.def_class(
            item=9011,
            level=3,
            tags=["tag", "wikipedia"],
            title=mapcss.tr(
        ...
        self.errors[9011010] = self.def_class(
            item=9011,
            level=3,
            tags=["tag", "wikipedia"],
            title=mapcss.tr(
        ...
        self.errors[9011011] = self.def_class(
            item=9011,
            level=3,
            tags=["tag", "wikipedia"],
            title=mapcss.tr(
        ...
        self.errors[9011012] = self.def_class(
            item=9011,
            level=2,
            tags=["tag", "wikipedia"],
            title=mapcss.tr("wikidata tag must be in Qnnnn format, where n is a digit"),
        )
        self.errors[9011015] = self.def_class(
            ...
            tags=["tag", "wikipedia"],
            title=mapcss.tr(
                "''{0}'' tag is set, but no ''{1}'' tag. Make sure to set ''wikipedia=language:value'' for the main article and optional ''wikipedia:language=value'' only for additional articles that are not just other language variants of the main article.",
                mapcss._tag_uncapture(capture_tags, "{1.key}"),
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9011016] = self.def_class(
            item=9011,
            level=3,
            tags=["tag", "wikipedia"],
            title=mapcss.tr(
                "{0} value looks like a {1} value",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
                "wikidata",
            ),
        )
    ...
    def node(self, data, tags):
                    ...
                    match = (
                        ...
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                                capture_tags, 1, self.re_07f8e639, "(?i)^[-a-z]{2,12}:"
                            ),
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_07f8e639
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 1, self.re_1f90813f, "^https?:\/\/"
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "wikipedia"),
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    2,
                                    self.re_67a81e56,
                                    "^(aa|ab|ace|ady|af|ak|als|alt|am|ami|an|ang|ar|arc|ary|arz|as|ast|atj|av|avk|awa|ay|az|azb|ba|ban|bar|bat-smg|bcl|be|be-tarask|be-x-old|bg|bh|bi|bjn|bm|bn|bo|bpy|br|bs|bug|bxr|ca|cbk-zam|cdo|ce|ceb|ch|cho|chr|chy|ckb|co|cr|crh|cs|csb|cu|cv|cy|da|dag|de|din|diq|dsb|dty|dv|dz|ee|el|eml|en|eo|es|et|eu|ext|fa|ff|fi|fiu-vro|fj|fo|fr|frp|frr|fur|fy|ga|gag|gan|gcr|gd|gl|glk|gn|gom|gor|got|gu|guw|gv|ha|hak|haw|he|hi|hif|ho|hr|hsb|ht|hu|hy|hyw|hz|ia|id|ie|ig|ii|ik|ilo|inh|io|is|it|iu|ja|jam|jbo|jv|ka|kaa|kab|kbd|kbp|kcg|kg|ki|kj|kk|kl|km|kn|ko|koi|kr|krc|ks|ksh|ku|kv|kw|ky|la|lad|lb|lbe|lez|lfn|lg|li|lij|lld|lmo|ln|lo|lrc|lt|ltg|lv|mad|mai|map-bms|mdf|mg|mh|mhr|mi|min|mk|ml|mn|mni|mnw|mo|mr|mrj|ms|mt|mus|mwl|my|myv|mzn|na|nah|nap|nds|nds-nl|ne|new|ng|nia|nl|nn|no|nov|nqo|nrm|nso|nv|ny|oc|olo|om|or|os|pa|pag|pam|pap|pcd|pdc|pfl|pi|pih|pl|pms|pnb|pnt|ps|pt|pwn|qu|rm|rmy|rn|ro|roa-rup|roa-tara|ru|rue|rw|sa|sah|sat|sc|scn|sco|sd|se|sg|sh|shi|shn|shy|si|simple|sk|skr|sl|sm|smn|sn|so|sq|sr|srn|ss|st|stq|su|sv|sw|szl|szy|ta|tay|tcy|te|tet|tg|th|ti|tk|tl|tn|to|tpi|tr|trv|ts|tt|tum|tw|ty|tyv|udm|ug|uk|ur|uz|ve|vec|vep|vi|vls|vo|wa|war|wo|wuu|xal|xh|xmf|yi|yo|yue|za|zea|zh|zh-classical|zh-min-nan|zh-yue|zu):",
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "wikipedia"),
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1826918481,
                        "text": mapcss.tr(
                            "wikipedia tag has an unknown language prefix"
                        ),
                    }
                )
        ...
        if "wikipedia" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_1f90813f),
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_091c4afa),
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        "class": 9011003,
                        "subclass": 75691825,
                        "text": mapcss.tr("wikipedia tag format is deprecated"),
                    }
                )
        ...
        if "wikipedia" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_53b6f173),
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "wikipedia" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_034ab801),
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "wikimedia_commons" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_210c6ccc),
                        mapcss._tag_capture(capture_tags, 0, tags, "wikimedia_commons"),
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "wikipedia" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_19995c46),
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, self.re_79a96753)
                    ) and (
                        mapcss.regexp_test(
                            self.re_04adb5d2,
                            mapcss._match_regex(tags, self.re_79a96753),
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "wikipedia" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_536e5b67),
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "wikipedia" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss.regexp_test(
                        mapcss._value_capture(capture_tags, 0, self.re_67c3b565),
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "subclass": 696665203,
                        "text": mapcss.tr(
                            "wikipedia title should not have ''{0}'' prefix", "wiki/"
                        ),
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict(
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_5940ff7c
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 1, self.re_1ac7f364, "^jbo:"
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "wikipedia"),
                            )
                        )
        ...
        if "wikipedia" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_08b52119),
                            mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        )
                    ) and (
                        not mapcss.regexp_test(
            ...
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "da:da:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "da:dk:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "de:de:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "dk:dk:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "en:de:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "en:en:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "en:es:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "en:eu:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "en:fr:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "en:ja:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "en:pl:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "en:pt:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "en:zh:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "es:es:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "eu:eu:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "fr:fr:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "ja:ja:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "pl:en:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "pl:pl:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "pt:pt:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "ru:fr:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "ru:ru:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss.startswith(
                        mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"),
                        mapcss._value_capture(capture_tags, 0, "zh:zh:"),
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "wikidata" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "wikidata")
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                                capture_tags, 1, self.re_4b567f18, "^Q[1-9][0-9]{0,8}$"
                            ),
                            mapcss._tag_capture(capture_tags, 1, tags, "wikidata"),
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_2dd1bee3),
                            mapcss._tag_capture(capture_tags, 1, tags, "wikipedia"),
                        )
                    )
                except mapcss.RuleAbort:
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (
                        not mapcss._tag_capture(capture_tags, 0, tags, "wikipedia")
                    ) and (mapcss._tag_capture(capture_tags, 1, tags, self.re_79319bf9))
                except mapcss.RuleAbort:
                    pass
            if match:
...
class Test(TestPluginMapcss):
    def test(self):
        ...
        self.check_err(
            n.node(data, {"wikipedia": "Foobar"}),
            expected={"class": 9011001, "subclass": 1517450396},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "en-GB:Foobar"}),
            expected={"class": 9011001, "subclass": 1517450396},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "en:Foobar"}),
            expected={"class": 9011001, "subclass": 1517450396},
        )
        self.check_err(
            n.node(data, {"wikipedia": "X-Y-Z:Foobar"}),
            expected={"class": 9011002, "subclass": 1826918481},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "en:Foobar"}),
            expected={"class": 9011002, "subclass": 1826918481},
        ...
        self.check_not_err(
            n.node(data, {"wikipedia": "en:OpenStreetMap"}),
            expected={"class": 9011003, "subclass": 75691825},
        )
        self.check_err(
            n.node(data, {"wikipedia": "http://en.wikipedia.org/wiki/OpenStreetMap"}),
            expected={"class": 9011003, "subclass": 75691825},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "abe-x-old:foo"}),
            expected={"class": 9011004, "subclass": 616152609},
        )
        self.check_err(
            n.node(data, {"wikipedia": "be-x-old:foo"}),
            expected={"class": 9011004, "subclass": 616152609},
        )
        self.check_err(
            n.node(data, {"wikipedia": "cz:foo"}),
            expected={"class": 9011005, "subclass": 243392039},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "en:cz:foo"}),
            expected={"class": 9011005, "subclass": 243392039},
        )
        self.check_err(
            n.node(data, {"wikimedia_commons": "File:Foo%27s"}),
            expected={"class": 9011006, "subclass": 1999051286},
        )
        self.check_not_err(
            n.node(data, {"wikimedia_commons": "File:Foo"}),
            expected={"class": 9011006, "subclass": 1999051286},
        )
        self.check_err(
            n.node(data, {"wikipedia": "en:Foo%27s"}),
            expected={"class": 9011006, "subclass": 83644825},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "en:Foo"}),
            expected={"class": 9011006, "subclass": 83644825},
        )
        self.check_err(
            n.node(data, {"wikipedia:de": "Foo%27s"}),
            expected={"class": 9011006, "subclass": 556604422},
        )
        self.check_not_err(
            n.node(data, {"wikipedia:de": "Foo"}),
            expected={"class": 9011006, "subclass": 556604422},
        )
        self.check_err(
            n.node(data, {"wikipedia": "en: foo"}),
            expected={"class": 9011007, "subclass": 1273458928},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "en:foo"}),
            expected={"class": 9011007, "subclass": 1273458928},
        ...
        self.check_not_err(
            n.node(data, {"wikipedia": "en:foo"}),
            expected={"class": 9011008, "subclass": 696665203},
        )
        self.check_err(
            n.node(data, {"wikipedia": "en:wiki/foo"}),
            expected={"class": 9011008, "subclass": 696665203},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "en:Foo"}),
            expected={"class": 9011009, "subclass": 1824269684},
        )
        self.check_err(
            n.node(data, {"wikipedia": "en:foo"}),
            expected={"class": 9011009, "subclass": 1824269684},
        ...
        self.check_not_err(
            n.node(data, {"wikipedia": "en:foo bar"}),
            expected={"class": 9011010, "subclass": 2024856824},
        )
        self.check_err(
            n.node(data, {"wikipedia": "en:foo_bar"}),
            expected={"class": 9011010, "subclass": 2024856824},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "en:Bar"}),
            expected={"class": 9011011, "subclass": 124114060},
        )
        self.check_err(
            n.node(data, {"wikipedia": "en:en:Foo"}),
            expected={"class": 9011011, "subclass": 124114060},
        )
        self.check_err(
            n.node(data, {"wikipedia": "en:fr:Foo"}),
            expected={"class": 9011011, "subclass": 124114060},
        )
        self.check_err(
            n.node(data, {"wikidata": "Q"}),
            expected={"class": 9011012, "subclass": 1398622919},
        )
        self.check_err(
            n.node(data, {"wikidata": "Q0"}),
            expected={"class": 9011012, "subclass": 1398622919},
        )
        self.check_err(
            n.node(data, {"wikidata": "Q0123"}),
            expected={"class": 9011012, "subclass": 1398622919},
        )
        self.check_not_err(
            n.node(data, {"wikidata": "Q1"}),
            expected={"class": 9011012, "subclass": 1398622919},
        )
        self.check_not_err(
            n.node(data, {"wikidata": "Q123"}),
            expected={"class": 9011012, "subclass": 1398622919},
        )
        self.check_err(
            n.node(data, {"wikidata": "a"}),
            expected={"class": 9011012, "subclass": 1398622919},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "a"}),
            expected={"class": 9011016, "subclass": 346570414},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "de:Q"}),
            expected={"class": 9011016, "subclass": 346570414},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "de:Q0"}),
            expected={"class": 9011016, "subclass": 346570414},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "de:Q0123"}),
            expected={"class": 9011016, "subclass": 346570414},
        )
        self.check_err(
            n.node(data, {"wikipedia": "de:Q1"}),
            expected={"class": 9011016, "subclass": 346570414},
        )
        self.check_err(
            n.node(data, {"wikipedia": "de:Q123"}),
            expected={"class": 9011016, "subclass": 346570414},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "de:a"}),
            expected={"class": 9011016, "subclass": 346570414},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "en-GB:Q0123"}),
            expected={"class": 9011016, "subclass": 346570414},
        )
        self.check_err(
            n.node(data, {"wikipedia": "en-GB:Q1"}),
            expected={"class": 9011016, "subclass": 346570414},
        )
        self.check_err(
            n.node(data, {"wikipedia": "en-GB:Q123"}),
            expected={"class": 9011016, "subclass": 346570414},
        )
        self.check_err(
            n.node(data, {"wikipedia:en": "a"}),
            expected={"class": 9011015, "subclass": 153018468},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "Foo"}),
            expected={"class": 9011015, "subclass": 153018468},
        )
        self.check_not_err(
            n.node(data, {"wikipedia": "a", "wikipedia:en": "b"}),
            expected={"class": 9011015, "subclass": 153018468},
        )
