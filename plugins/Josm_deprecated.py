...
class Josm_deprecated(PluginMapCSS):
    ...
    def init(self, logger):
        ...
        self.errors[9002001] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr("deprecated tagging"),
        )
        self.errors[9002002] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
                "''{0}'' is meaningless, use more specific tags, e.g. ''{1}''",
                "access=designated",
                "bicycle=designated",
            ),
        )
        self.errors[9002003] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
                "''{0}'' does not specify the official mode of transportation, use ''{1}'' for example",
                "access=official",
                "bicycle=official",
            ),
        )
        self.errors[9002004] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
                "{0}={1} is unspecific. Instead of ''{1}'' please give more information about what exactly should be fixed.",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
                mapcss._tag_uncapture(capture_tags, "{0.value}"),
            ),
        )
        self.errors[9002005] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
        ...
        self.errors[9002006] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
                "{0} is unspecific. Instead use the key fixme with the information what exactly should be fixed in the value of fixme.",
                mapcss._tag_uncapture(capture_tags, "{0.tag}"),
            ),
        )
        self.errors[9002007] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
        ...
        self.errors[9002011] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr("key with uncommon character"),
        )
        self.errors[9002012] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr("uncommon short key"),
        )
        self.errors[9002014] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr("questionable key (ending with a number)"),
        )
        self.errors[9002016] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
        ...
        self.errors[9002017] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
                "The key {0} has an uncommon value.",
                mapcss._tag_uncapture(capture_tags, "{1.key}"),
            ),
        )
        self.errors[9002018] = self.def_class(
            item=9002,
            level=2,
            tags=["tag", "deprecated"],
            title=mapcss.tr("misspelled value"),
        )
        self.errors[9002019] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
                "wrong value: {0}", mapcss._tag_uncapture(capture_tags, "{0.tag}")
            ),
        )
        self.errors[9002020] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
                "unusual value of {0}", mapcss._tag_uncapture(capture_tags, "{0.key}")
            ),
        )
        self.errors[9002021] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
                "Unusual key {0}, maybe {1} or {2} is meant",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
                "level",
                "building:levels",
            ),
        )
        self.errors[9002023] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
                "{0} with a temporary URL which may be outdated very soon",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9002024] = self.def_class(
            item=9002,
            level=3,
            tags=["tag", "deprecated"],
            title=mapcss.tr(
                "{0} is unspecific", mapcss._tag_uncapture(capture_tags, "{0.tag}")
            ),
        )

        self.re_01eb1711 = re.compile(r"^(yes|both|no)$")
        self.re_047d5648 = re.compile(
            r"^(1|2|3|4|5|grade1|grade2|grade3|grade4|grade5)$"
        )
        ...
        self.re_51df498f = re.compile(
            r"^(alley|drive-through|drive_through|driveway|emergency_access|parking_aisle|rest_area|slipway|yes)$"
        )
        self.re_554de4c7 = re.compile(r":color")
        self.re_5ee0acf2 = re.compile(r"josm\/ignore")
        self.re_6029fe03 = re.compile(r"^diaper:")
        self.re_61b0be1b = re.compile(
            r"^(buoy_cardinal|buoy_installation|buoy_isolated_danger|buoy_lateral|buoy_safe_water|buoy_special_purpose|mooring)$"
        )
        self.re_620f4d52 = re.compile(
            r"=|\+|\/|&|<|>|;|\'|\"|%|#|@|\\|,|\.|\{|\}|\?|\*|\^|\$"
        )
    ...
    def node(self, data, tags):
        ...
        keys = tags.keys()
        err = []
        set_bbq_autofix = set_beam_pump_no_mech = set_diaper___checked = (
            set_diaper_checked
        ) = set_generic_power_tower_type_warning = set_levels_building = (
            set_parcel_fixable
        ) = set_power_pole_type_warning = set_power_tower_type_warning = (
            set_pumping_ring_no_mech
        ) = set_samebuildingcolor = set_sameroofcolor = False
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "barrier"
                    ) == mapcss._value_capture(capture_tags, 0, "wire_fence")
        ...
        if "barrier" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "barrier"
                    ) == mapcss._value_capture(capture_tags, 0, "wood_fence")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["barrier", "fence"], ["fence_type", "wood"]])
                        },
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        == mapcss._value_capture(capture_tags, 0, "reservoir")
                    ) and (
                        not mapcss._tag_capture(capture_tags, 1, tags, "reservoir_type")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "reservoir_type")
                        == mapcss._value_capture(capture_tags, 1, "water_storage")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["natural", "water"], ["water", "reservoir"]]),
                            "-": (["reservoir_type"]),
                        },
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "reservoir_type")
                        == mapcss._value_capture(capture_tags, 1, "tailings")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "reservoir_type")
                        == mapcss._value_capture(capture_tags, 1, "evaporator")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "reservoir_type")
                        == mapcss._value_capture(capture_tags, 1, "sewage")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "shop" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "bags")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "shop" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "fashion")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "shop" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "pets")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["amenity", mapcss.tag(tags, "shop")]]),
                            "-": (["shop"]),
                        },
                    }
                )
        ...
        if "bicycle_parking" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "bicycle_parking"
                    ) == mapcss._value_capture(capture_tags, 0, "sheffield")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["bicycle_parking", "stands"]])},
                    }
                )
        ...
        if "location" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "location"
                    ) == mapcss._value_capture(capture_tags, 0, "rooftop")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "generator:location" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "generator:location"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "generator:method" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "generator:method"
                    ) == mapcss._value_capture(capture_tags, 0, "dam")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["generator:method", "water-storage"]])},
                    }
                )
        ...
        if "generator:method" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "generator:method"
                    ) == mapcss._value_capture(capture_tags, 0, "pumped-storage")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["generator:method", "water-pumped-storage"]])
                        },
                    }
                )
        ...
        if "generator:method" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "generator:method"
                    ) == mapcss._value_capture(capture_tags, 0, "pumping")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "fence_type" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "fence_type"
                    ) == mapcss._value_capture(capture_tags, 0, "chain")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "board_type" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "board_type"
                    ) == mapcss._value_capture(capture_tags, 0, "board")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "man_made" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "man_made"
                    ) == mapcss._value_capture(capture_tags, 0, "measurement_station")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["man_made", "monitoring_station"]])},
                    }
                )
        ...
        if "measurement" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "measurement"
                    ) == mapcss._value_capture(capture_tags, 0, "water_level")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["monitoring:water_level", "yes"]]),
                            "-": (["measurement"]),
                        },
                    }
                )
        ...
        if "measurement" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "measurement"
                    ) == mapcss._value_capture(capture_tags, 0, "weather")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "measurement" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "measurement"
                    ) == mapcss._value_capture(capture_tags, 0, "seismic")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["monitoring:seismic_activity", "yes"]]),
                            "-": (["measurement"]),
                        },
                    }
                )
        ...
        if "monitoring:river_level" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "monitoring:river_level"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                            ...
                            "+": dict(
                                [
                                    [
                                        ...
                                        mapcss.tag(tags, "monitoring:river_level"),
                                    ]
                                ]
                            ),
                            "-": (["monitoring:river_level"]),
        ...
        if "stay" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, "stay")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["maxstay", mapcss.tag(tags, "stay")]]),
                            "-": (["stay"]),
                        },
                    }
                )
        ...
        if "access" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "access"
                    ) == mapcss._value_capture(capture_tags, 0, "designated")
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "access" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "access"
                    ) == mapcss._value_capture(capture_tags, 0, "official")
                except mapcss.RuleAbort:
                    pass
            if match:
            ...
            if not match:
                ...
                try:
                    match = (mapcss._tag_capture(capture_tags, 0, tags, "name")) and (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_1f92073a),
        ...
        if "note" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = (mapcss._tag_capture(capture_tags, 0, tags, "note")) and (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_1f92073a),
                            mapcss._tag_capture(capture_tags, 1, tags, "note"),
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "type" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "type"
                    ) == mapcss._value_capture(capture_tags, 0, "broad_leaved")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "type"
                    ) == mapcss._value_capture(capture_tags, 0, "broad_leafed")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if ("type" in keys) or ("wood" in keys):
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "wood"
                    ) == mapcss._value_capture(capture_tags, 0, "coniferous")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "type"
                    ) == mapcss._value_capture(capture_tags, 0, "conifer")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "wood" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "wood"
                    ) == mapcss._value_capture(capture_tags, 0, "mixed")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if ("type" in keys) or ("wood" in keys):
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "wood"
                    ) == mapcss._value_capture(capture_tags, 0, "evergreen")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
        ...
        if ("type" in keys) or ("wood" in keys):
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "wood"
                    ) == mapcss._value_capture(capture_tags, 0, "deciduous")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "type"
                    ) == mapcss._value_capture(capture_tags, 0, "deciduos")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "type" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "type"
                    ) == mapcss._value_capture(capture_tags, 0, "palm")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "bridge" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "bridge"
                    ) == mapcss._value_capture(capture_tags, 0, "causeway")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if ("fee" in keys) or ("lit" in keys) or ("supervised" in keys):
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "fee"
                    ) == mapcss._value_capture(capture_tags, 0, "interval")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "supervised"
                    ) == mapcss._value_capture(capture_tags, 0, "interval")
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if True:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, self.re_5ee0acf2)
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "parking" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "parking"
                    ) == mapcss._value_capture(capture_tags, 0, "park_and_ride")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["amenity", "parking"], ["park_ride", "yes"]]),
                            "-": (["parking"]),
                        },
                    }
                )
        ...
        if (
            ...
            or ("parking" in keys)
            or ("place" in keys)
            or ("playground" in keys)
            or ("police" in keys)
            or ("service" in keys)
            or ("shop" in keys)
            or ("traffic_calming" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "playground"
                    ) == mapcss._value_capture(capture_tags, 0, "yes")
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "manhole"
                    ) == mapcss._value_capture(capture_tags, 0, "plain")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "manhole"
                    ) == mapcss._value_capture(capture_tags, 0, "unknown")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "traffic_calming"
                    ) == mapcss._value_capture(capture_tags, 0, "yes")
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "access"
                    ) == mapcss._value_capture(capture_tags, 0, "restricted")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "aerialway")
                        == mapcss._value_capture(capture_tags, 0, "yes")
                    ) and (
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "shop")
                        == mapcss._value_capture(capture_tags, 0, "yes")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "amenity")
                        != mapcss._value_const_capture(capture_tags, 1, "fuel", "fuel")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
        ...
        if "waterway" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "waterway"
                    ) == mapcss._value_capture(capture_tags, 0, "water_point")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["amenity", mapcss.tag(tags, "waterway")]]),
                            "-": (["waterway"]),
                        },
                    }
                )
        ...
        if "waterway" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "waterway"
                    ) == mapcss._value_capture(capture_tags, 0, "waste_disposal")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "waterway" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "waterway"
                    ) == mapcss._value_capture(capture_tags, 0, "mooring")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["mooring", "yes"]]), "-": (["waterway"])},
                    }
                )

        # *[building][levels]
        # *[building:part][levels]
        if ("building" in keys and "levels" in keys) or (
            "building:part" in keys and "levels" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    ...
                    ) and (mapcss._tag_capture(capture_tags, 1, tags, "levels"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
        ...
        if "levels" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = (not set_levels_building) and (
                        mapcss._tag_capture(capture_tags, 0, tags, "levels")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "building:level" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "building:level")
                    ) and (
                        not mapcss._tag_capture(
                        ...
                        "fix": {
                            "+": dict(
                                [
                                    [
                                        "building:levels",
                                        mapcss.tag(tags, "building:level"),
                                    ]
                                ]
                            ),
                            "-": (["building:level"]),
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "building:levels")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "protected_class" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "protected_class"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "sport" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "sport"
                    ) == mapcss._value_capture(capture_tags, 0, "skiing")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, self.re_554de4c7))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "building:color"
                            )
                        )
                        and (
                            not mapcss._tag_capture(capture_tags, 2, tags, "roof:color")
                        )
                        and (
                            not mapcss._tag_capture(capture_tags, 3, tags, "gpxd:color")
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if True:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, self.re_0c5b5730)
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if True:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, self.re_620f4d52)
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1752615188,
                        "text": mapcss.tr(
                            "{0}", mapcss._tag_uncapture(capture_tags, "{0.key}")
                        ),
                    }
                )
        ...
        if True:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, self.re_27210286)
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "kp"))
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "pk"))
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        "class": 9002012,
                        "subclass": 79709106,
                        "text": mapcss.tr("uncommon short key"),
                    }
                )
        ...
        if "sport" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "sport"
                    ) == mapcss._value_capture(capture_tags, 0, "billard")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "sport"
                    ) == mapcss._value_capture(capture_tags, 0, "billards")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "sport"
                    ) == mapcss._value_capture(capture_tags, 0, "billiard")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        # *[payment:ep_chipknip]
        if (
            ("payment:ep_cash" in keys)
            or ("payment:ep_chipknip" in keys)
            or ("payment:ep_proton" in keys)
            or ("payment:ep_quick" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "payment:ep_quick"
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "payment:ep_cash"
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "payment:ep_proton"
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "payment:ep_chipknip"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "kp" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = (mapcss._tag_capture(capture_tags, 0, tags, "kp")) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "railway")
                        != mapcss._value_const_capture(
                            capture_tags, 1, "milestone", "milestone"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["distance", mapcss.tag(tags, "kp")]]),
                            "-": (["kp"]),
                        },
                    }
                )
        ...
        if "pk" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = (mapcss._tag_capture(capture_tags, 0, tags, "pk")) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "railway")
                        != mapcss._value_const_capture(
                            capture_tags, 1, "milestone", "milestone"
                        )
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["distance", mapcss.tag(tags, "pk")]]),
                            "-": (["pk"]),
                        },
                    }
                )
        ...
        if "kp" in keys and "railway" in keys:
            ...
            if not match:
                ...
                try:
                    match = (mapcss._tag_capture(capture_tags, 0, tags, "kp")) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "railway")
                        == mapcss._value_capture(capture_tags, 1, "milestone")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["railway:position", mapcss.tag(tags, "kp")]]),
                            "-": (["kp"]),
                        },
                    }
                )
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["railway:position", mapcss.tag(tags, "pk")]]),
                            "-": (["pk"]),
                        },
                    }
                )
        ...
        if "distance" in keys and "railway" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "distance")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "railway")
                        == mapcss._value_capture(capture_tags, 1, "milestone")
                    )
        ...
        if "postcode" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, "postcode")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "water" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "water"
                    ) == mapcss._value_capture(capture_tags, 0, "intermittent")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["intermittent", "yes"]]), "-": (["water"])},
                    }
                )
        ...
        if "seamark" in keys and "seamark:type" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "seamark")
                        == mapcss._value_capture(capture_tags, 0, "buoy")
                    ) and (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_61b0be1b),
                            mapcss._tag_capture(capture_tags, 1, tags, "seamark:type"),
                        )
                    )
                except mapcss.RuleAbort:
                    pass
                    ...
                    match = (
                        ...
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                                ...
                                1,
                                self.re_61b0be1b,
                                "^(buoy_cardinal|buoy_installation|buoy_isolated_danger|buoy_lateral|buoy_safe_water|buoy_special_purpose|mooring)$",
                            ),
                            mapcss._tag_capture(capture_tags, 1, tags, "seamark:type"),
                        )
                    )
        ...
        if "landuse" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "landuse"
                    ) == mapcss._value_capture(capture_tags, 0, "conservation")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "shop" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "fish")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "shop" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "betting")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "amenity" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "amenity"
                    ) == mapcss._value_capture(capture_tags, 0, "exercise_point")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        == mapcss._value_capture(capture_tags, 0, "studio")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "type")
                        == mapcss._value_capture(capture_tags, 1, "audio")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "type")
                        == mapcss._value_capture(capture_tags, 1, "radio")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "type")
                        == mapcss._value_capture(capture_tags, 1, "television")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "type")
                        == mapcss._value_capture(capture_tags, 1, "video")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["studio", mapcss.tag(tags, "type")]]),
                            "-": (["type"]),
                        },
                    }
                )
        ...
        if "location" in keys and "power" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = (mapcss._tag_capture(capture_tags, 0, tags, "power")) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "location")
                        == mapcss._value_capture(capture_tags, 1, "kiosk")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "man_made" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "man_made"
                    ) == mapcss._value_capture(capture_tags, 0, "well")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if ("leisure" in keys) or ("shop" in keys):
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "gambling")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
        ...
        if "shop" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "glass")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, self.re_300dfa36))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, self.re_3185ac6d
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, self.re_6d27b157
                            )
                        )
                    )
                except mapcss.RuleAbort:
        ...
        if "sport" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "sport"
                    ) == mapcss._value_capture(capture_tags, 0, "skating")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "amenity" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "amenity"
                    ) == mapcss._value_capture(capture_tags, 0, "public_building")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "vending" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "vending"
                    ) == mapcss._value_capture(capture_tags, 0, "news_papers")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "service" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "service"
                    ) == mapcss._value_capture(capture_tags, 0, "drive_through")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["service", "drive-through"]])},
                    }
                )
        ...
        if "noexit" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "noexit"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "noexit")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "yes", "yes"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "noexit")
        ...
        if "pole" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "pole"
                    ) == mapcss._value_capture(capture_tags, 0, "air_to_ground")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "pole"
                    ) == mapcss._value_capture(capture_tags, 0, "transition")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "shop" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "souvenir")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "souvenirs")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "souveniers")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "vending" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "vending"
                    ) == mapcss._value_capture(capture_tags, 0, "animal_food")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "amenity" in keys and "vending" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "vending")
                        == mapcss._value_capture(capture_tags, 0, "photos")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "amenity")
                        == mapcss._value_capture(capture_tags, 1, "vending_machine")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "vending")
                        == mapcss._value_capture(capture_tags, 0, "photo")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "amenity")
                        == mapcss._value_capture(capture_tags, 1, "vending_machine")
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "amenity")
                        != mapcss._value_const_capture(
                            capture_tags, 1, "vending_machine", "vending_machine"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
                    ...
                    match = (
                        (
                            ...
                            == mapcss._value_capture(
                                capture_tags, 0, "emergency_access_point"
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 1, tags, "phone"))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "emergency_telephone_code"
                            )
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "phone")
                        == mapcss._value_capture(
                            capture_tags,
                            1,
                            mapcss.tag(tags, "emergency_telephone_code"),
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "phone")
                            != mapcss._value_capture(
                                capture_tags,
                                3,
                                mapcss.tag(tags, "emergency_telephone_code"),
        ...
        if "amenity" in keys and "lock" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "amenity")
                        == mapcss._value_capture(capture_tags, 0, "hunting_stand")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "lock")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["lockable", mapcss.tag(tags, "lock")]]),
                            "-": (["lock"]),
                        },
                    }
                )
        ...
        if "building" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "true")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "Y")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                ...
                err.append(
                    {
                        ...
                        "subclass": 596818855,
                        "text": mapcss.tr(
                            "{0}", mapcss._tag_uncapture(capture_tags, "{0.tag}")
                        ),
                        "allow_fix_override": True,
                        "fix": {"+": dict([["building", "yes"]])},
                    }
                )
        ...
        if "building" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "abandoned")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "address")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "bing")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "collapsed")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "damaged")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "demolished")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "disused")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "fixme")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "occupied")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "razed")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "building" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "other")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "unclassified")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "undefined")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "unidentified")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "location")
                            == mapcss._value_capture(capture_tags, 1, "pole")
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "transformer"))
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["power", mapcss.tag(tags, "location")]]),
                            "-": (["location"]),
                        },
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "transformer"
                            )
                        )
                    )
                except mapcss.RuleAbort:
        ...
        if ("amenity" in keys) or ("leisure" in keys) or ("tourism" in keys):
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "tourism"
                    ) == mapcss._value_capture(capture_tags, 0, "picnic_table")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "leisure"
                    ) == mapcss._value_capture(capture_tags, 0, "picnic")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "leisure"
                    ) == mapcss._value_capture(capture_tags, 0, "picnic_site")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "amenity" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "amenity"
                    ) == mapcss._value_capture(capture_tags, 0, "toilet")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("misspelled value")
        ...
        if "building" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "central_office")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["building", "yes"], ["telecom", "exchange"]])
                        },
                    }
                )
        ...
        if (
            ("communication" in keys)
            or ("man_made" in keys)
            or ("street_cabinet" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "communication"
                    ) == mapcss._value_capture(capture_tags, 0, "outdoor_dslam")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "street_cabinet"
                    ) == mapcss._value_capture(capture_tags, 0, "outdoor_dslam")
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "telecom" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "telecom"
                    ) == mapcss._value_capture(capture_tags, 0, "dslam")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["telecom", "service_device"]])},
                    }
                )
        ...
        if "fire_hydrant:type" in keys:
            ...
            if not match:
                ...
                try:
                    ...
                    ) == mapcss._value_capture(capture_tags, 0, "pond")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "fire_hydrant:flow_capacity" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "fire_hydrant:flow_capacity"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "in_service")
                        == mapcss._value_capture(capture_tags, 1, "no")
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["disused:emergency", "fire_hydrant"]]),
                            "-": (
                                [
                                    mapcss._tag_uncapture(capture_tags, "{0.key}"),
                                    mapcss._tag_uncapture(capture_tags, "{1.key}"),
        ...
        if "fire_hydrant:water_source" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "fire_hydrant:water_source"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                        ...
                        "fix": {
                            "+": dict(
                                [
                                    [
                                        "water_source",
                                        mapcss.tag(tags, "fire_hydrant:water_source"),
                                    ]
                                ]
                            ),
        ...
        if "natural" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "natural"
                    ) == mapcss._value_capture(capture_tags, 0, "waterfall")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["waterway", mapcss.tag(tags, "natural")]]),
                            "-": (["natural"]),
                        },
                    }
                )
        ...
        if "religion" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "religion"
                    ) == mapcss._value_capture(capture_tags, 0, "unitarian")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["religion", "unitarian_universalist"]])},
                    }
                )
        ...
        if "shop" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "shopping_centre")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if True:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, "is_in")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, self.re_69ec353a)
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "sport" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "sport"
                    ) == mapcss._value_capture(capture_tags, 0, "football")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "leisure" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "leisure"
                    ) == mapcss._value_capture(capture_tags, 0, "common")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "cuisine" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "cuisine"
                    ) == mapcss._value_capture(capture_tags, 0, "vegan")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "cuisine"
                    ) == mapcss._value_capture(capture_tags, 0, "vegetarian")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "kitchen_hours" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, "kitchen_hours")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "shop" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "money_transfer")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "contact:google_plus" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "contact:google_plus"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "amenity" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "amenity"
                    ) == mapcss._value_capture(capture_tags, 0, "garages")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "amenity"
                    ) == mapcss._value_capture(capture_tags, 0, "garage")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if ("amenity" in keys) or ("shop" in keys):
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "winery")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
        ...
        if "amenity" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "amenity"
                    ) == mapcss._value_capture(capture_tags, 0, "youth_centre")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if ("building" in keys and "building:type" in keys) or (
            "building:type" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "building:type")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "building")
                        == mapcss._value_capture(capture_tags, 1, "yes")
                    )
                except mapcss.RuleAbort:
                    pass
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "building")
                            != mapcss._value_const_capture(
        ...
        if "leisure" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "leisure"
                    ) == mapcss._value_capture(capture_tags, 0, "beach")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "natural" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "natural"
                    ) == mapcss._value_capture(capture_tags, 0, "moor")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "shop" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "furnace")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "diaper" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = (mapcss._tag_capture(capture_tags, 0, tags, "diaper")) and (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_0f294fdf),
                            mapcss._tag_capture(capture_tags, 1, tags, "diaper"),
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "diaper" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "diaper"
                    ) == mapcss._value_capture(capture_tags, 0, "room")
                except mapcss.RuleAbort:
                    pass
            if match:
                # set diaper_checked
        ...
        if "diaper:male" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "diaper:male"
                    ) == mapcss._value_capture(capture_tags, 0, "yes")
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["changing_table:location", "male_toilet"]]),
                            "-": (["diaper:male"]),
                        },
                    }
                )
        ...
        if "diaper:female" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "diaper:female"
                    ) == mapcss._value_capture(capture_tags, 0, "yes")
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["changing_table:location", "female_toilet"]]),
                            "-": (["diaper:female"]),
                        },
                    }
                )
        ...
        if "diaper:unisex" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "diaper:unisex"
                    ) == mapcss._value_capture(capture_tags, 0, "yes")
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["changing_table:location", "unisex_toilet"]]),
                            "-": (["diaper:unisex"]),
                        },
                    }
                )
        ...
        if "diaper:wheelchair" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "diaper:wheelchair"
                    ) == mapcss._value_capture(capture_tags, 0, "yes")
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                err.append(
                    {
                        ...
                        "fix": {
                            "+": dict(
                                [
                                    [
                                        "changing_table:wheelchair",
                                        mapcss.tag(tags, "diaper:wheelchair"),
                                    ]
                                ]
                            ),
                            "-": (["diaper:wheelchair"]),
        ...
        if "diaper:fee" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "diaper:fee"
                    ) == mapcss._value_capture(capture_tags, 0, "yes")
                except mapcss.RuleAbort:
                    pass
            if not match:
        ...
        if True:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = (not set_diaper___checked) and (
                        mapcss._tag_capture(capture_tags, 0, tags, self.re_6029fe03)
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        "class": 9002001,
                        "subclass": 26578864,
                        "text": mapcss.tr("{0} is deprecated", "diaper:*"),
                    }
                )
        ...
        if "changing_table" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "changing_table")
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                                capture_tags, 1, self.re_787405b1, "^(yes|no|limited)$"
                            ),
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "changing_table"
                            ),
                        )
                    )
                except mapcss.RuleAbort:
        ...
        if "roof:shape" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "roof:shape"
                    ) == mapcss._value_capture(capture_tags, 0, "half_hipped")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["roof:shape", "half-hipped"]])},
                    }
                )
        ...
        if "bridge_name" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, "bridge_name")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "crossing" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "crossing"
                    ) == mapcss._value_capture(capture_tags, 0, "island")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "recycling:metal" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "recycling:metal"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                            ...
                            "+": dict(
                                [
                                    [
                                        ...
                                        mapcss.tag(tags, "recycling:metal"),
                                    ]
                                ]
                            ),
                            "-": (["recycling:metal"]),
        ...
        if "shop" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "dog_grooming")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "tower:type" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "tower:type"
                    ) == mapcss._value_capture(capture_tags, 0, "anchor")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "tower:type"
                    ) == mapcss._value_capture(capture_tags, 0, "suspension")
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "branch:type" in keys and "tower:type" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "tower:type")
                        == mapcss._value_capture(capture_tags, 0, "branch")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "branch:type")
                        == mapcss._value_capture(capture_tags, 1, "split")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "branch:type")
                        == mapcss._value_capture(capture_tags, 1, "loop")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["line_management", "split"]]),
                            "-": (["branch:type", "tower:type"]),
                        },
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        not mapcss._tag_capture(capture_tags, 1, tags, "branch:type")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "branch:type")
                        == mapcss._value_capture(capture_tags, 1, "tap")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "branch:type")
                        == mapcss._value_capture(capture_tags, 1, "cross")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "tower:type" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "tower:type"
                    ) == mapcss._value_capture(capture_tags, 0, "termination")
                except mapcss.RuleAbort:
                    pass
            if match:
                # set power_tower_type_warning
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["line_management", "termination"]]),
                            "-": (["tower:type"]),
                        },
                    }
                )
        ...
        if "tower:type" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "tower:type"
                    ) == mapcss._value_capture(capture_tags, 0, "transposing")
                except mapcss.RuleAbort:
                    pass
            if match:
                # set power_tower_type_warning
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["line_management", "transpose"]]),
                            "-": (["tower:type"]),
                        },
                    }
                )
        ...
        if "power" in keys and "tower:type" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (not set_power_tower_type_warning)
                        and (mapcss._tag_capture(capture_tags, 0, tags, "tower:type"))
                        and (mapcss._tag_capture(capture_tags, 1, tags, "power"))
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_24dfeb95
                                ),
        ...
        if "branch:type" in keys and "pole:type" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "pole:type")
                        == mapcss._value_capture(capture_tags, 0, "branch")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "branch:type")
                        == mapcss._value_capture(capture_tags, 1, "split")
        ...
        if "pole:type" in keys and "power" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (not set_power_pole_type_warning)
                        and (not set_generic_power_tower_type_warning)
                        and (mapcss._tag_capture(capture_tags, 0, tags, "pole:type"))
                        and (mapcss._tag_capture(capture_tags, 1, tags, "power"))
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
        ...
        if (
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "man_made"
                    ) == mapcss._value_capture(capture_tags, 0, "pipeline_marker")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "pipeline"
                    ) == mapcss._value_capture(capture_tags, 0, "marker")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
        ...
        if "sloped_curb" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "sloped_curb")
                        == mapcss._value_capture(capture_tags, 0, "yes")
                    ) and (not mapcss._tag_capture(capture_tags, 1, tags, "kerb"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 1, self.re_01eb1711, "^(yes|both|no)$"
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "sloped_curb"
                                ),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "kerb"))
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "sloped_curb")
                    ) and (mapcss._tag_capture(capture_tags, 1, tags, "kerb"))
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["noname", mapcss.tag(tags, "unnamed")]]),
                            "-": (["unnamed"]),
                        },
                    }
                )
        ...
        if "building:height" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building:height"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "building:min_height" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building:min_height"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                        ...
                        "fix": {
                            "+": dict(
                                [
                                    [
                                        "min_height",
                                        mapcss.tag(tags, "building:min_height"),
                                    ]
                                ]
                            ),
                            "-": (["building:min_height"]),
        ...
        if "navigationaid" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "navigationaid"
                    ) == mapcss._value_capture(capture_tags, 0, "approach_light")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        ...
                        capture_tags, 0, "ALS (Approach lighting system)"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "exit_to" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, "exit_to")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        == mapcss._value_capture(capture_tags, 0, "riverbank")
                    ) and (not mapcss._tag_capture(capture_tags, 1, tags, "natural"))
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["natural", "water"], ["water", "river"]])},
                    }
                )
        ...
        if (
            ("natural" in keys and "water" in keys and "waterway" in keys)
            or ("natural" in keys and "waterway" in keys)
            or ("water" in keys and "waterway" in keys)
            or ("waterway" in keys)
        ):
            match = False
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "natural"))
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "water"))
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "water")
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "water"))
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 2, "river")
                        )
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["natural", "water"], ["water", "river"]]),
                            "-": (["waterway"]),
                        },
                    }
                )
        ...
        if ("natural" in keys and "waterway" in keys) or (
            "water" in keys and "waterway" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "water"))
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "water")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "river", "river"
                            )
                        )
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "amenity")
                            == mapcss._value_capture(capture_tags, 0, "bench")
                        )
                        and (mapcss._tag_capture(capture_tags, 1, tags, "capacity"))
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "seats"))
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["seats", mapcss.tag(tags, "capacity")]]),
                            "-": (["capacity"]),
                        },
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "capacity"))
                        and (mapcss._tag_capture(capture_tags, 2, tags, "seats"))
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "shop" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "shop"
                    ) == mapcss._value_capture(capture_tags, 0, "lamps")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "access" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "access"
                    ) == mapcss._value_capture(capture_tags, 0, "customer")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "addr:inclusion" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "addr:inclusion"
                    ) == mapcss._value_capture(capture_tags, 0, "estimated")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["addr:inclusion", "estimate"]])},
                    }
                )
        ...
        if "building" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "apartment")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "lamp_mount" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "lamp_mount"
                    ) == mapcss._value_capture(capture_tags, 0, "bent mast")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "lamp_mount" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "lamp_mount"
                    ) == mapcss._value_capture(capture_tags, 0, "straight mast")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["lamp_mount", "straight_mast"]])},
                    }
                )
        ...
        if "lamp_type" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "lamp_type"
                    ) == mapcss._value_capture(capture_tags, 0, "electrical")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "generator:type" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "generator:type"
                    ) == mapcss._value_capture(
                        capture_tags, 0, "solar_photovoltaic_panels"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["generator:type", "solar_photovoltaic_panel"]])
                        },
                    }
                )
        ...
        if "building" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building"
                    ) == mapcss._value_capture(capture_tags, 0, "part")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "natural" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "natural"
                    ) == mapcss._value_capture(capture_tags, 0, "sink_hole")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "climbing:grade:UIAA:min" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "climbing:grade:UIAA:min"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                        ...
                        "fix": {
                            "+": dict(
                                [
                                    [
                                        "climbing:grade:uiaa:min",
                                        mapcss.tag(tags, "climbing:grade:UIAA:min"),
                                    ]
                                ]
                            ),
                            "-": (["climbing:grade:UIAA:min"]),
        ...
        if "climbing:grade:UIAA:max" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "climbing:grade:UIAA:max"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                        ...
                        "fix": {
                            "+": dict(
                                [
                                    [
                                        "climbing:grade:uiaa:max",
                                        mapcss.tag(tags, "climbing:grade:UIAA:max"),
                                    ]
                                ]
                            ),
                            "-": (["climbing:grade:UIAA:max"]),
        ...
        if "climbing:grade:UIAA:mean" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "climbing:grade:UIAA:mean"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                        ...
                        "fix": {
                            "+": dict(
                                [
                                    [
                                        "climbing:grade:uiaa:mean",
                                        mapcss.tag(tags, "climbing:grade:UIAA:mean"),
                                    ]
                                ]
                            ),
                            "-": (["climbing:grade:UIAA:mean"]),
        ...
        if "climbing:grade:UIAA" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "climbing:grade:UIAA"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                        ...
                        "fix": {
                            "+": dict(
                                [
                                    [
                                        "climbing:grade:uiaa",
                                        mapcss.tag(tags, "climbing:grade:UIAA"),
                                    ]
                                ]
                            ),
                            "-": (["climbing:grade:UIAA"]),
        ...
        if "cuisine" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "cuisine")
                    ) and (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_2f881233),
                            mapcss._tag_capture(capture_tags, 1, tags, "cuisine"),
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "cuisine" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_340a2b31),
                            mapcss._tag_capture(capture_tags, 0, tags, "cuisine"),
                        )
                    ) and (
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                                capture_tags, 1, self.re_7d409ed5, "(?i)(_bbq)"
                            ),
                            mapcss._tag_capture(capture_tags, 1, tags, "cuisine"),
                        )
                    )
                ...
                err.append(
                    {
                        "class": 9002001,
                        "subclass": 1958782130,
                        "text": mapcss.tr("{0} is deprecated", "cuisine=bbq"),
                    }
                )
        ...
        if "Fixme" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, "Fixme")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["fixme", mapcss.tag(tags, "Fixme")]]),
                            "-": (["Fixme"]),
                        },
                    }
                )
        ...
        if "service:bicycle:chaintool" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "service:bicycle:chaintool"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                            ...
                            "+": dict(
                                [
                                    [
                                        ...
                                        mapcss.tag(tags, "service:bicycle:chaintool"),
                                    ]
                                ]
                            ),
                            "-": (["service:bicycle:chaintool"]),
        ...
        if "building:roof:shape" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "building:roof:shape"
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                        ...
                        "fix": {
                            "+": dict(
                                [
                                    [
                                        "roof:shape",
                                        mapcss.tag(tags, "building:roof:shape"),
                                    ]
                                ]
                            ),
                            "-": (["building:roof:shape"]),
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "pumping_rig")
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "pump_mechanism"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 3, tags, "mechanical_coupling"
                            )
                        )
                    )
                except mapcss.RuleAbort:
        ...
        if "man_made" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = (not set_pumping_ring_no_mech) and (
                        mapcss._tag_capture(capture_tags, 0, tags, "man_made")
                        == mapcss._value_capture(capture_tags, 0, "pumping_rig")
                    )
                except mapcss.RuleAbort:
        ...
        if "pump:type" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "pump:type")
                            == mapcss._value_capture(capture_tags, 0, "beam_pump")
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "pump_mechanism"
        ...
        if "pump:type" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = (not set_beam_pump_no_mech) and (
                        mapcss._tag_capture(capture_tags, 0, tags, "pump:type")
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "substance" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "substance"
                    ) == mapcss._value_capture(capture_tags, 0, "heat")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "landuse" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "landuse"
                    ) == mapcss._value_capture(capture_tags, 0, "school")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "vending")
                        == mapcss._value_capture(capture_tags, 1, "parcel_mail_in")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "vending")
                        == mapcss._value_capture(capture_tags, 1, "parcel_pickup")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "vending"))
                        and (
                            mapcss.list_contains(
                                mapcss._tag_capture(capture_tags, 2, tags, "vending"),
                                mapcss._value_capture(
                                    capture_tags, 2, "parcel_mail_in"
                                ),
                            )
                        )
                        and (
                            mapcss.list_contains(
                                mapcss._tag_capture(capture_tags, 3, tags, "vending"),
                                mapcss._value_capture(capture_tags, 3, "parcel_pickup"),
                            )
                        )
                        and (
                            mapcss.count(
                                mapcss.uniq_list(
                                    mapcss.split(";", mapcss.tag(tags, "vending"))
                                )
                            )
                            == 2
                        )
        ...
        if "surface" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "surface"
                    ) == mapcss._value_capture(capture_tags, 0, "decoturf")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "school" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "school"
                    ) == mapcss._value_capture(capture_tags, 0, "entrance")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if ("voltage-high" in keys) or ("voltage-low" in keys):
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, "voltage-high")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, "voltage-low")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "toilet" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = (mapcss._tag_capture(capture_tags, 0, tags, "toilet")) and (
                        not mapcss._tag_capture(capture_tags, 1, tags, "toilets")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["toilets", mapcss.tag(tags, "toilet")]]),
                            "-": (["toilet"]),
                        },
                    }
                )
        ...
        if "toilet" in keys and "toilets" in keys:
            ...
            if not match:
                ...
                try:
                    match = (mapcss._tag_capture(capture_tags, 0, tags, "toilet")) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "toilets")
                    )
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "type" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "type"
                    ) == mapcss._value_capture(capture_tags, 0, "turnlanes:turns")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "image" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = (mapcss._tag_capture(capture_tags, 0, tags, "image")) and (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 1, self.re_0fbae48f),
                            mapcss._tag_capture(capture_tags, 1, tags, "image"),
                        )
                    )
                except mapcss.RuleAbort:
                    pass
    ...
    def way(self, data, tags, nds):
        ...
        if "building:color" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "building:color"))
                        and (
                            not mapcss._tag_capture(
                        ...
                        "fix": {
                            "+": dict(
                                [
                                    [
                                        "building:colour",
                                        mapcss.tag(tags, "building:color"),
                                    ]
                                ]
                            ),
                            "-": (["building:color"]),
        ...
        if "roof:color" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "roof:color"))
                        and (
                            not mapcss._tag_capture(
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "building:color")
                            == mapcss._value_capture(
                                capture_tags, 2, mapcss.tag(tags, "building:colour")
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, -1, tags, "area")
        ...
        if "roof:color" in keys and "roof:colour" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "roof:color"))
                        and (mapcss._tag_capture(capture_tags, 1, tags, "roof:colour"))
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "roof:color")
                            == mapcss._value_capture(
                                capture_tags, 2, mapcss.tag(tags, "roof:colour")
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, -1, tags, "area")
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, self.re_34c15d62))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "route")
                            == mapcss._value_capture(capture_tags, 1, "ferry")
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "to"))
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "type")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "waterway", "waterway"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "man_made")
                            == mapcss._value_capture(capture_tags, 2, "pipeline")
                        )
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["substance", mapcss.tag(tags, "type")]]),
                            "-": (["type"]),
                        },
                    }
                )
        ...
        if ("barrier" in keys and "type" in keys) or (
            "barrier" in keys and "type" in keys and "wall" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "wall")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "type")
                            == mapcss._value_capture(capture_tags, 1, "noise_barrier")
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "wall"))
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "wall")
                            == mapcss._value_capture(capture_tags, 2, "noise_barrier")
                        )
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["wall", mapcss.tag(tags, "type")]]),
                            "-": (["type"]),
                        },
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 2, tags, "wall"))
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "wall")
                            != mapcss._value_const_capture(
                                capture_tags, 3, "noise_barrier", "noise_barrier"
                            )
                        )
                    )
                except mapcss.RuleAbort:
        ...
        if (
            ("highway" in keys and "service" in keys)
            or ("noexit" in keys)
            or ("railway" in keys and "service" in keys)
            or ("service" in keys and "waterway" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "service"))
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags,
                                    2,
                                    self.re_51df498f,
                                    "^(alley|drive-through|drive_through|driveway|emergency_access|parking_aisle|rest_area|slipway|yes)$",
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "service"),
                            )
                        )
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "rail")
                        )
                        and (mapcss._tag_capture(capture_tags, 1, tags, "service"))
                        and (
                            not mapcss.regexp_test(
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "waterway")
                            == mapcss._value_capture(capture_tags, 0, "canal")
                        )
                        and (mapcss._tag_capture(capture_tags, 1, tags, "service"))
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    2,
                                    self.re_7a045a17,
                                    "^(irrigation|transportation|water_power)$",
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "service"),
                            )
                        )
        ...
        if "tracktype" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "tracktype"
                    ) == mapcss._value_capture(capture_tags, 0, 3)
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("misspelled value")
        ...
        if "tracktype" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "tracktype"
                    ) == mapcss._value_capture(capture_tags, 0, 4)
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("misspelled value")
        ...
        if "tracktype" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "tracktype"
                    ) == mapcss._value_capture(capture_tags, 0, 5)
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("misspelled value")
                    ...
                    match = (
                        ...
                        not mapcss.regexp_test(
                            mapcss._value_const_capture(
                                ...
                                1,
                                self.re_047d5648,
                                "^(1|2|3|4|5|grade1|grade2|grade3|grade4|grade5)$",
                            ),
                            mapcss._tag_capture(capture_tags, 1, tags, "tracktype"),
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "area" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "area"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "area")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "yes", "yes"
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "area")
                            != mapcss._value_const_capture(capture_tags, 2, "no", "no")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, -1, tags, "area")
        ...
        if ("direction" in keys) or ("direction" in keys and "incline" in keys):
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "direction")
                        == mapcss._value_capture(capture_tags, 0, "up")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "incline")
                        == mapcss._value_capture(capture_tags, 1, "up")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "direction")
                        == mapcss._value_capture(capture_tags, 0, "down")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "incline")
                        == mapcss._value_capture(capture_tags, 1, "down")
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "direction")
                        == mapcss._value_capture(capture_tags, 0, "up")
                    ) and (not mapcss._tag_capture(capture_tags, 1, tags, "incline"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict([["incline", mapcss.tag(tags, "direction")]]),
                            "-": (["direction"]),
                        },
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "incline"))
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "incline")
                            != mapcss._value_const_capture(capture_tags, 2, "up", "up")
                        )
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "water" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "water"
                    ) == mapcss._value_capture(capture_tags, 0, "salt")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "water"
                    ) == mapcss._value_capture(capture_tags, 0, "salt_pool")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "water"
                    ) == mapcss._value_capture(capture_tags, 0, "salt_panne")
                except mapcss.RuleAbort:
                    pass
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "water"
                    ) == mapcss._value_capture(capture_tags, 0, "salt_pond")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "water" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "water"
                    ) == mapcss._value_capture(capture_tags, 0, "tidal")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "power" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "power"
                    ) == mapcss._value_capture(capture_tags, 0, "busbar")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append(
                    {
                        ...
                        "allow_fix_override": True,
                        "fix": {"+": dict([["line", "busbar"], ["power", "line"]])},
                    }
                )
        ...
        if "barrier" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "barrier"
                    ) == mapcss._value_capture(capture_tags, 0, "embankment")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "landuse" in keys:
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "landuse"
                    ) == mapcss._value_capture(capture_tags, 0, "churchyard")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if "bicycle:oneway" in keys:
            ...
            if not match:
                capture_tags = {}
                try:
                    match = mapcss._tag_capture(capture_tags, 0, tags, "bicycle:oneway")
                except mapcss.RuleAbort:
                    pass
            if match:
                # group:tr("deprecated tagging")
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "highway"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "construction")
                            == mapcss._value_capture(capture_tags, 1, "yes")
                        )
                        and (
        ...
        if (
            ...
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "cycleway:left"
                    ) == mapcss._value_capture(capture_tags, 0, "none")
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = mapcss._tag_capture(
                        capture_tags, 0, tags, "cycleway:right"
                    ) == mapcss._value_capture(capture_tags, 0, "none")
                except mapcss.RuleAbort:
                    pass
            if not match:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "parking:orientation"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "orientation"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, -1, tags, "area")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "orientation"))
                        and (
                            mapcss._tag_capture(
                                capture_tags, 2, tags, "parking:orientation"
                            )
                            == mapcss._value_capture(
                                capture_tags, 2, mapcss.tag(tags, "orientation")
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, -1, tags, "area")
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, self.re_34c15d62)
                    ) and (not mapcss._tag_capture(capture_tags, 1, tags, "to"))
                except mapcss.RuleAbort:
                    pass
            if match:
                # throwWarning:tr("uncommon short key")
...
class Test(TestPluginMapcss):
    def test(self):
        ...
        self.check_err(
            n.node(data, {"name": "FIXME"}),
            expected={"class": 9002005, "subclass": 642340557},
        )
        self.check_err(
            n.node(data, {"name": "Fixme"}),
            expected={"class": 9002005, "subclass": 642340557},
        ...
        self.check_not_err(
            n.node(data, {"name": "valid name"}),
            expected={"class": 9002005, "subclass": 642340557},
        )
        self.check_err(
            n.node(data, {"f": "b"}), expected={"class": 9002012, "subclass": 79709106}
        )
        self.check_err(
            n.node(data, {"fo": "bar"}),
            expected={"class": 9002012, "subclass": 79709106},
        )
        self.check_not_err(
            n.node(data, {"kp": "5"}), expected={"class": 9002012, "subclass": 79709106}
        )
        self.check_not_err(
            n.node(data, {"pk": "7"}), expected={"class": 9002012, "subclass": 79709106}
        )
        self.check_not_err(
            n.node(
                data,
                {
                    "emergency_telephone_code": "456",
                    "highway": "emergency_access_point",
                },
            ),
            expected={"class": 9002001, "subclass": 1339208019},
        )
        self.check_not_err(
            n.node(
                data,
        ...
        self.check_err(
            n.node(data, {"highway": "emergency_access_point", "phone": "123"}),
            expected={"class": 9002001, "subclass": 1339208019},
        )
        self.check_not_err(
            n.node(data, {"phone": "123"}),
            expected={"class": 9002001, "subclass": 1339208019},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    "emergency_telephone_code": "123",
                    "highway": "emergency_access_point",
                },
            ),
            expected={"class": 9002001, "subclass": 342466099},
        )
        self.check_err(
            n.node(
                data,
        ...
        self.check_not_err(
            ...
            expected={"class": 9002001, "subclass": 663070970},
        )
        self.check_not_err(
            n.node(
                data,
        ...
        self.check_err(
            n.node(data, {"amenity": "vending_machine", "vending": "parcel_mail_in"}),
            expected={"class": 9002001, "subclass": 1305128315},
        )
        self.check_err(
            n.node(data, {"amenity": "vending_machine", "vending": "parcel_pickup"}),
            expected={"class": 9002001, "subclass": 1305128315},
        )
        self.check_err(
            n.node(
            ...
            expected={"class": 9002001, "subclass": 954921281},
        )
        self.check_err(
            n.node(
                data,
        ...
        self.check_err(
            n.node(
                data, {"amenity": "vending_machine", "vending": "parcel_pickup;stamp"}
            ),
            expected={"class": 9002001, "subclass": 424486726},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    "image": "https://commons.wikimedia.org/wiki/File:2015-05-13_Basteibr%C3%BCcke-.jpg"
                },
            ),
            expected={"class": 9002023, "subclass": 2042174729},
        )
        self.check_not_err(
            n.node(
                data,
                {
                    "image": "https://web.archive.org/web/20220623215400/https://westnordost.de/p/97331.jpg"
                },
            ),
            expected={"class": 9002023, "subclass": 2042174729},
        )
        self.check_err(
            n.node(data, {"image": "https://westnordost.de/p/17484.jpg"}),
            expected={"class": 9002023, "subclass": 2042174729},
        )
        self.check_not_err(
            n.way(data, {"barrier": "fence"}, [0]),
            expected={"class": 9002001, "subclass": 1107799632},
        )
        self.check_err(
            n.way(data, {"barrier": "wire_fence"}, [0]),
            expected={"class": 9002001, "subclass": 1107799632},
        )
        self.check_err(
            n.way(data, {"access": "designated"}, [0]),
            expected={"class": 9002002, "subclass": 2057594338},
        )
        self.check_err(
            n.way(data, {"access": "official"}, [0]),
            expected={"class": 9002003, "subclass": 1909133836},
        )
        self.check_err(
            n.way(data, {"fixme": "yes"}, [0]),
            expected={"class": 9002004, "subclass": 136657482},
        )
        self.check_not_err(
            n.way(data, {"building:color": "red", "building:colour": "red"}, [0]),
            expected={"class": 9002001, "subclass": 816484633},
        )
        self.check_err(
            n.way(data, {"building:color": "red"}, [0]),
            expected={"class": 9002001, "subclass": 816484633},
        )
        self.check_not_err(
            n.way(data, {"roof:color": "red", "roof:colour": "red"}, [0]),
            expected={"class": 9002001, "subclass": 1645101726},
        )
        self.check_err(
            n.way(data, {"roof:color": "red"}, [0]),
            expected={"class": 9002001, "subclass": 1645101726},
        )
        self.check_not_err(
            n.way(data, {"building:color": "red", "building:colour": "green"}, [0]),
            expected={"class": 9002001, "subclass": 1236974991},
        )
        self.check_err(
            n.way(data, {"building:color": "red", "building:colour": "red"}, [0]),
            expected={"class": 9002001, "subclass": 1236974991},
        ...
        self.check_not_err(
            n.way(data, {"roof:color": "red", "roof:colour": "green"}, [0]),
            expected={"class": 9002001, "subclass": 1815260806},
        )
        self.check_err(
            n.way(data, {"roof:color": "red", "roof:colour": "red"}, [0]),
            expected={"class": 9002001, "subclass": 1815260806},
        ...
        self.check_not_err(
            n.way(data, {"color": "red"}, [0]),
            expected={"class": 9002001, "subclass": 1632389707},
        )
        self.check_err(
            n.way(data, {"cycleway:surface:color": "grey"}, [0]),
            expected={"class": 9002001, "subclass": 1632389707},
        )
        self.check_not_err(
            n.way(data, {"roof:color": "grey"}, [0]),
            expected={"class": 9002001, "subclass": 1632389707},
        )
        self.check_err(
            n.way(data, {"color:back": "grey"}, [0]),
            expected={"class": 9002001, "subclass": 1390370717},
        )
        self.check_not_err(
            n.way(data, {"color": "red"}, [0]),
            expected={"class": 9002001, "subclass": 1390370717},
        ...
        self.check_not_err(
            n.way(data, {"route": "ferry", "to": "Zuidschermer;Akersloot"}, [0]),
            expected={"class": 9002012, "subclass": 1765060211},
        )
        self.check_err(
            n.way(data, {"to": "bar"}, [0]),
            expected={"class": 9002012, "subclass": 1765060211},
        ...
        self.check_not_err(
            n.way(data, {"description_3": "foo"}, [0]),
            expected={"class": 9002014, "subclass": 2081989305},
        )
        self.check_err(
            n.way(data, {"name_1": "foo"}, [0]),
            expected={"class": 9002014, "subclass": 2081989305},
        )
        self.check_not_err(
            n.way(data, {"note_2": "foo"}, [0]),
            expected={"class": 9002014, "subclass": 2081989305},
        )
        self.check_not_err(
            n.way(data, {"tiger:name_base_1": "bar"}, [0]),
            expected={"class": 9002014, "subclass": 2081989305},
        )
        self.check_not_err(
            n.way(data, {"building": "supermarket", "building:type": "church"}, [0]),
            expected={"class": 9002001, "subclass": 1927794430},
        )
        self.check_err(
            n.way(data, {"building": "yes", "building:type": "church"}, [0]),
            expected={"class": 9002001, "subclass": 1927794430},
        )
        self.check_err(
            n.way(data, {"building:type": "church"}, [0]),
            expected={"class": 9002001, "subclass": 1927794430},
        )
        self.check_err(
            n.way(data, {"building": "supermarket", "building:type": "church"}, [0]),
            expected={"class": 9002001, "subclass": 1133239698},
        )
        self.check_not_err(
            n.way(data, {"building": "yes", "building:type": "church"}, [0]),
            expected={"class": 9002001, "subclass": 1133239698},
        ...
        self.check_not_err(
            n.way(
                data,
                {"natural": "shingle", "water": "river", "waterway": "riverbank"},
                [0],
            ),
            expected={"class": 9002001, "subclass": 1604946271},
        )
        self.check_not_err(
            n.way(data, {"natural": "shingle", "waterway": "riverbank"}, [0]),
            expected={"class": 9002001, "subclass": 1604946271},
        )
        self.check_not_err(
            n.way(
                data,
                {"natural": "water", "water": "lake", "waterway": "riverbank"},
                [0],
            ),
            expected={"class": 9002001, "subclass": 1604946271},
        )
        self.check_err(
            n.way(
                data,
                {"natural": "water", "water": "river", "waterway": "riverbank"},
                [0],
            ),
            expected={"class": 9002001, "subclass": 1604946271},
        )
        self.check_err(
            n.way(data, {"natural": "water", "waterway": "riverbank"}, [0]),
            expected={"class": 9002001, "subclass": 1604946271},
        )
        self.check_not_err(
            n.way(data, {"water": "lake", "waterway": "riverbank"}, [0]),
            expected={"class": 9002001, "subclass": 1604946271},
        )
        self.check_err(
            n.way(data, {"water": "river", "waterway": "riverbank"}, [0]),
            expected={"class": 9002001, "subclass": 1604946271},
        )
        self.check_err(
            n.way(data, {"waterway": "riverbank"}, [0]),
            expected={"class": 9002001, "subclass": 1604946271},
        )
        self.check_err(
            n.way(data, {"natural": "shingle", "waterway": "riverbank"}, [0]),
            expected={"class": 9002001, "subclass": 301661430},
        )
        self.check_not_err(
            n.way(
                data,
        ...
        self.check_err(
            n.way(data, {"cuisine": "BBQ"}, [0]),
            expected={"class": 9002001, "subclass": 1943338875},
        )
        self.check_err(
            n.way(data, {"cuisine": "bbq"}, [0]),
            expected={"class": 9002001, "subclass": 1943338875},
        ...
        self.check_not_err(
            n.way(data, {"cuisine": "bbq;pizza"}, [0]),
            expected={"class": 9002001, "subclass": 1943338875},
        )
        self.check_not_err(
            n.way(data, {"cuisine": "korean_bbq"}, [0]),
            expected={"class": 9002001, "subclass": 1943338875},
        )
        self.check_not_err(
            n.way(data, {"cuisine": "korean_bbq;bbq"}, [0]),
            expected={"class": 9002001, "subclass": 1943338875},
        )
        self.check_not_err(
            n.way(data, {"cuisine": "pasta;bbq;pizza"}, [0]),
            expected={"class": 9002001, "subclass": 1943338875},
        )
        self.check_not_err(
            n.way(data, {"cuisine": "pizza;Bbq"}, [0]),
            expected={"class": 9002001, "subclass": 1943338875},
        )
        self.check_not_err(
            n.way(data, {"cuisine": "pizza;bbq"}, [0]),
        ...
        self.check_not_err(
            n.way(data, {"cuisine": "BBQ"}, [0]),
            expected={"class": 9002001, "subclass": 1958782130},
        )
        self.check_not_err(
            n.way(data, {"cuisine": "bbq"}, [0]),
            expected={"class": 9002001, "subclass": 1958782130},
        ...
        self.check_not_err(
            n.way(data, {"FIXME": "foo"}, [0]),
            expected={"class": 9002001, "subclass": 592643943},
        )
        self.check_err(
            n.way(data, {"Fixme": "foo"}, [0]),
            expected={"class": 9002001, "subclass": 592643943},
        ...
        self.check_err(
            n.relation(data, {"fo": "bar"}, []),
            expected={"class": 9002012, "subclass": 518970721},
        )
        self.check_not_err(
            n.relation(data, {"to": "Berlin"}, []),
            expected={"class": 9002012, "subclass": 518970721},
        )
