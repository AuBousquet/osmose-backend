...
class Josm_Rules_Brazilian_Specific(PluginMapCSS):
    ...
    def init(self, logger):
        ...
        self.errors[9018002] = self.def_class(
            item=9018, level=3, tags=["tag"], title=mapcss.tr("Brasil - Verificar")
        )
        self.errors[9018003] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "palavra abreviada em {0}",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9018004] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr("nome supérfluo/incompleto de local de lazer"),
        )
        self.errors[9018005] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr("nome supérfluo/incompleto de local de saúde"),
        )
        self.errors[9018006] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr("Brasil - Correções e melhorias"),
        )
        self.errors[9018007] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr("objeto com nomenclatura incorreta"),
        )
        self.errors[9018008] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} não deve ser utilizado em nó; utilizar a restrição na via",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9018009] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} é uma chave utilizada apenas no Reino Unido",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9018010] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} sem pelo menos uma das tags: {1} ou {2}",
        ...
        self.errors[9018012] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} sem nome", mapcss._tag_uncapture(capture_tags, "{0.value}")
            ),
        )
        self.errors[9018013] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} deve conter apenas o nome da cidade",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9018014] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
        ...
        self.errors[9018016] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr("SAMU classificado de forma errada"),
        )
        self.errors[9018017] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "objeto não deve possuir {0}",
                mapcss._tag_uncapture(capture_tags, "{1.key}"),
            ),
        )
        self.errors[9018018] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
        ...
        self.errors[9018019] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} deve ser utilizado com {1}={0} ou {2}={0}",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
                mapcss._tag_uncapture(capture_tags, "{1.key}"),
                mapcss._tag_uncapture(capture_tags, "{2.key}"),
            ),
        )
        self.errors[9018020] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} deve estar incluído em {1}, separado por '';'' caso necessário",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
                mapcss._tag_uncapture(capture_tags, "{1.key}"),
            ),
        )
        self.errors[9018021] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "especificar valor correto para {0} ao invés de ''{1}''",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
                mapcss.tag(tags, "landuse"),
            ),
        )
        self.errors[9018022] = self.def_class(
            item=9018,
            level=2,
            tags=["tag"],
            title=mapcss.tr(
                "chave inválida: {0}", mapcss._tag_uncapture(capture_tags, "{0.key}")
            ),
        )
        self.errors[9018023] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "não se deve utilizar {0} para demarcar áreas de cobertura de imagem",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9018026] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "possível ausência de tag {0}",
                mapcss._tag_uncapture(capture_tags, "{1.key}"),
            ),
        )
        self.errors[9018027] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "ausência do tempo de duração ({0}) da balsa",
                mapcss._tag_uncapture(capture_tags, "{1.key}"),
            ),
        )
        self.errors[9018029] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "possível definição incorreta para praça: ''{0}''",
                mapcss._tag_uncapture(capture_tags, "{2.key}"),
            ),
        )
        self.errors[9018030] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "utilizar prefixo em português (pt:) para {0}",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9018031] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr("nome utilizado de forma incorreta"),
        )
        self.errors[9018032] = self.def_class(
            item=9018,
            level=2,
            tags=["tag"],
            title=mapcss.tr(
                "nó não deve possuir {0}",
                mapcss._tag_uncapture(capture_tags, "{0.tag}"),
            ),
        )
        self.errors[9018033] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
        ...
        self.errors[9018034] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "valor incorreto para {0}",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9018035] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr("ausência de boundary=protected_area"),
        )
        self.errors[9018036] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} deve ser usado apenas em ways",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9018037] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "utilize ''destination'' no caminho de saída ao invés de ''exit_to''"
            ),
        )
        self.errors[9018039] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "o conteúdo de {0} deve fazer parte de ref, separado por ;",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9018041] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "objeto incompleto: possui apenas {0}",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9018042] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "objeto incompleto: possui apenas {0} e {1}",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
                mapcss._tag_uncapture(capture_tags, "{1.key}"),
            ),
        )
        self.errors[9018043] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "não utilizar ''{0}'' para locais sem número",
                mapcss.tag(tags, "addr:housenumber"),
            ),
        )
        self.errors[9018044] = self.def_class(
            item=9018,
            level=2,
            tags=["tag"],
            title=mapcss.tr("objeto contém Google como source"),
        )
        self.errors[9018046] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "relação não deve possuir {0}",
                mapcss._tag_uncapture(capture_tags, "{1.key}"),
            ),
        )
        self.errors[9018047] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} deve ser utilizado apenas em nós",
                mapcss._tag_uncapture(capture_tags, "{0.tag}"),
            ),
        )
        self.errors[9018048] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} deve possuir ''type=boundary''",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9018049] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} deve ser utilizado junto com {1}",
                mapcss._tag_uncapture(capture_tags, "{0.tag}"),
                mapcss._tag_uncapture(capture_tags, "{1.key}"),
            ),
        )
        self.errors[9018051] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "não classificar via como {0}",
                mapcss._tag_uncapture(capture_tags, "{0.tag}"),
            ),
        )
        self.errors[9018052] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} com nome supérfluo/incompleto",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
            ),
        )
        self.errors[9018053] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} não deve possuir {1}",
                mapcss._tag_uncapture(capture_tags, "{0.key}"),
                mapcss._tag_uncapture(capture_tags, "{1.tag}"),
            ),
        )
        self.errors[9018056] = self.def_class(
            item=9018,
            level=2,
            tags=["tag"],
            title=mapcss.tr(
                "{0} deve ser utilizado apenas no nó de saída da rodovia",
                mapcss._tag_uncapture(capture_tags, "{0.tag}"),
            ),
        )
        self.errors[9018063] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "uso incorreto de {0} com {1}",
                mapcss._tag_uncapture(capture_tags, "{0.tag}"),
                mapcss._tag_uncapture(capture_tags, "{1.tag}"),
            ),
        )
        self.errors[9018064] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "uso incorreto de {0}", mapcss._tag_uncapture(capture_tags, "{1.key}")
            ),
        )
        self.errors[9018065] = self.def_class(
            item=9018, level=3, tags=["tag"], title=mapcss.tr("ausência de wetland=*")
        )
        self.errors[9018066] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
        ...
        self.errors[9018067] = self.def_class(
            item=9018,
            level=3,
            tags=["tag"],
            title=mapcss.tr(
                "{0} inapropriada para ''{1}''",
                mapcss._tag_uncapture(capture_tags, "{1.key}"),
                mapcss._tag_uncapture(capture_tags, "{0.tag}"),
            ),
        )
        ...
        self.re_044c8944 = re.compile(
            r"^(?i)(?u)(SENAC|SENAI|Serviço Nacional de Aprendizagem)"
        )
        ...
        self.re_07f31a73 = re.compile(
            r"^(living_street|pedestrian|residential|road|service|track)$"
        )
        self.re_0b27200b = re.compile(r"(?i)^s(\.|-| )?\/?n\.?º?$")
        self.re_0db5b64e = re.compile(r"village|town|city")
        self.re_1054eb5a = re.compile(
            r"bridleway|bus_stop|cycleway|crossing|footway|give_way|motorway_junction|path|raceway|rest_area|services|speed_camera|steps|stop"
        )
        ...
        self.re_178f5446 = re.compile(
            r"(?i)(^|.* )(Cel|Cmte|Cond|Conj|Dª|Dr|Eng|Gov|Hab|Jd|Jr|Marg|Mun|p\/|Pde|Pe|Pq|Pst|Pref|Profa|Profª|Prof|Res|s\/|Sr(a|ª)?|Sta|Sto|Ver)\.? .*"
        )
        self.re_17fd35b3 = re.compile(r"^pt:")
        self.re_1b6eb989 = re.compile(
            r"^(fine_gravel|gravel|pebbles|pebblestone|sand|shells|shingle|stones)$"
        )
        self.re_1d232d4c = re.compile(
            r"^(?i)(?u)(Centro Universitário|Faculdades?|FATEC|Instituto Federal)\b"
        )
        self.re_20188fb1 = re.compile(r"^[0-9]+( |-)*([A-Z])?$")
        self.re_20c7dd98 = re.compile(
            r"^(?i)(?u)(aldeia|borrach(aria|eiro)|bosque|capela|cemit(é|e)rio|c(ó|o)rrego|escola|estacionamento|fazenda|floresta|hospital|igreja|lago|lagoa|mata( nativa)?|praça|parque|parquinho|posto( de gasolina)?|riacho|rio|rodovi(á|a)ria|vila)$"
        )
        self.re_20cf30ba = re.compile(
            r"^(?i)(?u)(alameda|avenida|beco|estrada|ladeira|rodovia|rotatória|rua|travessa|trevo|viela) .*"
        )
        self.re_20fc5143 = re.compile(r"^(?i)Bairro\b")
        self.re_243f4993 = re.compile(r"^(\+55|0800)")
        self.re_280004fd = re.compile(
            r"^(Água|Arroio|Cabeceira|Córrego|Furo|Grota|Igarapé|Lajeado|Paraná|Restinga|Riacho|Ribeirão|Rio|Sanga)\b"
        )
        ...
        self.re_31732cd0 = re.compile(
            r"(?i)(?u)^(Brasilg(á|a)s|Consigaz|Copagaz|Liquig(á|a)s|Minasg(á|a)s|Nacional G(á|a)s|Supergasbras|Ultragaz)$"
        )
        self.re_3570fd42 = re.compile(r"(?i)\bAPA\b")
        self.re_35bb0f2f = re.compile(
            r"^(?i)(?u)(auto(-| )?( moto )?escola|centro de formação de condutores|cfc|moto escola)\b"
        )
        self.re_362f879f = re.compile(r"college|school")
        self.re_375e3de4 = re.compile(
            r".*([A-Z]{2,3}-[0-9]{2,4}|SPM(-| )[0-9]{3} ?(D|E)?|SP(A|D|I)(-| )[0-9]{3}\/[0-9]{3}|[A-Z]{3}-[0-9]{3}\/[0-9]{3}).*"
        )
        self.re_38a8f0ff = re.compile(r"^(?i)(?u)edifício.*")
        self.re_39d67968 = re.compile(r"^[a-z].*")
        self.re_3aeda39d = re.compile(
            r"hamlet|island|isolated_dwelling|neighbourhood|suburb|village"
        )
        self.re_3b304b9b = re.compile(
            r"(?i)(?u)\b(Centro Paula Souza|Escola Técnica|ETEC)\b"
        )
        ...
        self.re_52ab3b8b = re.compile(
            r"^(?i)(?u)((Posto|Unidade (Básica)?) de Sa(u|ú)de|UBS|PSF|hospital)$"
        )
        self.re_53abc074 = re.compile(
            r"^(give_way|mini_roundabout|stop|turning_circle)$"
        )
        ...
        self.re_5849be19 = re.compile(
            r"^(?i)(?u)(alameda|avenida|beco|estrada|ladeira|passarela|rodovia|rotatória|rua|travessa|trevo|viela|(anel|complexo|dispositivo) viário) .*"
        )
        self.re_58f616c9 = re.compile(
            r"^(city_block|farm|hamlet|island|islet|isolated_dwelling|neighbourhood|square)$"
        )
        ...
        self.re_65710fdb = re.compile(
            r"(?i)(?u)((sem (denomina(ç|c)(ã|a)o|nome|sa(i|í)da))|desconhecido|n(ã|a)o conhecido)"
        )
        self.re_667ce569 = re.compile(
            r"^(?i)(?u)((via de )?(acesso|ligação)(( (a|à))? propriedade)?|entrada|entroncamento|rampa|retorno|rotat(ó|o)ria|r(ó|o)tula|sa(í|i)da|trevo|estrada( municipal| de terra)?|rua|rodovia|via)( (de acesso|sem nome|projetad(a|o)))?$"
        )
        self.re_67c67cf2 = re.compile(r"^[0-9]+0$")
        self.re_6b6e390d = re.compile(r"(Alameda|Avenida|Rua|Travessa|Viela) .*")
        self.re_6bf570a0 = re.compile(
        ...
        self.re_7b7c453d = re.compile(
            r"^(?i)(?u)(AM(A|E)|(Posto|Unidade (Básica)?) de Sa(u|ú)de|UBS|PSF).*"
        )
        self.re_7ec1fb9a = re.compile(r"(?i)^prefeitura\b")
        self.re_7f53e992 = re.compile(
            r"^(?i)(?u)(campo|est(á|a)dio|gin(á|a)sio|quadra)( de (futebol|esportes?))?$"
        )
    ...
    def node(self, data, tags):
                    ...
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "addr:street"
                                ),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 279840772,
                        "text": mapcss.tr(
                            "{0} com logradouro ausente, errado ou abreviado",
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                        ),
                    }
                )
        ...
        if "name" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (not mapcss._tag_capture(capture_tags, 0, tags, "highway"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "route")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "road", "road"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "public_transport"
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 3, self.re_72d45155, "route|street"
                                ),
                                mapcss._tag_capture(capture_tags, 3, tags, "type"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 4, tags, "name"))
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 5, self.re_5849be19
                                ),
                                mapcss._tag_capture(capture_tags, 5, tags, "name"),
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(capture_tags, 6, tags, "name"),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                err.append(
                    {
                        ...
                        "subclass": 535280341,
                        "text": mapcss.tr(
                            "objeto com nome de via mas sem tag de {0}",
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                        ),
                    }
                )
        ...
        if "name" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_4bd3b925),
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 1476954926,
                        "text": mapcss.tr("utilizar espaço ao invés de underscore"),
                    }
                )
        ...
        if "name" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_178f5446),
                            mapcss._tag_capture(capture_tags, 0, tags, "name"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_7f53e992
                                ),
                ...
                err.append(
                    {
                        ...
                        "subclass": 1485441713,
                        "text": mapcss.tr(
                            "nome supérfluo/incompleto de local de lazer"
                        ),
                    }
                )
        ...
        if "name" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_52ab3b8b),
                            mapcss._tag_capture(capture_tags, 0, tags, "name"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1497769259,
                        "text": mapcss.tr(
                            "nome supérfluo/incompleto de local de saúde"
                        ),
                    }
                )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_5ab76b11
                                ),
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_4cf86823
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 1962359328,
                        "text": mapcss.tr("erro de ortografia em ''saúde''"),
                    }
                )
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "farm")
                        )
                        and (
                            mapcss.startswith(
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                                mapcss._value_capture(capture_tags, 1, "Sitio "),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 653860263,
                        "text": mapcss.tr("faltando acento em ''Sítio''"),
                    }
                )
        ...
        if "name" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_20c7dd98),
                            mapcss._tag_capture(capture_tags, 0, tags, "name"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1104230922,
                        "text": mapcss.tr(
                            "local com nome supérfluo, incompleto ou descritivo"
                        ),
                    }
                )
        ...
        if ("designation" in keys) or ("name" in keys) or ("ref" in keys):
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "designation")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "addr:housename")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "ref")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "designation")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "ref")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "old_ref")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "name")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "alt_name")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "name")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "int_name")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "name")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "loc_name")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "name")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "nat_name")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "name")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "official_name")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "name")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "old_name")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "name")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "reg_name")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "name")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "short_name")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "name")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "sorting_name")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "subclass": 2003922,
                        "text": mapcss.tr(
                            "{0} e {1} são iguais; remover chave {1} desnecessária",
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                            mapcss._tag_uncapture(capture_tags, "{0.value}"),
                        ),
        ...
        if "source" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "source")
                        == mapcss._value_capture(
                            capture_tags, 0, mapcss.tag(tags, "name")
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
        ...
        if "name" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_65710fdb),
                            mapcss._tag_capture(capture_tags, 0, tags, "name"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        "class": 9018007,
                        "subclass": 1272098213,
                        "text": mapcss.tr("objeto com nomenclatura incorreta"),
                    }
                )
        ...
        if ("maxheight" in keys) or ("maxspeed" in keys):
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "maxheight"))
                        and (
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 1, "speed_camera", "speed_camera"
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(
                                capture_tags, 0, "motorway_junction"
                            )
                        )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_152c10ee
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "place"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "population")
                            >= mapcss._value_capture(capture_tags, 1, 100000)
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1009134521,
                        "text": mapcss.tr(
                            "local com 100.000 habitantes ou mais deve ser classificado como city"
                        ),
                        "allow_fix_override": True,
                        "fix": {"+": dict([["place", "city"]])},
                    }
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_591572a5
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "place"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "population")
                            >= mapcss._value_capture(capture_tags, 1, 10000)
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "population")
                            < mapcss._value_capture(capture_tags, 2, 100000)
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1343568198,
                        "text": mapcss.tr(
                            "local com população entre 10.000 e 100.000 deve ser classificado como town"
                        ),
                        "allow_fix_override": True,
                        "fix": {"+": dict([["place", "town"]])},
                    }
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    1,
                                    self.re_3aeda39d,
                                    "hamlet|island|isolated_dwelling|neighbourhood|suburb|village",
                                ),
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "population")
                            < mapcss._value_capture(capture_tags, 2, 10000)
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 409005616,
                        "text": mapcss.tr(
                            "local com menos de 10.000 habitantes deve ser classificado como village"
                        ),
                        "allow_fix_override": True,
                        "fix": {"+": dict([["place", "village"]])},
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "place")
                            == mapcss._value_capture(capture_tags, 0, "city")
                        )
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "name"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "place")
                            == mapcss._value_capture(capture_tags, 0, "town")
                        )
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "name"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "place")
                            == mapcss._value_capture(capture_tags, 0, "village")
                        )
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "name"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
        ...
        if ("addr:city" in keys and "place" in keys) or (
            "addr:suburb" in keys and "place" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_0db5b64e
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "place"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "addr:city")
                            == mapcss._value_capture(
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "place")
                            == mapcss._value_capture(capture_tags, 0, "suburb")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "addr:suburb")
                            == mapcss._value_capture(
                                capture_tags, 1, mapcss.tag(tags, "name")
                            )
                        )
        ...
        if "addr:city" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_10f1c360),
                            mapcss._tag_capture(capture_tags, 0, tags, "addr:city"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_2cd1e949
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "name"),
                            )
                        )
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    2,
                                    self.re_5d3348cb,
                                    "city|farm|neighbourhood|suburb|town|village",
                                ),
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_20fc5143
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 1441242115,
                        "text": mapcss.tr(
                            "objeto talvez não deva ter ''Bairro'' no nome"
                        ),
                    }
                )
        ...
        if "place" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_6416be64),
                            mapcss._tag_capture(capture_tags, 0, tags, "place"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 820669758,
                        "text": mapcss.tr(
                            "representar a ilha, se possível, como uma área"
                        ),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        == mapcss._value_capture(capture_tags, 0, "0")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_362f879f
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "amenity"),
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_1d232d4c
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 1605707172,
                        "text": mapcss.tr(
                            "estabelecimento de ensino classificado incorretamente"
                        ),
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict(
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_044c8944
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_6c0d6e9e
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "amenity"),
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_3b304b9b
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_35bb0f2f
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        "class": 9018006,
                        "subclass": 566309924,
                        "text": mapcss.tr("autoescola classificada incorretamente"),
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict(
                                [
                                    (
                                        mapcss._tag_uncapture(
                                            capture_tags, "{0.key}=driving_school"
                                        )
                                    ).split("=", 1)
                                ]
                            )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_160d1bfc
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        "class": 9018006,
                        "subclass": 1847987722,
                        "text": mapcss.tr("creche classificada incorretamente"),
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict(
                                [
                                    (
                                        mapcss._tag_uncapture(
                                            capture_tags, "{0.key}=kindergarten"
                                        )
                                    ).split("=", 1)
                                ]
                            )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_7b7c453d
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "name"),
                            )
                        )
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "hospital")
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 74419437,
                        "text": mapcss.tr(
                            "postos/unidades de saúde devem ser amenity=clinic"
                        ),
                        "allow_fix_override": True,
                        "fix": {"+": dict([["amenity", "clinic"]])},
                    }
                )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_2dbaea13
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "name"),
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_3eb0ab44
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "amenity"),
                            )
                        )
                ...
                err.append(
                    {
                        "class": 9018016,
                        "subclass": 392029310,
                        "text": mapcss.tr("SAMU classificado de forma errada"),
                    }
                )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_53abc074
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "highway"),
                            )
                        )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "highway")
                            == mapcss._value_capture(capture_tags, 0, "speed_camera")
                        )
        ...
        if "crossing" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "crossing"))
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "highway"))
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "railway"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if ("aeroway" in keys and "designation" in keys) or (
            "aeroway" in keys and "ref" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_7afc6883
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "designation"
                                ),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "icao"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                    pass
                    ...
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(capture_tags, 1, tags, "ref"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "icao"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                ...
                err.append(
                    {
                        ...
                        "subclass": 619372172,
                        "text": mapcss.tr(
                            "{0} provavelmente deve ser utilizado como {1}",
                            mapcss._tag_uncapture(capture_tags, "{1.key}"),
                            mapcss._tag_uncapture(capture_tags, "{2.key}"),
                        ),
                        "allow_fix_override": True,
        ...
        if "access" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "access")
                        == mapcss._value_capture(capture_tags, 0, "permissive")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1240816112,
                        "text": mapcss.tr(
                            "{0} deve ser utilizado apenas em vias privadas com permissão de acesso e não em vias de acesso público",
                            mapcss._tag_uncapture(capture_tags, "{0.tag}"),
                        ),
                    }
                )
        ...
        if "addr:postcode" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_57bee688),
                            mapcss._tag_capture(capture_tags, 0, tags, "addr:postcode"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        "class": 9018006,
                        "subclass": 1667206075,
                        "text": mapcss.tr("formato do CEP pode ser melhorado"),
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict(
                                [
        ...
        if "alt_source" in keys and "source" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "alt_source"))
                        and (mapcss._tag_capture(capture_tags, 1, tags, "source"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "long_name" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "long_name")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "hires" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "hires")
                        in ("yes", "true", "1")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "tower:type")
                            == mapcss._value_capture(capture_tags, 1, "lighting")
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "motel")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "amenity")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "love_hotel", "love_hotel"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_01454d46
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "name"),
                            )
                        )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "amenity")
                            == mapcss._value_capture(capture_tags, 0, "love_hotel")
                        )
                        and (mapcss._tag_capture(capture_tags, 1, tags, "tourism"))
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "tourism")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "motel", "motel"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_5cd37790
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 1456128106,
                        "text": mapcss.tr("motel classificado incorretamente"),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "aeroway")
                            == mapcss._value_capture(capture_tags, 0, "aerodrome")
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_6efb8049
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "aeroway")
                            == mapcss._value_capture(capture_tags, 0, "helipad")
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_6566db6a
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_6024a566
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_139e342b
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 136467214,
                        "text": mapcss.tr(
                            "conferir se existe nome oficial do {0}",
                            mapcss._tag_uncapture(capture_tags, "{0.value}"),
                        ),
                    }
                )
                ...
                err.append(
                    {
                        ...
                        "subclass": 1633437696,
                        "text": mapcss.tr(
                            "''{0}'' não faz sentido em aeroporto",
                            mapcss._tag_uncapture(capture_tags, "{1.key}"),
                        ),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "layer")
                            < mapcss._value_capture(capture_tags, 1, 0)
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "tunnel"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "subclass": 203420779,
                        "text": mapcss.tr(
                            "{0} negativo de {1} com ausência de {2}",
                            mapcss._tag_uncapture(capture_tags, "{1.key}"),
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                            mapcss._tag_uncapture(capture_tags, "{2.key}"),
                        ),
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "bridge"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "subclass": 1870051659,
                        "text": mapcss.tr(
                            "{0} positivo de {1} com ausência de {2}",
                            mapcss._tag_uncapture(capture_tags, "{1.key}"),
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                            mapcss._tag_uncapture(capture_tags, "{2.key}"),
                        ),
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_38a8f0ff
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "ferry")
                        )
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "duration"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if ("landuse" in keys and "name" in keys) or (
            "name" in keys and "natural" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_4a8ca94e
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "name"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "leisure"))
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_05a345c7
                                ),
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_12b48afb
                                ),
        ...
        if "wikipedia" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "wikipedia"))
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 1, self.re_17fd35b3, "^pt:"
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "wikipedia"),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
        ...
        if "name" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_131cc885),
                            mapcss._tag_capture(capture_tags, 0, tags, "name"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        "class": 9018031,
                        "subclass": 115703372,
                        "text": mapcss.tr("nome utilizado de forma incorreta"),
                    }
                )
        ...
        if (
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "admin_level"))
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "capital"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                    pass
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "boundary")
                            == mapcss._value_capture(capture_tags, 0, "national_park")
                        )
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "name"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "boundary")
                            == mapcss._value_capture(capture_tags, 0, "protected_area")
                        )
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "name"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "leisure")
                            == mapcss._value_capture(capture_tags, 0, "nature_reserve")
                        )
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "name"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "protect_class"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
        ...
        if "protect_class" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "protect_class"))
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags,
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "protect_class"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "boundary")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "protected_area", "protected_area"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                err.append(
                    {
                        "class": 9018035,
                        "subclass": 1649283274,
                        "text": mapcss.tr("ausência de boundary=protected_area"),
                    }
                )
        ...
        if "exit_to" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "exit_to")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1001734093,
                        "text": mapcss.tr(
                            "saída de rodovia ({0}) fora do padrão",
                            mapcss._tag_uncapture(capture_tags, "{1.key}"),
                        ),
                    }
                )
                ...
                err.append(
                    {
                        ...
                        "subclass": 625356625,
                        "text": mapcss.tr(
                            "{0} geralmente não possui nome; use ''destination'' no caminho de saída",
                            mapcss._tag_uncapture(capture_tags, "{0.tag}"),
                        ),
                    }
                )
        ...
        if "name" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_2ffc377d),
                            mapcss._tag_capture(capture_tags, 0, tags, "name"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 874509528,
                        "text": mapcss.tr(
                            "''da'', ''de'' e ''do'' são minúsculos nos nomes em português"
                        ),
                    }
                )
        ...
        if "name" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_39d67968),
                            mapcss._tag_capture(capture_tags, 0, tags, "name"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 2073274467,
                        "text": mapcss.tr("nome iniciando com letra minúscula"),
                    }
                )
        ...
        if "alt_ref" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "alt_ref")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if ("name" in keys and "surface" in keys) or (
            "name" in keys and "website" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "name"))
                        and (mapcss._tag_capture(capture_tags, 1, tags, "website"))
                        and (len(tags) == 2)
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "peak")
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_292e0bb5
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 907675189,
                        "text": mapcss.tr("nome não deve conter a elevação do pico"),
                    }
                )
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "tennis")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "surface")
                            == mapcss._value_capture(capture_tags, 2, "unpaved")
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 990400213,
                        "text": mapcss.tr(
                            "{0} com superfície incorreta",
                            mapcss._tag_uncapture(capture_tags, "{2.key}"),
                        ),
                        "allow_fix_override": True,
                        "fix": {"+": dict([["surface", "clay"]])},
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "amenity")
                            == mapcss._value_capture(capture_tags, 0, "fuel")
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_604bb645
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 1724035987,
                        "text": mapcss.tr(
                            "o nome não deve conter a bandeira/marca do posto"
                        ),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "brand")
                            == mapcss._value_capture(capture_tags, 1, "BR")
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 435141543,
                        "text": mapcss.tr("uso inconsistente de bandeira do posto"),
                        "allow_fix_override": True,
                        "fix": {"+": dict([["brand", "Petrobras"]])},
                    }
                )
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "gas")
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_31732cd0
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 867102166,
                        "text": mapcss.tr(
                            "o nome não deve conter a bandeira/marca da loja"
                        ),
                    }
                )
        ...
        if True:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, self.re_57b8ef8e))
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "is_in:iso_3166_2"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_0b27200b
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 0, tags, "addr:housenumber"
                                ),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "note"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                    pass
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "note"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if "source" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_2e8e4f2b),
                            mapcss._tag_capture(capture_tags, 0, tags, "source"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        "class": 9018044,
                        "subclass": 1159310436,
                        "text": mapcss.tr("objeto contém Google como source"),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "amenity")
                            == mapcss._value_capture(capture_tags, 0, "townhall")
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_46ab4d8d
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 532372413,
                        "text": mapcss.tr(
                            "câmara de vereadores mapeada incorretamente"
                        ),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "government")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "legislative", "legislative"
                            )
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_46ab4d8d
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 2126685099,
                        "text": mapcss.tr("ausência de government=legislative"),
                    }
                )

        # *[amenity=townhall][name=~/^(?i)(?u)c((â|a)me|ama)ra\b/][inside("BR")]
        # *[office=government][name=~/^(?i)(?u)c((â|a)me|ama)ra\b/][inside("BR")]
        if ("amenity" in keys and "name" in keys) or (
            "name" in keys and "office" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_793b22ec
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 1277153079,
                        "text": mapcss.tr("erro de ortografia em ''câmara''"),
                    }
                )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_7ec1fb9a
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "name"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "amenity")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "townhall", "townhall"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                err.append(
                    {
                        ...
                        "subclass": 1445137044,
                        "text": mapcss.tr(
                            "prefeitura possivelmente mapeada de forma incorreta"
                        ),
                    }
                )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_13f4c147
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 1169494638,
                        "text": mapcss.tr(
                            "paço possivelmente mapeado de forma incorreta"
                        ),
                    }
                )
        ...
        if "amenity" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "amenity")
                        == mapcss._value_capture(capture_tags, 0, "charging_station")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 2011797637,
                        "text": mapcss.tr("possivelmente deve ser amenity=fuel"),
                    }
                )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_126ba9a9
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "name"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "shop")
                            == mapcss._value_capture(capture_tags, 1, "tyres")
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "repair"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 1225518759,
                        "text": mapcss.tr("borracharia sem ''repair=yes''"),
                    }
                )
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 755877630,
                        "text": mapcss.tr("borracharia sem ''shop=tyres''"),
                    }
                )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_6e34cd0f
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "name"),
                            )
                        )
                        and (
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 1, "bandstand", "bandstand"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 2, tags, "leisure")
                            != mapcss._value_const_capture(
                                capture_tags, 2, "park", "park"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                err.append(
                    {
                        ...
                        "subclass": 810497942,
                        "text": mapcss.tr(
                            "coreto possivelmente classificado de forma incorreta"
                        ),
                    }
                )
        ...
        if "leisure" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "leisure")
                        == mapcss._value_capture(capture_tags, 0, "recreation_ground")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "leisure")
                            == mapcss._value_capture(
                                capture_tags, 0, "recreation_ground"
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "landuse")
                            == mapcss._value_capture(
                                capture_tags, 1, "recreation_ground"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
        ...
        if "ref:vatin" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "ref:vatin"))
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 1, self.re_524288b6, "^BR[0-9]{14}$"
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "ref:vatin"),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 1793026117,
                        "text": mapcss.tr("CNPJ diferente do formato BRxxxxxxxxxxxxxx"),
                    }
                )
        ...
        if "ref:vatin" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_5ddbb7eb),
                            mapcss._tag_capture(capture_tags, 0, tags, "ref:vatin"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1609978963,
                        "text": mapcss.tr(
                            "formato do CNPJ pode ser melhorado em {0}",
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                        ),
                        "allow_fix_override": True,
                        "fix": {
        ...
        if "ref:vatin" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_408831d0),
                            mapcss._tag_capture(capture_tags, 0, tags, "ref:vatin"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 1616044431,
                        "text": mapcss.tr(
                            "CNPJ deve iniciar maiúsculo: BRxxxxxxxxxxxxxx"
                        ),
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict(
                                [
                                    (
                                        mapcss.concat(
                                            "ref:vatin=",
                                            mapcss.upper(mapcss.tag(tags, "ref:vatin")),
                                        )
                                    ).split("=", 1)
                                ]
                            )
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 1, self.re_243f4993, "^(\+55|0800)"
                                ),
                    ...
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "contact:phone"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                ...
                err.append(
                    {
                        ...
                        "subclass": 1438682200,
                        "text": mapcss.tr(
                            "{0} em formato diferente do internacional +55 XX YYYY-YYYY",
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                        ),
                    }
                )
        ...
        if ("contact:phone" in keys) or ("phone" in keys):
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss.regexp_test(
                            mapcss._value_capture(capture_tags, 0, self.re_7a246e93),
                            mapcss._tag_capture(capture_tags, 0, tags, "phone"),
                        )
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 371146161,
                        "text": mapcss.tr(
                            "não usar número de emergência em {0}",
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                        ),
                        "allow_fix_override": True,
                        "fix": {
    ...
    def way(self, data, tags, nds):
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_568a42f4
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 457207682,
                        "text": mapcss.tr("rodovia com ref no nome"),
                    }
                )
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    1,
                                    self.re_1054eb5a,
                                    "bridleway|bus_stop|cycleway|crossing|footway|give_way|motorway_junction|path|raceway|rest_area|services|speed_camera|steps|stop",
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "highway"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "name"))
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags,
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_7a5b2736
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 2131010585,
                        "text": mapcss.tr(
                            "Rua com nome abreviado; procurar nome completo nas camadas de nomes"
                        ),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "highway")
                            == mapcss._value_capture(capture_tags, 0, "track")
                        )
                        and (mapcss._tag_capture(capture_tags, 1, tags, "name"))
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_20cf30ba
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_667ce569
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            ...
                            == mapcss._value_capture(capture_tags, 1, "route")
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_375e3de4
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 2109205925,
                        "text": mapcss.tr(
                            "utilizar o código/sigla da rodovia também na tag {0}",
                            mapcss._tag_uncapture(capture_tags, "{1.key}"),
                        ),
                    }
                )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_7633bf4e
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 718023291,
                        "text": mapcss.tr(
                            "nome incorreto de rodovia; utilizar o nome oficial ou apenas ref"
                        ),
                    }
                )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_6b6e390d
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 227495312,
                        "text": mapcss.tr(
                            "possível uso desnecessário/errado de ref em {0}={1}",
                            mapcss._tag_uncapture(capture_tags, "{0.key}"),
                            mapcss.tag(tags, "highway"),
                        ),
                    }
                )
        ...
        if "highway" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "highway")
                        == mapcss._value_capture(capture_tags, 0, "give_way")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "highway")
                        == mapcss._value_capture(capture_tags, 0, "mini_roundabout")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "highway")
                        == mapcss._value_capture(capture_tags, 0, "stop")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "highway")
                        == mapcss._value_capture(capture_tags, 0, "turning_circle")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if match:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "highway"))
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "junction")
                            == mapcss._value_capture(capture_tags, 1, "circular")
                        )
                        and (
                            not mapcss._tag_capture(capture_tags, 2, tags, "oneway")
                            in ("yes", "true", "1")
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 1396859077,
                        "text": mapcss.tr("junção circular sem ''oneway''"),
                        "allow_fix_override": True,
                        "fix": {"+": dict([["oneway", "yes"]])},
                    }
                )
        ...
        if ("addr:postcode" in keys and "highway" in keys) or (
            "addr:postcode" in keys and "place" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                            ...
                            "+": dict(
                                [
                                    [
                                        (
                                            mapcss._tag_uncapture(
                                                capture_tags, "{1.key} => postal_code"
                                            )
                                        )
                                        .split("=>", 1)[1]
                                        .strip(),
        ...
        if "highway" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "highway")
                        == mapcss._value_capture(capture_tags, 0, "motorway_junction")
                    ) and (mapcss.inside(self.father.config.options, "BR"))
                except mapcss.RuleAbort:
                    pass
            if match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 2, self.re_066203d3, "^[0-9]+$"
                                ),
                ...
                err.append(
                    {
                        ...
                        "subclass": 78890622,
                        "text": mapcss.tr(
                            "velocidade máxima deve ser apenas o valor numérico, em km/h"
                        ),
                    }
                )
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 2, self.re_67c67cf2, "^[0-9]+0$"
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "maxspeed"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 1298210435,
                        "text": mapcss.tr(
                            "velocidade máxima deveria ser múltiplo de 10"
                        ),
                    }
                )
        ...
        if ("cycleway" in keys and "cycleway:left" in keys) or (
            "cycleway" in keys and "cycleway:right" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "lane")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "cycleway:left")
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    1,
                                    self.re_58f616c9,
                                    "^(city_block|farm|hamlet|island|islet|isolated_dwelling|neighbourhood|square)$",
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "place"),
                            )
                        )
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 2, tags, "admin_level"
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "boundary"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        ...
                        "subclass": 1502787309,
                        "text": mapcss.tr(
                            "local com ausência/incoerência de limite administrativo"
                        ),
                    }
                )
                ...
                err.append(
                    {
                        "class": 9018006,
                        "subclass": 827896633,
                        "text": mapcss.tr("ausência de boundary=administrative"),
                        "allow_fix_override": True,
                        "fix": {"+": dict([["boundary", "administrative"]])},
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "leisure")
                            == mapcss._value_capture(capture_tags, 1, "nature_reserve")
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 2, self.re_509425de
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_3570fd42
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
                ...
                err.append(
                    {
                        ...
                        "subclass": 2108639028,
                        "text": mapcss.tr(
                            "Utilizar o nome por extenso ao invés de ''APA''"
                        ),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "tracktype"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_07f31a73
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "highway"),
                            )
                        )
                ...
                err.append(
                    {
                        "class": 9018002,
                        "subclass": 728045324,
                        "text": mapcss.tr("a via deve ser ao menos tertiary"),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "natural")
                            == mapcss._value_capture(capture_tags, 0, "wetland")
                        )
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "wetland"))
                        and (mapcss.inside(self.father.config.options, "BR"))
                        and (
                            mapcss._tag_capture(capture_tags, -1, tags, "area")
                            != mapcss._value_const_capture(capture_tags, -1, "no", "no")
                ...
                err.append(
                    {
                        "class": 9018065,
                        "subclass": 1029145948,
                        "text": mapcss.tr("ausência de wetland=*"),
                    }
                )
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    2,
                                    self.re_1b6eb989,
                                    "^(fine_gravel|gravel|pebbles|pebblestone|sand|shells|shingle|stones)$",
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "surface"),
                            )
                        )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(capture_tags, 1, tags, "area")
                            in ("yes", "true", "1")
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                        and (nds[0] == nds[-1])
                ...
                err.append(
                    {
                        ...
                        "subclass": 691633247,
                        "text": mapcss.tr(
                            "adicionar ''area=yes'' caso esteja representando uma área"
                        ),
                    }
                )
        ...
        if ("alt_name" in keys and "waterway" in keys) or (
            "name" in keys and "waterway" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_04873a60
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "waterway"),
                            )
                        )
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    2,
                                    self.re_280004fd,
                                    "^(?U)(Água|Arroio|Cabeceira|Córrego|Furo|Grota|Igarapé|Lajeado|Paraná|Restinga|Riacho|Ribeirão|Rio|Sanga)\b",
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "name"),
                            )
                        )
                    ...
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(capture_tags, 2, tags, "alt_name"),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                err.append(
                    {
                        ...
                        "subclass": 139982797,
                        "text": mapcss.tr(
                            "{0} com possível nome errado/incompleto",
                            mapcss.tag(tags, "waterway"),
                        ),
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "place")
                            == mapcss._value_capture(capture_tags, 0, "square")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "leisure")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "park", "park"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                        and (
                ...
                err.append(
                    {
                        ...
                        "subclass": 758716021,
                        "text": mapcss.tr(
                            "{0} deve ser usado em praças pavimentadas (plaza)",
                            mapcss._tag_uncapture(capture_tags, "{0.tag}"),
                        ),
                    }
                )
    ...
    def relation(self, data, tags, members):
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_073e5345
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "name"),
                            )
                        )
        ...
        # area[place=~/village|town|city/]["addr:city"=*name][inside("BR")]
        # area[place=suburb]["addr:suburb"=*name][inside("BR")]
        if ("addr:city" in keys and "place" in keys and "type" in keys) or (
            "addr:suburb" in keys and "place" in keys and "type" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
        ...
        if "enforcement" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "enforcement")
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "enforcement")
                            == mapcss._value_capture(capture_tags, 0, "maxheight")
                        )
                        and (
                            not mapcss._tag_capture(capture_tags, 1, tags, "maxheight")
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "enforcement")
                            == mapcss._value_capture(capture_tags, 0, "maxweight")
                        )
                        and (
                            not mapcss._tag_capture(capture_tags, 1, tags, "maxweight")
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "type")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "boundary", "boundary"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "boundary")
                            != mapcss._value_const_capture(
                                capture_tags, 1, "administrative", "administrative"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss._tag_capture(
                                capture_tags, 1, tags, "admin_level"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "BR"))
                    )
                ...
                err.append(
                    {
                        "class": 9018006,
                        "subclass": 238210452,
                        "text": mapcss.tr("relação deve ser do tipo ''type=boundary''"),
                        "allow_fix_override": True,
                        "fix": {"+": dict([["type", "boundary"]])},
                    }
                )
