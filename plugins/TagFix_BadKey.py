...
[Any_tags_you_like#Syntactic_conventions_for_new_tags](https://wiki.openstreetmap.org/wiki/Any_tags_you_like#Syntactic_conventions_for_new_tags)."""
            ...
            fix=T_("""Check the key tag, and correct."""),
            trap=T_("""There certainly false positives."""),
        )
        self.errors[3050] = self.def_class(
            item=3050, level=1, tags=["tag", "fix:chair"], title=T_("Bad key"), **doc
        )
        self.errors[30502] = self.def_class(
            item=3050, level=3, tags=["tag", "fix:chair"], title=T_("Bad key"), **doc
        )
        self.errors[30501] = self.def_class(
            item=3050,
            level=1,
            tags=["tag", "fix:chair"],
        ...
        self.exceptions = set(
            (
                ...
                "cityracks.rackid",
                "cityracks.small",
                "cityracks.street",  # NYC amenity=bicycle_parking
