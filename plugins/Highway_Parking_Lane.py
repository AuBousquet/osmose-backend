...
class Highway_Parking_Lane(Plugin):
    ...
    def init(self, logger):
        ...
        self.parkingConditionReasonValues = [
            "bus_stop",
            "crossing",
            "driveway",
            "dual_carriage",
        ...
        self.errors[31611] = self.def_class(
            item=3161,
            level=2,
            tags=["highway", "parking", "fix:imagery"],
...
[`parking:lane=*`](https://wiki.openstreetmap.org/wiki/Key:parking:lane)."""
        ...
        self.errors[31614] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:imagery"],
...
However, `both` already covers both sides of a street, so the latter are redundant."""
        ...
        self.errors[31615] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:chair"],
        ...
        self.errors[31616] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:survey"],
            title=T_("parking:condition:[side] without parking:lane:[side] value"),
            detail=T_("""A parking condition is present but without parking kind."""),
            fix=T_(
                """Consider switching to the new [street parking tagging scheme]("https://wiki.openstreetmap.org/wiki/Street_parking)."""
            ),
        )
        self.errors[31617] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:survey"],
        ...
        self.errors[31618] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:survey"],
            title=T_(
                "parking:condition:[side] should be mapped on separately mapped parking area"
            ),
            detail=T_(
...
be tagged on that object instead."""
        ...
        self.errors[31619] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:survey"],
        ...
        self.errors[31621] = self.def_class(
            item=3161,
            level=2,
            tags=["highway", "parking", "fix:imagery"],
            ...
            fix=T_("""Use `parking:left`, `parking:right` or `parking:both`."""),
...
you should use `parking:both:maxstay=2 hours`, and not `parking:maxstay=2 hours`."""
        ...
        self.errors[31622] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:survey"],
        ...
        self.errors[31623] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:imagery"],
...
However, `parking:both` already covers both sides of a street, so the latter are redundant."""
        ...
        self.errors[31624] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:chair"],
            title=T_("Bad value for parking:[side]=*"),
            fix=T_(
                """Use any of the following values: `{0}`.""",
                "`, `".join(self.parkingValues),
            ),
            resource="https://wiki.openstreetmap.org/wiki/Street_parking",
        )
        self.errors[31625] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:survey"],
        ...
        self.errors[31626] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:survey"],
            title=T_(
                "Property of parking should be mapped on separately mapped parking area"
            ),
            detail=T_(
...
Any parking details should be tagged on that object instead."""
        ...
        self.errors[31627] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:survey"],
            ...
            fix=T_(
                """Use any of the following values: `{0}`.""",
                ", ".join(self.orientationValues),
            ),
            resource="https://wiki.openstreetmap.org/wiki/Street_parking",
        )
        self.errors[31628] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:survey"],
            ...
            fix=T_(
                """Use any of the following values: `{0}`.""",
                ", ".join(self.restrictionValues),
            ),
            resource="https://wiki.openstreetmap.org/wiki/Street_parking",
        )
        self.errors[31629] = self.def_class(
            item=3161,
            level=3,
            tags=["highway", "parking", "fix:survey"],
    ...
    def way(self, data, tags, nds):
        ...
        sides = list(
            map(lambda tag: tag[len("parking:") :].split(":")[0], parking_keys)
        )
        if ("condition" in sides or "lane" in sides) and not (
            "right" in sides or "left" in sides or "both" in sides
        ):
            ...
            if (
                (
                    "parking:condition:right" in tags
                    and tags["parking:condition:right"][0:2] != "no"
                    and "parking:lane:right" not in tags
                    and "parking:lane:both" not in tags
                )
                or (
                    "parking:condition:left" in tags
                    and tags["parking:condition:left"][0:2] != "no"
                    and "parking:lane:left" not in tags
                    and "parking:lane:both" not in tags
                )
                or (
                    "parking:condition:both" in tags
                    and tags["parking:condition:both"][0:2] != "no"
                    and "parking:lane:both" not in tags
                    and not (
                        "parking:lane:left" in tags and "parking:lane:right" in tags
                    )
                )
            ):
            ...
            sides = list(
                map(
                    lambda tag: tag[len("parking:lane:") :].split(":")[0],
                    filter(lambda tag: tag.startswith("parking:lane:"), tags),
                )
            )
            if len(sides) == 0:
                return err
            ...
            if "parking:lane:both" in tags and (
                (
                    "parking:lane:right" in tags
                    and tags["parking:lane:right"] == tags["parking:lane:both"]
                )
                or (
                    "parking:lane:left" in tags
                    and tags["parking:lane:left"] == tags["parking:lane:both"]
                )
            ):
                ...
                if side in tags:
                    if tags[side] not in self.parkingLaneValues:
                        ...
                        if tags[side] in self.parkingConditionValues:
                            err.append(
                                {
                                    "class": 31615,
                                    "subclass": stablehash64(side),
                                    "text": T_(
                                        "`{0}` is a value for key `{1}`",
                                        tags[side],
                    ...
                    if condition in tags:
                        if tags[side] == "no" and tags[condition][0:2] != "no":
                            ...
                            tags[condition] in self.parkingLaneValues
                            and tags[condition] not in self.parkingConditionValues
                        ):
        ...
        sides = list(
            set(
                [
                    i
                    for i in sides
                    if i not in ("left", "right", "both", "condition", "lane")
                ]
            )
        )
        if len(sides) > 0:
            err.append(
                {
                    "class": 31621,
                    "subclass": stablehash64(";".join(sides)),
                    "text": {
                        "en": (
                            f"parking:[{'|'.join(sides)}]"
                            if len(sides) > 1
                            else f"parking:{sides[0]}"
                        )
                    },
                }
            )
        ...
        if (
            (
                "parking:both" not in parking_keys
                and "parking:left" not in parking_keys
                and any(
                    map(
                        lambda key: key.startswith("parking:left:")
                        and (
                            not key.startswith("parking:left:restriction")
                            or (
                                key == "parking:left:restriction"
                                and tags[key][0:3] != "no_"
                            )
                        ),
                        parking_keys,
                    )
            ...
            or (
                "parking:both" not in parking_keys
                and "parking:right" not in parking_keys
                and any(
                    map(
                        lambda key: key.startswith("parking:right:")
                        and (
                            not key.startswith("parking:right:restriction")
                            or (
                                key == "parking:right:restriction"
                                and tags[key][0:3] != "no_"
                            )
                        ),
                        parking_keys,
            ...
            or (
                "parking:both" not in parking_keys
                and not (
                    "parking:right" in parking_keys and "parking:left" in parking_keys
                )
                and any(
                    map(
                        lambda key: key.startswith("parking:both:")
                        and (
                            not key.startswith("parking:both:restriction")
                            or (
                                key == "parking:both:restriction"
                                and tags[key][0:3] != "no_"
                            )
                        ),
                        parking_keys,
        ...
        for leftrightkey in filter(
            lambda key: key.startswith("parking:left")
            or key.startswith("parking:right"),
            parking_keys,
        ):
            bothkey = leftrightkey.replace(":left", ":both", 1).replace(
                ":right", ":both", 1
            )
        ...
        for side in ("parking:right", "parking:left", "parking:both"):
            if side in parking_keys and tags[side] not in self.parkingValues:
                ...
                for s in {
                    side,
                    side.replace("left", "both", 1).replace("right", "both", 1),
                }:
                    for k in parking_keys:
                        if (
                            k == s + ":restriction"
                            and (tags[k][0:3] != "no_" or tags[side] == "separate")
                        ) or (
                            k.startswith(s + ":")
                            and k != s + ":restriction"
                            and (
                                (":reason" not in k and tags[k] != "no")
                                or tags[side] == "separate"
                            )
                        ):
                            err.append(
                                {
            ...
            # Mixup of other 'subkeys' of parking:side
                ...
                side + ":orientation" in parking_keys
                and tags[side + ":orientation"] not in self.orientationValues
                and (
                    tags[side + ":orientation"] in self.directionValues
                    or tags[side + ":orientation"] in self.restrictionValues
                    or tags[side + ":orientation"] in self.reasonValues
                    or tags[side + ":orientation"] in self.parkingValues
                )
            ):
                err.append(
                    {
                        ...
                        "text": {
                            "en": "{0}={1}".format(
                                side + ":orientation", tags[side + ":orientation"]
                            )
                        },
                    }
                )
            elif (
                side + ":restriction" in parking_keys
                and tags[side + ":restriction"] not in self.restrictionValues
                and (
                    tags[side + ":restriction"] in self.directionValues
                    or tags[side + ":restriction"] in self.orientationValues
                    or tags[side + ":restriction"] in self.reasonValues
                    or tags[side + ":restriction"] in self.parkingValues
                )
            ):
                err.append(
                    {
                        ...
                        "text": {
                            "en": "{0}={1}".format(
                                side + ":restriction", tags[side + ":restriction"]
                            )
                        },
                    }
                )
            elif (
                side + ":direction" in parking_keys
                and tags[side + ":direction"] not in self.directionValues
                and (
                    tags[side + ":direction"] in self.restrictionValues
                    or tags[side + ":direction"] in self.orientationValues
                    or tags[side + ":direction"] in self.reasonValues
                    or tags[side + ":direction"] in self.parkingValues
                )
            ):
                err.append(
                    {
                        ...
                        "text": {
                            "en": "{0}={1}".format(
                                side + ":direction", tags[side + ":direction"]
                            )
                        },
                    }
                )
    ...
    def test(self):
        ...
        for t in [
            ...
            },
            {
                ...
                "parking:condition:both": "parallel",
            },
            ...
            },
            {
                "highway": "road",
                "parking:both": "street_side",
                "parking:both:maxstay": "14 days",
                "parking:right:maxstay": "14 days",
            },
            {
                "highway": "road",
                "parking:both": "street_side",
                "parking:both:capacity": "14",
                "parking:left:capacity": "14",
            },
            ...
            {"highway": "road", "parking:both": "back_in"},
            {
                "highway": "road",
                "parking:both": "street_side",
                "parking:both:restriction": "street_side",
            },
            {
                "highway": "road",
                "parking:both": "yes",
                "parking:both:restriction": "fire_lane",
            },
            {
                "highway": "road",
                "parking:both": "yes",
                "parking:both:orientation": "back_in",
            },
            {
                "highway": "road",
                "parking:both": "yes",
                "parking:both:direction": "diagonal",
            },
            {
                "highway": "road",
            ...
            },
            {
                ...
                "parking:both:direction": "back_in",
            },
            {
                "highway": "road",
                "parking:both": "no",
            ...
            },
            {
                "highway": "road",
                "parking:both": "no",
                "parking:both:restriction": "loading_only",
            },
            {
                "highway": "road",
                "parking:left": "no",
            ...
            },
            {
                "highway": "road",
                "parking:right": "separate",
                "parking:right:reason": "fire_lane",
            },
        ]:
        ...
        for t in [
            {"highway": "r", "parking:lane:both:parallel": "t"},
            {
                "highway": "r",
                "parking:condition:both": "private",
            ...
            },
            {
                ...
                "parking:lane:right": "parallel",
                "parking:lane:both": "no",
            },  # Checked by Highway_Sides plugin
            {
                "highway": "r",
                "parking:condition:right": "private",
            ...
            },
            {
                ...
                "parking:condition:right:capacity": "19",
            },
            {
                "highway": "r",
            ...
            {"highway": "r", "parking:condition:both": "no_parking"},
            {
                ...
                "parking:right": "street_side",
                "parking:lane:left": "parallel",
            },  # Checked for by TagFix_Deprecated
            {"highway": "road", "parking:right": "street_side"},
            {
                ...
                "parking:right:capacity": "14",
                "parking:right:maxstay": "1 hour",
            },
            {
                "highway": "road",
                "parking:right": "street_side",
                "parking:right:orientation": "parallel",
                "parking:right:direction": "back_in",
            },
            ...
            },
            {
                ...
                "parking:both": "no",
                "parking:right:reason": "fire_lane",
                "parking:left:reason": "custom_value",
            },
            {
                "highway": "road",
                "parking:right": "no",
            ...
            },
            {
                "highway": "road",
                "parking:right": "no",
                "parking:right:restriction:reason": "fire_lane",
                "parking:right:restriction": "no_stopping",
            },
            ...
            },  # Checked by Highway_Sides plugin
            {
                ...
                "parking:both": "on_kerb",
            },
            {
                "highway": "road",
                "parking:both:access": "private",
                "parking:left": "half_on_kerb",
