...
class Josm_FranceSpecificRules(PluginMapCSS):
    ...
    def init(self, logger):
        ...
        self.errors[20806] = self.def_class(
            item=2080,
            level=3,
            tags=mapcss.list_("parking", "amenity", "fix:chair"),
            title=mapcss.tr("Missing tag carpool on area"),
        )
        self.errors[21600] = self.def_class(
            item=2160,
            level=3,
            tags=mapcss.list_("tag", "railway"),
            title=mapcss.tr("Missing tag gauge on rail"),
        )
        self.errors[30402] = self.def_class(
            item=3040,
            level=3,
            tags=mapcss.list_("ref", "infrastructure", "power"),
            title=mapcss.tr("missing tag"),
        )
        self.errors[30403] = self.def_class(
            item=3040,
            level=3,
            tags=mapcss.list_("ref", "infrastructure", "telecom"),
            title=mapcss.tr("missing tag"),
        )
        self.errors[30406] = self.def_class(
            item=3040,
            level=3,
            tags=mapcss.list_("ref", "infrastructure", "power"),
            title=mapcss.tr(
                "{0} is invalid", mapcss._tag_uncapture(capture_tags, "{0.tag}")
            ),
        )
        self.errors[30407] = self.def_class(
            item=3040,
            level=3,
            tags=mapcss.list_("ref", "infrastructure", "telecom"),
            title=mapcss.tr(
                "{0} is invalid. Should look like PT123 without leading zeros",
                mapcss._tag_uncapture(capture_tags, "{0.tag}"),
            ),
        )
        self.errors[30408] = self.def_class(
            item=3040,
            level=3,
            tags=mapcss.list_("ref", "infrastructure", "telecom"),
            title=mapcss.tr(
                "{0} is invalid. Should look like 12345ABC",
                mapcss._tag_uncapture(capture_tags, "{0.tag}"),
            ),
        )
        self.errors[30409] = self.def_class(
            item=3040,
            level=3,
            tags=mapcss.list_("ref", "infrastructure", "telecom"),
            title=mapcss.tr(
                "{0} is invalid. Should look like ABC",
                mapcss._tag_uncapture(capture_tags, "{0.tag}"),
            ),
        )
        self.errors[30410] = self.def_class(
            item=3040,
            level=3,
            tags=mapcss.list_("ref", "infrastructure", "telecom"),
            title=mapcss.tr(
        ...
        self.errors[40103] = self.def_class(
            item=4010,
            level=3,
            tags=mapcss.list_("tag", "infrastructure", "power"),
            title=mapcss.tr("deprecated tagging"),
        )
        self.errors[40104] = self.def_class(
            item=4010,
            level=3,
            tags=mapcss.list_("ref", "infrastructure", "power"),
            title=mapcss.tr("deprecated tagging"),
        )
        self.errors[40105] = self.def_class(
            item=4010, level=3, tags=[], title=mapcss.tr("misused tag in this country")
        )
        self.errors[40612] = self.def_class(
            item=4061,
            level=2,
            tags=mapcss.list_("parking", "amenity", "fix:chair"),
            title=mapcss.tr(
                "Does this station still sell SP95, or has it been replaced by the SP95-E10?"
            ),
        )
        self.errors[9019001] = self.def_class(
            item=9019,
            level=3,
            tags=mapcss.list_("ref", "highway"),
            title=mapcss.tr("validation rules highway milestone"),
        )
        self.errors[9019002] = self.def_class(
            item=9019,
            level=3,
            tags=mapcss.list_("ref", "highway"),
            title=mapcss.tr("validation rules nat_ref in France"),
        )
        self.errors[9019003] = self.def_class(
            item=9019, level=3, tags=[], title=mapcss.tr("missing tag")
        )
        self.errors[9019004] = self.def_class(
            item=9019,
            level=3,
            tags=[],
            title={
                "en": "Unusual ref for motorway_junction; use of 'ref=*' for the exit destination ref?"
            },
        )
        self.errors[9019005] = self.def_class(
            item=9019,
            level=3,
            tags=mapcss.list_("ref", "highway"),
            title=mapcss.tr("validation rules Fantoir in France"),
        )

        self.re_045a0f34 = re.compile(r"(?i)co.?voiturage")
        self.re_107d2c86 = re.compile(r"PT[1-9]{1}[0-9]*")
        self.re_1473b7c6 = re.compile(
            r"^(motorway|trunk|primary|secondary|tertiary|unclassified)$"
        )
        self.re_173ac8d4 = re.compile(r"[0-9]{5}[A-Z0-9]{3}")
        self.re_23d0d993 = re.compile(r"[A-Z0-9]{3}")
        self.re_299ea34e = re.compile(
            r"^(motorway_link|trunk_link|primary_link|secondary_link|tertiary_link)$"
        )
        self.re_30299d59 = re.compile(r"^(Enedis|GRDF)$")
        self.re_3b28b3c0 = re.compile(
            r"^(motorway|trunk|primary|secondary|tertiary|unclassified|service)$"
        )
        self.re_3b90619c = re.compile(r"^\D")
        self.re_419bc5d2 = re.compile(
            r"^(([1-9][0-9]|0[1-9])[ANP](8|9)[0-9]{3}(|A|N)([0-9]?[0-9]|B1|B2)(|[A-Z]|[a-z])(|CD)_(1[0-9]|[1-9])D)$"
        )
        self.re_4bae79a8 = re.compile(
            r"[0-9AB]{5}[A-Z]{1,3}[0-9]{4}|[0-9AB]{5}EEM[0-9]{2}"
        )
        self.re_4e9373ac = re.compile(
            r"^(([1-9][0-9]|0[1-9])[ANP]9[0-9]{3}(|A|N)([0-9]?[0-9]|B1|B2)(|[A-Z]|[a-z])(|CD)_(1[0-9]|[1-9])D)$"
        )
        self.re_66c32242 = re.compile(
            r"^([1-9][0-9]|0[1-9])[ANP](8|9)[0-9]{3}(|A|N)([0-9]?[0-9]|B1|B2)(|[A-Z]|[a-z])(|CD)_(1[0-9]|[1-9])D$"
        )
        self.re_6ac6c83c = re.compile(r"^(pole|tower)$")
        self.re_6beaf147 = re.compile(
            r"^([1-9][0-9]|0[1-9])[AN]8[0-9]{3}(|A|N)([0-9]?[0-9])(|[A-Z]|[a-z])(|CD)_(1[0-9]|[1-9])D$"
        )
        self.re_7510958f = re.compile(
            r"^(([1-9][0-9]|0[1-9])PR([0-9]|[1-9][0-9]|[1-9][0-9][0-9])[DGU](|C))$"
        )
        self.re_7f0c6b73 = re.compile(
            r"^(((((((0[1-9]|1[0-9]|2A|2B|2[1-9]|[3-8][0-9]|9[0-5])([0-9]{3}))|((971(0[1-9]|[1-3][0-9]))|(972(0[1-9]|[1-3][0-9]))|(973(0[1-9]|[1-6][0-9]))|(974(0[1-9]|[1-2][0-9]))|(976(0[1-9]|1[0-7]))))([0-9]|[A-Z])([0-9]{3}))([ABCDEFGHJKLMNPRSTUVWXYZ]|))(|;(((((0[1-9]|1[0-9]|2A|2B|2[1-9]|[3-8][0-9]|9[0-5])([0-9]{3}))|((971(0[1-9]|[1-3][0-9]))|(972(0[1-9]|[1-3][0-9]))|(973(0[1-9]|[1-6][0-9]))|(974(0[1-9]|[1-2][0-9]))|(976(0[1-9]|1[0-7]))))([0-9]|[A-Z])([0-9]{3}))([ABCDEFGHJKLMNPRSTUVWXYZ]|))+))|no)$"
        )
    ...
    def node(self, data, tags):
                    ...
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_045a0f34
                                ),
                        ...
                        and (
                            ...
                            != mapcss._value_const_capture(
                                capture_tags, 2, "car_pooling", "car_pooling"
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "carpool"))
                ...
                err.append(
                    {
                        "class": 20806,
                        "subclass": 0,
                        "text": mapcss.tr("Missing tag carpool on area"),
                        "allow_fix_override": True,
                        "fix": {
                            "+": dict(
                                [["amenity", "car_pooling"], ["carpool", "designated"]]
                            )
                        },
                    }
                )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "fuel:octane_95")
                            == mapcss._value_capture(capture_tags, 1, "yes")
                        )
                        and (not mapcss._tag_capture(capture_tags, 2, tags, "fuel:e10"))
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
                except mapcss.RuleAbort:
                    pass
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        == mapcss._value_capture(capture_tags, 0, "ERDF")
                    ) and (mapcss.inside(self.father.config.options, "FR"))
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "ref:ERDF:gdo" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "ref:ERDF:gdo")
                    ) and (mapcss.inside(self.father.config.options, "FR"))
                except mapcss.RuleAbort:
                    pass
            if match:
        ...
        if "ref:FR:gdo" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "ref:FR:gdo"))
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    1,
                                    self.re_4bae79a8,
                                    "[0-9AB]{5}[A-Z]{1,3}[0-9]{4}|[0-9AB]{5}EEM[0-9]{2}",
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "ref:FR:gdo"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "substation")
                        )
                        and (
                            not mapcss._tag_capture(capture_tags, 1, tags, "ref:FR:gdo")
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "ref"))
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 3, self.re_30299d59
                                ),
                                mapcss._tag_capture(capture_tags, 3, tags, "operator"),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "operator")
                            == mapcss._value_capture(capture_tags, 3, "Enedis")
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
                except mapcss.RuleAbort:
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_6ac6c83c
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "power"),
                            )
                        )
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "operator"))
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
                except mapcss.RuleAbort:
                    pass
        ...
        if (
            ("ref:FR:ARCEP" in keys)
            or ("ref:FR:Orange" in keys)
            or ("ref:FR:PTT" in keys)
            or ("ref:FR:SFR" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "ref:FR:ARCEP")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "telecom")
                        != mapcss._value_const_capture(
                            capture_tags, 1, "connection_point", "connection_point"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        ...
                        mapcss._tag_capture(capture_tags, 1, tags, "telecom:medium")
                        != mapcss._value_const_capture(
                            capture_tags, 1, "fibre", "fibre"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "ref:FR:Orange")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "telecom:medium")
                        != mapcss._value_const_capture(
                            capture_tags, 1, "fibre", "fibre"
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "ref:FR:SFR")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "telecom:medium")
                        != mapcss._value_const_capture(
                            capture_tags, 1, "fibre", "fibre"
            ...
            if not match:
                ...
                try:
                    match = (
                        mapcss._tag_capture(capture_tags, 0, tags, "ref:FR:PTT")
                    ) and (
                        mapcss._tag_capture(capture_tags, 1, tags, "telecom:medium")
                        != mapcss._value_const_capture(
                            capture_tags, 1, "copper", "copper"
                        )
                    )
                except mapcss.RuleAbort:
                    pass
                    ...
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "ref:FR:Orange"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "ref:FR:Orange:NRO"
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "ref:FR:Orange:NRO"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags, 1, self.re_23d0d993, "[A-Z0-9]{3}"
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "ref:FR:PTT"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
        ...
        if "ref:FR:PTT:NRA" in keys:
            ...
            if not match:
                ...
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "ref:FR:PTT:NRA"))
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags,
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "ref:FR:PTT:NRA"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "operator"))
                        and (mapcss._tag_capture(capture_tags, 2, tags, "nat_ref"))
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags,
                                    3,
                                    self.re_7510958f,
                                    "^(([1-9][0-9]|0[1-9])PR([0-9]|[1-9][0-9]|[1-9][0-9][0-9])[DGU](|C))$",
                                ),
                                mapcss._tag_capture(capture_tags, 3, tags, "nat_ref"),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
                ...
                err.append(
                    {
                        ...
                        "subclass": 0,
                        "text": mapcss.tr(
                            "{0} is not a milestone valid reference RIU",
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (mapcss._tag_capture(capture_tags, 1, tags, "operator"))
                        and (mapcss._tag_capture(capture_tags, 2, tags, "nat_ref"))
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "distance"))
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        "class": 9019001,
                        "subclass": 0,
                        "text": mapcss.tr("missing distance"),
                    }
                )
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_3b90619c
                                ),
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(capture_tags, 0, tags, "amenity")
                            == mapcss._value_capture(capture_tags, 0, "kindergarten")
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 1, tags, "school:FR")
                            == mapcss._value_capture(capture_tags, 1, "maternelle")
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 0,
                        "text": {
                            "en": "amenity=kindergarten is no longer used for an 'école maternelle' in France, use amenity=school"
                        },
                        "allow_fix_override": True,
                        "fix": {"+": dict([["amenity", "school"]])},
                    }
                )
        ...
        if (
            ("ref:FR:FANTOIR" in keys)
            or ("ref:FR:FANTOIR:left" in keys)
            or ("ref:FR:FANTOIR:right" in keys)
        ):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        (mapcss._tag_capture(capture_tags, 0, tags, "ref:FR:FANTOIR"))
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    capture_tags,
                                    1,
                                    self.re_7f0c6b73,
                                    "^(((((((0[1-9]|1[0-9]|2A|2B|2[1-9]|[3-8][0-9]|9[0-5])([0-9]{3}))|((971(0[1-9]|[1-3][0-9]))|(972(0[1-9]|[1-3][0-9]))|(973(0[1-9]|[1-6][0-9]))|(974(0[1-9]|[1-2][0-9]))|(976(0[1-9]|1[0-7]))))([0-9]|[A-Z])([0-9]{3}))([ABCDEFGHJKLMNPRSTUVWXYZ]|))(|;(((((0[1-9]|1[0-9]|2A|2B|2[1-9]|[3-8][0-9]|9[0-5])([0-9]{3}))|((971(0[1-9]|[1-3][0-9]))|(972(0[1-9]|[1-3][0-9]))|(973(0[1-9]|[1-6][0-9]))|(974(0[1-9]|[1-2][0-9]))|(976(0[1-9]|1[0-7]))))([0-9]|[A-Z])([0-9]{3}))([ABCDEFGHJKLMNPRSTUVWXYZ]|))+))|no)$",
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "ref:FR:FANTOIR"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "ref:FR:FANTOIR:left"
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "ref:FR:FANTOIR:left"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
            ...
            if not match:
                ...
                try:
                    match = (
                        (
                            mapcss._tag_capture(
                                capture_tags, 0, tags, "ref:FR:FANTOIR:right"
                            )
                        )
                        and (
                            not mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 1, tags, "ref:FR:FANTOIR:right"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
                ...
                err.append(
                    {
                        "class": 9019005,
                        "subclass": 0,
                        "text": {"en": "format code ref:FR:FANTOIR"},
                    }
                )
    ...
    def way(self, data, tags, nds):
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (not mapcss._tag_capture(capture_tags, 1, tags, "gauge"))
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        "class": 21600,
                        "subclass": 0,
                        "text": mapcss.tr("Missing tag gauge on rail"),
                    }
                )
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_1473b7c6
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "highway"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 1, tags, "nat_ref"))
                        and (mapcss._tag_capture(capture_tags, 2, tags, "operator"))
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "junction"))
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
                except mapcss.RuleAbort:
                    pass
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    2,
                                    self.re_6beaf147,
                                    "^([1-9][0-9]|0[1-9])[AN]8[0-9]{3}(|A|N)([0-9]?[0-9])(|[A-Z]|[a-z])(|CD)_(1[0-9]|[1-9])D$",
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "nat_ref"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 3, tags, "operator"))
                ...
                err.append(
                    {
                        ...
                        "subclass": 0,
                        "text": mapcss.tr(
                            "{0} must be a link road or roundabout",
                            mapcss._tag_uncapture(capture_tags, "{1.tag}"),
                        ),
                    }
                )
        ...
        if (
            "highway" in keys and "nat_ref:backward" in keys and "operator" in keys
        ) or ("highway" in keys and "nat_ref:forward" in keys and "operator" in keys):
            match = False
            if not match:
                capture_tags = {}
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_3b28b3c0
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "highway"),
                            )
                        )
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "nat_ref:backward"
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "operator"))
                        and (mapcss.inside(self.father.config.options, "FR"))
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss._tag_capture(
                                capture_tags, 1, tags, "nat_ref:forward"
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "operator"))
                        and (mapcss.inside(self.father.config.options, "FR"))
                ...
                try:
                    match = (
                        (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 0, self.re_299ea34e
                                ),
                                mapcss._tag_capture(capture_tags, 0, tags, "highway"),
                            )
                        )
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    2,
                                    self.re_66c32242,
                                    "^([1-9][0-9]|0[1-9])[ANP](8|9)[0-9]{3}(|A|N)([0-9]?[0-9]|B1|B2)(|[A-Z]|[a-z])(|CD)_(1[0-9]|[1-9])D$",
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "nat_ref"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "operator")
                            != mapcss._value_const_capture(
                                capture_tags, 3, "VILLE DE PARIS", "VILLE DE PARIS"
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
                ...
                try:
                    match = (
                        (
                            ...
                            == mapcss._value_capture(capture_tags, 0, "roundabout")
                        )
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_3b28b3c0
                                ),
            ...
            if not match:
                ...
                try:
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    2,
                                    self.re_7f2e60da,
                                    "^(75Periph_Paris_[0-9]{2}_(1[0-9]|[1-9])D)$",
                                ),
                                mapcss._tag_capture(capture_tags, 2, tags, "nat_ref"),
                            )
                        )
                        and (
                            mapcss._tag_capture(capture_tags, 3, tags, "operator")
                            == mapcss._value_capture(capture_tags, 3, "VILLE DE PARIS")
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
                except mapcss.RuleAbort:
                ...
                err.append(
                    {
                        ...
                        "subclass": 0,
                        "text": mapcss.tr(
                            "{0} is not a valid reference (Paris)",
                            mapcss._tag_uncapture(capture_tags, "{1.tag}"),
                        ),
                    }
                )
        ...
        if ("highway" in keys and "nat_ref:backward" in keys) or (
            "highway" in keys and "nat_ref:forward" in keys
        ):
            match = False
            if not match:
                capture_tags = {}
                        ...
                        and (
                            not mapcss.regexp_test(
                                mapcss._value_const_capture(
                                    ...
                                    2,
                                    self.re_4e9373ac,
                                    "^(([1-9][0-9]|0[1-9])[ANP]9[0-9]{3}(|A|N)([0-9]?[0-9]|B1|B2)(|[A-Z]|[a-z])(|CD)_(1[0-9]|[1-9])D)$",
                                ),
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "nat_ref:forward"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
                    ...
                    match = (
                        ...
                        and (
                            not mapcss.regexp_test(
                                ...
                                mapcss._tag_capture(
                                    capture_tags, 2, tags, "nat_ref:backward"
                                ),
                            )
                        )
                        and (mapcss.inside(self.father.config.options, "FR"))
                ...
                try:
                    match = (
                        ...
                        and (
                            mapcss.regexp_test(
                                mapcss._value_capture(
                                    capture_tags, 1, self.re_299ea34e
                                ),
                                mapcss._tag_capture(capture_tags, 1, tags, "highway"),
                            )
                        )
                        and (mapcss._tag_capture(capture_tags, 2, tags, "nat_ref"))
                        and (not mapcss._tag_capture(capture_tags, 3, tags, "operator"))
                        and (mapcss.inside(self.father.config.options, "FR"))
                    )
                except mapcss.RuleAbort:
                    pass
                ...
                err.append(
                    {
                        "class": 9019002,
                        "subclass": 0,
                        "text": mapcss.tr("Missing tag operator with nat_ref"),
                    }
                )
...
class Test(TestPluginMapcss):
    def test(self):
        ...
        with with_options(n, {"country": "FR"}):
            self.check_err(
                n.node(data, {"amenity": "parking", "name": "Aire de Covoiturage"}),
                expected={"class": 20806, "subclass": 0},
            )
        with with_options(n, {"country": "FR"}):
            self.check_not_err(
                n.node(
                ...
                expected={"class": 30403, "subclass": 0},
            )
        with with_options(n, {"country": "FR"}):
            self.check_not_err(
                n.node(
                ...
                expected={"class": 9019001, "subclass": 0},
            )
        with with_options(n, {"country": "FR"}):
            self.check_err(
                n.node(
        ...
        with with_options(n, {"country": "FR"}):
            self.check_err(
                n.node(data, {"highway": "motorway_junction", "ref": "N7"}),
                expected={"class": 9019004, "subclass": 995082934},
            )
        with with_options(n, {"country": "FR"}):
            self.check_not_err(
                n.way(data, {"railway": "disused"}, [0]),
                expected={"class": 21600, "subclass": 0},
            )
        with with_options(n, {"country": "FR"}):
            self.check_not_err(
                n.way(data, {"gauge": "1435", "railway": "rail"}, [0]),
                expected={"class": 21600, "subclass": 0},
            )
        with with_options(n, {"country": "FR"}):
            self.check_err(
        ...
        with with_options(n, {"country": "FR"}):
            self.check_not_err(
                n.way(
                    data, {"amenity": "car_pooling", "name": "Aire de covoiturage"}, [0]
                ),
                expected={"class": 20806, "subclass": 0},
            )
        with with_options(n, {"country": "FR"}):
            self.check_err(
                n.way(
                    data, {"amenity": "car_sharing", "name": "Aire de covoiturage"}, [0]
                ),
                expected={"class": 20806, "subclass": 0},
            )
        with with_options(n, {"country": "FR"}):
        ...
        with with_options(n, {"country": "FR"}):
            self.check_not_err(
                n.way(
                    data,
                    {"name": "Station Covoiturage", "public_transport": "platform"},
                    [0],
                ),
                expected={"class": 20806, "subclass": 0},
            )
            ...
            self.check_not_err(
                n.way(
                    data,
                    {
                        "highway": "primary",
                        "junction": "roundabout",
                        "nat_ref": "62A901609CD_2D",
                        "operator": "SANEF",
                    },
                    [0],
                ),
                expected={"class": 9019002, "subclass": 0},
            )
        with with_options(n, {"country": "FR"}):
            self.check_err(
                n.way(
            ...
            self.check_not_err(
                n.way(
                    data,
                    {
                        ...
                        "nat_ref:backward": "62A902615CD_2D",
                        "nat_ref:forward": "62A902615CD_11D",
                        "operator": "SANEF",
                    },
                    [0],
                ),
        ...
        with with_options(n, {"country": "FR"}):
            self.check_not_err(
                n.way(
                    ...
                    {
                        "highway": "motorway_link",
                        "nat_ref:backward": "62A902615CD_12D",
                        "nat_ref:forward": "62A902615CD_1D",
                        "operator": "SANEF",
                    },
                    [0],
                ),
            ...
            self.check_not_err(
                n.way(
                    data,
                    {
                        "highway": "residential",
                        "name": "impasse",
                        "ref:FR:FANTOIR:left": "75106S581L",
                        "ref:FR:FANTOIR:right": "75106S581R",
                    },
                    [0],
                ),
                expected={"class": 9019005, "subclass": 0},
            )
        with with_options(n, {"country": "FR"}):
            self.check_not_err(
                n.way(
                    data,
                    {
                        "highway": "residential",
                        "name": "impasse",
                        "ref:FR:FANTOIR:left": "no",
                        "ref:FR:FANTOIR:right": "75106S581;67317B012Y",
                    },
                    [0],
                ),
                expected={"class": 9019005, "subclass": 0},
            ...
            self.check_not_err(
                n.way(
                    data,
                    {
                        "highway": "residential",
                        "name": "impasse",
                        "ref:FR:FANTOIR": "75106S581T;67317B012Y",
                    },
                    [0],
                ),
                expected={"class": 9019005, "subclass": 0},
