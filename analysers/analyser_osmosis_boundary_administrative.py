...
class Analyser_Osmosis_Boundary_Administrative(Analyser_Osmosis):
    ...
    def __init__(self, config, logger=None):
        ...
        self.classs[2] = self.def_class(
            ...
            detail=T_("""An area is marked as belonging to several cities at once."""),
            fix=T_("""Check what city this area belongs to."""),
        )
...
class Test(TestAnalyserOsmosis):
    ...
    def test(self):
        with Analyser_Osmosis_Boundary_Administrative(
