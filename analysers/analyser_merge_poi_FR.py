...
from .Analyser_Merge import GPKG, Conflate, LoadGeomCentroid, Mapping, Select, SourceIGN
    ...
    def __init__(self, config, logger=None):
        ...
        maping = [
            ...
            dict(
                ...
                select={
                    "nature": "Culte chrétien",
                    "nature_detaillee": "Temple protestant",
                },
                tags={"amenity": "place_of_worship"},
                generate_tags={
                    "amenity": "place_of_worship",
            ...
            dict(
                ...
                select={
                    "nature": "Culte chrétien",
                    "nature_detaillee": "Eglise orthodoxe",
                },
                tags={"amenity": "place_of_worship"},
                generate_tags={
                    "amenity": "place_of_worship",
            ...
            dict(
                ...
                select={
                    ...
                    "nature_detaillee": [
                        False,
                        "Mairie de commune associée ou déléguée",
                        "Mairie annexe",
                        "Hôtel de ville",
            ...
            dict(
                ...
                select={
                    "nature": "Point de vue",
                    "nature_detaillee": [False, "Belvédère"],
                },
            ...
            dict(
                ...
                select={
                    "nature": "Point de vue",
                    "nature_detaillee": "Table d'orientation",
                },
                tags={
                    "tourism": "viewpoint",
                    "information": "map",
...
class SubAnalyser_Merge_POI_FR(SubAnalyser_Merge_Dynamic):
    def __init__(
        ...
        self.init(
            ...
            LoadGeomCentroid(select=select),
            Conflate(
                select=Select(types=["nodes", "ways", "relations"], tags=tags),
