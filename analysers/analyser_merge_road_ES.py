...
from .Analyser_Merge import SHP, Load, Mapping, Select, Source
    ...
    def __init__(self, config, logger=None):
        ...
        self.init(
            ...
            Load(
                "geom",
                table_name="road_es_"
                + self.secuencialDescDir(config.options["country"]),
                select={
                    "clased": [
            ...
            ConflateNetwork(
                ...
                mapping=Mapping(
                    ...
                    text=lambda tags, fields: {
                        "en": ", ".join(filter(lambda x: x, [fields["clased"]]))
                    },
                ),
            ),
        )
