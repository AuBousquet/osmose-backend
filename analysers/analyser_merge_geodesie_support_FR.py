        ...
        with open("merge_data/geodesie_support_FR.mapping.csv") as mappingfile:
            ...
            for row in spamreader:
                ...
                if len(osmTags) > 0:
                    ...
                    slug = (
                        "".join(filter(lambda x: x.isalpha(), topic.split("|")[0]))
                        .capitalize()
                        .encode("ascii", "ignore")
                        .decode("utf8")
                    )
                    self.classFactory(
                        SubAnalyser_Geodesie_Support_FR,
                        slug,
                        item,
                        classs,
                        level,
...
class SubAnalyser_Geodesie_Support_FR(SubAnalyser_Merge_Dynamic):
    def __init__(
        ...
        self.def_class_missing_official(
            ...
            tags=["merge"],
            title=T_(
                "Geodesic support not integrated {0}",
        ...
        self.init(
            ...
            CSV(
                Source(
                    attribution="©IGN 2010 dans le cadre de la cartographie réglementaire",
            ...
            Load_XY(
                ...
                and "détruit" not in res["description"].lower()
