...
class Analyser_Merge_Emergency_Points_LU(Analyser_Merge_Point):
    def __init__(self, config, logger=None):
        ...
        self.missing_official = self.def_class(
            ...
            id=1,
            level=3,
            tags=["merge", "emergency", "fix:survey"],
        ...
        self.possible_merge = self.def_class(
            ...
            id=3,
            level=3,
            tags=["merge", "emergency", "fix:survey", "fix:chair"],
        ...
        self.init(
            ...
            CSV(
                SourcePublicLu(
                    attribution="Corps grand-ducal d'incendie et de secours",
            ...
            Conflate(
                select=Select(
                    types=["nodes"], tags={"highway": "emergency_access_point"}
                ),
                osmRef="ref",
                conflationDistance=50,
                mapping=Mapping(
                    static1={"highway": "emergency_access_point"},
                    static2={
                        "source": self.source,
                    },
                    mapping1={"ref": "NAME", "name": "ZUSATZ"},
                ),
            ),
        )
