...
class Analyser_Merge_Water_Drinking_ES_Madrid(Analyser_Merge_Point):
    def __init__(self, config, logger=None):
        ...
        self.def_class_missing_official(
            ...
            id=21,
            level=3,
            tags=["merge", "public equipment", "water", "fix:survey", "fix:picture"],
        ...
        self.init(
            ...
            Load_XY("Longitud", "Latitud", select={"OBSERVACIONES": "EN SERVICIO"}),
            Conflate(
                select=Select(
                    types=["nodes", "ways"], tags={"amenity": "drinking_water"}
                ),
