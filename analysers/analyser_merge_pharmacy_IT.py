...
class Analyser_Merge_Pharmacy_IT(Analyser_Merge_Point):
    def __init__(self, config, logger=None):
        ...
        self.def_class_update_official(
            ...
            id=14,
            level=3,
            tags=["merge", "amenity", "fix:chair", "fix:survey"],
        ...
        self.init(
            ...
            CSV(
                Source(
                    ...
                    fileUrl="http://www.dati.salute.gov.it/imgs/C_17_dataset_5_download_itemDownload0_upFile.CSV",
                ),
                separator=";",
            ),
            Load_XY(
            ...
            Conflate(
                select=Select(
                    types=["nodes", "ways"],
                    tags={"amenity": "pharmacy", "dispensing": "yes"},
                ),
                osmRef="ref:msal",
                conflationDistance=80,
                mapping=Mapping(
                    static1={"amenity": "pharmacy", "dispensing": "yes"},
