        ...
        if not oh:
            ...
            return "Opens: " + " | ".join(
                map(
                    ...
                    + s["closes"]
                    + " ("
                    + ", ".join(map(lambda x: x[18:], s["dayOfWeek"]))
                    + ")",
                    theJson,
                )
            )
        ...
        self.init(
            ...
            Conflate(
                ...
                mapping=Mapping(
                    ...
                    static1={"amenity": "toilets"},
                    static2={"source": self.source},
                    mapping1={
                        "wheelchair": lambda res: (
                            "yes" if res and res["acceshandi"] == "true" else None
                        ),
                        "fee": lambda res: (
                            "yes" if res and res["payant"] == "true" else None
                        ),
                        "male": lambda res: (
                            "yes" if res and res["hommes"] == "true" else None
                        ),
                        "female": lambda res: (
                            "yes" if res and res["femmes"] == "true" else None
                        ),
                        "unisex": lambda res: (
                            "yes" if res and res["unisexe"] == "true" else None
                        ),
                        "child": lambda res: (
                            "yes" if res and res["enfants"] == "true" else None
                        ),
                        "website": lambda res: (
                            res["web"] if res and res["web"] else None
                        ),
                    },
                ),
            ),
