...
class Test(TestAnalyserOsmosis):
    ...
    def setup_class(cls):
        ...
        cls.analyser_conf = cls.load_osm(
            ...
            {"proj": 2154},
        )  # Random proj for highway table generation
    ...
    def test_left(self):
        ...
        self.check_err(
            cl="1", lat="43.9535032231925", lon="6.36996821091771", elems=[("way", "2")]
        )
    ...
    def test_right(self):
        ...
        self.root_err = self.load_errors()
        self.check_err(
            cl="1", lat="43.9533100018163", lon="6.36976238744323", elems=[("way", "1")]
        )
        self.check_num_err(1)
