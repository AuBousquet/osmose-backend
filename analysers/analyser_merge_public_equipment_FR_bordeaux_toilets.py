...
#########################################################################
#                                                                       #
# Copyrights Frederic Rodrigo 2014-2016                                 #
#                                                                       #
    ...
    def __init__(self, config, logger=None):
        ...
        self.init(
            ...
            Conflate(
                ...
                mapping=Mapping(
                    static1={"amenity": "toilets", "fee": "no", "access": "yes"},
                    static2={"source": self.source},
                    mapping1={
                        "toilets:wheelchair": lambda res: (
                            "yes" if res["handi"] == "OUI" else "no"
                        ),
                        "toilets:position": lambda res: (
                            "urinal" if res["type"] == "URINOIR" else None
                        ),
                    },
                ),
            ),
