...
class Analyser_Merge_Restriction_FR_92_Maxweight(Analyser_Merge_Point):
    def __init__(self, config, logger=None):
        ...
        self.def_class_missing_official(
            ...
            id=3,
            level=3,
            tags=["merge", "maxweight", "fix:survey", "fix:picture"],
        ...
        self.init(
            ...
            Conflate(
                select=Select(
                    types=["ways"],
                    tags={"highway": None, "bridge": None, "maxweight": None},
                ),
                conflationDistance=300,
                mapping=Mapping(
                    static2={"source:maxweight": self.source},
                    mapping1={
                        "maxweight": lambda fields: self.et(fields["ETIQUETTES"])
                    },
...
class Analyser_Merge_Restriction_FR_92_Maxheight(Analyser_Merge_Point):
    def __init__(self, config, logger=None):
        ...
        self.init(
            ...
            Conflate(
                select=Select(
                    types=["ways"], tags={"highway": None, "maxheight": None}
                ),
                conflationDistance=300,
                mapping=Mapping(
                    static2={"source:maxheight": self.source},
                    mapping1={
                        "maxheight": lambda fields: self.et(fields["ETIQUETTES"])
                    },
                    text=lambda tags, fields: {"en": fields["NOM_RD"]},
                ),
            ),
