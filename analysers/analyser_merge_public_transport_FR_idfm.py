...
class _Analyser_Merge_Public_Transport_FR_IdFM(Analyser_Merge_Point):
    def __init__(
        ...
        self.def_class_missing_official(
            ...
            id=1 + 10 * clas,
            level=3,
            tags=["merge", "railway", "public transport", "fix:survey", "fix:picture"],
        ...
        self.def_class_possible_merge(
            ...
            id=3 + 10 * clas,
            level=3,
            tags=["merge", "railway", "public transport", "fix:chair"],
        ...
        self.init(
            ...
            LoadGeomCentroid(select={"type_arret": select}),
            Conflate(
                ...
                mapping=Mapping(
                    ...
                    mapping1={
                        "ref:FR:STIF": lambda fields: fields["id_refa"]
                        and int(fields["id_refa"] or None)
                    },
                    mapping2={"name": "nom_lda"},
                    text=lambda tags, fields: T_(
                        "{0} stop of {1}", place, tags["name"]
                    ),
                ),
            ),
        )
...
class Analyser_Merge_IdFM_Bus(_Analyser_Merge_Public_Transport_FR_IdFM):
    def __init__(self, config, logger=None):
        _Analyser_Merge_Public_Transport_FR_IdFM.__init__(
            self,
            config,
            logger,
            3,
