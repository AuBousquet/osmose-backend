                ...
                mapping=Mapping(
                    ...
                    mapping1={
                        "recycling:glass_bottles": lambda fields: (
                            "yes" if fields["flux_lib"] == "Verre" else None
                        ),
                        "recycling:paper": lambda fields: (
                            "yes" if fields["flux_lib"] == "Biflux" else None
                        ),
                        "recycling:plastic": lambda fields: (
                            "yes" if fields["flux_lib"] == "Biflux" else None
                        ),
                        "recycling:packaging": lambda fields: (
                            "yes" if fields["flux_lib"] == "Biflux" else None
                        ),
                        "recycling:clothes": lambda fields: (
                            "yes" if fields["flux_lib"] == "Textile" else None
                        ),
                        "location": lambda fields: (
                            "underground" if fields["type_lib"] == "Enterré" else None
                        ),
                    },
                    text=lambda tags, fields: {
                        "en": "{0} - {1}".format(fields["flux_lib"], fields["adresse"])
                    },
                ),
            ),
        )
