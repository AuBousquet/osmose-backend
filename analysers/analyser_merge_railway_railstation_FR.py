...
class Analyser_Merge_Railway_Railstation_FR(Analyser_Merge_Point):
    def __init__(self, config, logger=None):
        ...
        self.def_class_missing_official(
            ...
            id=1,
            level=3,
            tags=["merge", "railway", "fix:imagery", "fix:survey"],
        ...
        self.init(
            ...
            Conflate(
                select=Select(
                    types=["nodes", "ways"], tags={"railway": ["station", "halt"]}
                ),
                osmRef="uic_ref",
                conflationDistance=500,
                mapping=Mapping(
                    static1={"railway": "station", "operator": "SNCF"},
                    static2={"source": self.source},
                    mapping1={
                        "uic_ref": lambda res: res["stop_id"]
                        .split(":")[1][3:]
                        .split("-")[-1][:-1]
                    },
                    mapping2={
                    ...
                    text=lambda tags, fields: {
                        "en": fields["stop_name"][0].upper() + fields["stop_name"][1:]
                    },
                ),
            ),
        )
