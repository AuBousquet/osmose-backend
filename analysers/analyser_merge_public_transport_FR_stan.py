...
class Analyser_Merge_Public_Transport_FR_stan(Analyser_Merge_Point):
    def __init__(self, config, logger=None):
        ...
        self.init(
            ...
            GTFS(
                SourceDataGouv(
                    attribution="Métropole du Grand Nancy",
                    dataset="5aa94714c751df666fefc80f",
                    resource="22ff00b8-aa07-4f01-af47-8f198964bb1a",
                )
            ),
            ...
            Conflate(
                ...
                mapping=Mapping(
                    ...
                    mapping1={
                        ...
                        "wheelchair": lambda fields: self.wheelchair_boarding[
                            fields.get("wheelchair_boarding")
                        ],
                    },
                    mapping2={"name": "stop_name"},
                    text=lambda tags, fields: T_(
                        "{0} stop of {1}", place, fields["stop_name"]
                    ),
                ),
            ),
        )

    wheelchair_boarding = {None: None, "0": None, "1": "yes", "2": "no"}
