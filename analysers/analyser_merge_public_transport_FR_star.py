                ...
                mapping=Mapping(
                    ...
                    mapping1={
                        ...
                        "wheelchair": lambda res: (
                            "yes"
                            if res["Accessible aux PMR"] == "true"
                            else "no" if res["Accessible aux PMR"] == "false" else None
                        ),
                        "shelter": lambda res: (
                            "yes"
                            if res["Mobilier"] and "Abri" in res["Mobilier"]
                            else "no" if res["Mobilier"] == "Poteau" else None
                        ),
                    },
                    text=lambda tags, fields: T_(
                        "{0} stop of {1}", place, fields["Nom"]
                    ),
                ),
            ),
        )
