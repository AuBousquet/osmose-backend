...
class MapCSSListener(ParseTreeListener):
    ...
    def enterParent_child_selector_operator(
    ...
    def exitParent_child_selector_operator(
        self, ctx: MapCSSParser.Parent_child_selector_operatorContext
    ):
        pass
    ...
    def exitSimple_selector_operator(
        self, ctx: MapCSSParser.Simple_selector_operatorContext
    ):
        pass
    ...
    def enterPseudo_class_selector(
        self, ctx: MapCSSParser.Pseudo_class_selectorContext
    ):
        pass
