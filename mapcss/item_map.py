...
item_map = {
    ...
    "Rules_Brazilian-Specific": {
        "class": {
            "''{0}'' sem ''{1}'' definida": 9018066,
    ...
    "addresses": {
        "class": {"Same value of {0} and {1}": 9000003, "{0} without number": 9000004},
        "item": 9000,
        "not_for": ["CA"],
        "prefix": "Josm_",
        "tags": ["tag", "addr"],
    ...
    "combinations": {
        "class": {
            "Use {0} only as value of {1}": 9001005,
    ...
    "de-openrailwaymap": {
        "class": {
            "German Ks signals can't have main and distant signal at the same place, try a combined signal instead": 9016009,
    ...
    "deprecated": {
        "class": {
            "''{0}'' does not specify the official mode of transportation, use ''{1}'' for example": 9002003,
    ...
    "geometry": {
        "class": {
            "Object at Position 0.00E 0.00N. There is nothing at this position except an already mapped weather buoy.": 9003009,
    ...
    "multiple": {
        "class": {
            "empty value in semicolon-separated ''{0}''": 9005002,
    ...
    "openrailwaymap": {
        "class": {
            "A sign cannot have different states.": 9015031,
    ...
    "ru-housenumber": {
        "class": {"Номера домов не соответствующие принятому соглашению": 9017001},
        "item": 9017,
        "only_for": ["RU"],
        "prefix": "Josm_",
        "tags": ["tag", "addr"],
    ...
    "wikipedia": {
        "class": {
            "''{0}'' tag is set, but no ''{1}'' tag. Make sure to set ''wikipedia=language:value'' for the main article and optional ''wikipedia:language=value'' only for additional articles that are not just other language variants of the main article.": 9011015,
